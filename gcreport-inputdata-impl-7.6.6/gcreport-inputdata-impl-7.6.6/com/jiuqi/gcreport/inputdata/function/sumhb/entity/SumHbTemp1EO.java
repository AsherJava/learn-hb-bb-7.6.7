...
@DBTable(name="GC_SUMHBNOTEMP1", title="SumHb\u516c\u5f0f\u4e34\u65f6\u8868", indexs={@DBIndex(name="IDX_SUMHBNOTEMP_B1", columnsFields={"batchId", "subjectCode"})})
public class SumHbTemp1EO
extends DefaultTableEntity {
    public static final String TABLE_NAME_SUBJECT = "GC_SUMHBNOTEMP1";
