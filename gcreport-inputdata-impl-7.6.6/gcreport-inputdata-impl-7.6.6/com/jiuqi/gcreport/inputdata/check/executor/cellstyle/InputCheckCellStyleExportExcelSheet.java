 ...
 */
package com.jiuqi.gcreport.inputdata.check.executor.cellstyle;

import com.jiuqi.common.base.util.Assert;
import com.jiuqi.common.expimp.dataexport.common.ExportContext;
import com.jiuqi.common.expimp.dataexport.excel.common.ExportExcelSheet;
import com.jiuqi.common.expimp.util.ExpImpUtils;
import com.jiuqi.gcreport.inputdata.check.executor.cellstyle.InputCheckIntervalColorExportExcelSheet;
...
public class InputCheckCellStyleExportExcelSheet
extends InputCheckIntervalColorExportExcelSheet {
    private Map<String, CellStyle> cellStyleName2StyleMap;
    private BitSet amtCellCol;
    private boolean hasInit;

    public InputCheckCellStyleExportExcelSheet(Integer sheetNo, String sheetName, Integer sheetHeadSize) {
    ...
    private void buildDefaultCellStyleMap(Workbook workbook) {
        ...
        this.cellStyleName2StyleMap.put("intervalColorText", (CellStyle)intervalColorString);
        ...
        this.cellStyleName2StyleMap.put("intervalColorAmt", (CellStyle)intervalColorAmt);
    }
}
