 ...
 */
package com.jiuqi.gcreport.inputdata.offsetitem.factory.sheet;
...
public class UnOffsetParentTabExportExcelSheet
extends CellStyleExportExcelSheet {
    private Map<String, CellStyle> cellStyleName2StyleMap;

    public UnOffsetParentTabExportExcelSheet(Integer sheetNo, String sheetName, Integer sheetHeadSize) {
    ...
    public void callBackCell(ExportContext context, ExportExcelSheet excelSheet, Workbook workbook, Sheet sheet, Row row, Cell cell, Object cellValue) {
        ...
        Set intervalColorRowSet = this.getIntervalColorRowSet();
    ...
    private void buildDefaultCellStyleMap(Workbook workbook) {
        ...
        this.cellStyleName2StyleMap.put("fontCenter", (CellStyle)contentFontCenter);
        ...
        this.cellStyleName2StyleMap.put("intervalColorFontCenter", (CellStyle)intervalColorFontCenter);
    }
}
