...
@Component
public class UnOffsetTabRuleSummaryExportTask
...
GcOffSetItemAction {
    ...
    public UnOffsetTabExportExcelSheet createSheet(QueryParamsVO queryParamsVO, Boolean templateExportFlag, int sheetNo) {
        ...
        unOffsetMap.setContent(this.addSubtotalRowByRuleSummary(unOffsetMap.getContent(), queryParamsVO));
        List gcOffSetVchrItemDTOS = unOffsetMap.getContent();
        Set<Integer> ruleSummaryFontRows = this.ruleSummaryFontBoldRows((OffsetItemExportParam)queryParamsVO, (Pagination<Map<String, Object>>)unOffsetMap);
        ruleSummaryFontRows.forEach(arg_0 -> ((UnOffsetTabExportExcelSheet)unOffsetTabExportExcelSheet).appendIntervalFontBoldRow(arg_0));
