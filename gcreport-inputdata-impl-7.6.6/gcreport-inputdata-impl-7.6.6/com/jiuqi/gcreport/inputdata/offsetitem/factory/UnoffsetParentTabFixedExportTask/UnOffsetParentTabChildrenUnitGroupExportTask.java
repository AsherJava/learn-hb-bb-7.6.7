...
@Component
public class UnOffsetParentTabChildrenUnitGroupExportTask
...
GcOffSetItemAction {
    ...
    public UnOffsetParentTabExportExcelSheet createSheet(QueryParamsVO queryParamsVO, Boolean templateExportFlag, int sheetNo) {
        ...
        int index = 9;
        unOffsetParentMap.setContent(this.addSubtotalRowByChildrenUnit(unOffsetParentMap.getContent()));
    ...
    public List<Map<String, Object>> addSubtotalRowByChildrenUnit(List<Map<String, Object>> content) {
        BigDecimal debitSum = new BigDecimal(0);
        BigDecimal creditSum = new BigDecimal(0);
        ArrayList<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
        for (Map<String, Object> item : content) {
            if (item.containsKey("even")) {
                result.add(this.createSubtotalRowChildrenUnit(debitSum, creditSum, item));
    ...
    private Map<String, Object> createSubtotalRowChildrenUnit(BigDecimal debitSum, BigDecimal creditSum, Map<String, Object> item) {
        HashMap<String, Object> subtotalRow = new HashMap<String, Object>();
        subtotalRow.put("UNITTITLE", item.get("UNITTITLE"));
        subtotalRow.put("OPPUNITTITLE", item.get("OPPUNITTITLE"));
    ...
    public Set<Integer> getSetIntervalRowSet(Pagination<Map<String, Object>> dataMap) {
        ...
        for (int i = 0; i < content.size(); ++i) {
            ...
            if (!item.containsKey("even")) continue;
            rowNumber.add(i + 1);
        }
        return rowNumber;
    }
