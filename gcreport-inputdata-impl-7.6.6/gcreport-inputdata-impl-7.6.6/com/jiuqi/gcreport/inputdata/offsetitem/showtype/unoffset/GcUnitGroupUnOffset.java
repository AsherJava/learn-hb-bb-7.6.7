...
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnOffsetTabFixedExportTask.UnOffsetTabUnitGroupExportTask;
...
@Component
public class GcUnitGroupUnOffset
implements GcOffsetItemShowType {
    @Autowired
    private UnitGroupQueryAction unitGroupQueryAction;
    @Autowired
    private UnOffsetTabUnitGroupExportTask unOffsetTabUnitGroupExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.unitGroupQueryAction);
        list.add(this.unOffsetTabUnitGroupExportTask);
