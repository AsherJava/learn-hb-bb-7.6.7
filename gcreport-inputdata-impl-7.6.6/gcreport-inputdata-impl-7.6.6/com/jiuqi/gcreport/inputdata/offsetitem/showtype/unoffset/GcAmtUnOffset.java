...
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnOffsetTabFixedExportTask.UnOffsetTabAmtExportTask;
...
@Component
public class GcAmtUnOffset
implements GcOffsetItemShowType {
    @Autowired
    private AmtQueryAction amtQueryAction;
    @Autowired
    private UnOffsetTabAmtExportTask unOffsetTabAmtExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.amtQueryAction);
        list.add(this.unOffsetTabAmtExportTask);
