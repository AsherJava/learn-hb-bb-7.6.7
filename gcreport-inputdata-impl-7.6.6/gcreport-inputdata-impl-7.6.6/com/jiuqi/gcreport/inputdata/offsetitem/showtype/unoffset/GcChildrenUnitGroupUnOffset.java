...
import com.jiuqi.gcreport.inputdata.offsetitem.action.query.unoffset.ChildrenUnitGroupQueryAction;
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnOffsetTabFixedExportTask.UnOffsetTabChildrenUnitGroupExportTask;
...
@Component
public class GcChildrenUnitGroupUnOffset
implements GcOffsetItemShowType {
    @Autowired
    private ChildrenUnitGroupQueryAction childrenUnitGroupQueryAction;
    @Autowired
    private UnOffsetTabChildrenUnitGroupExportTask unOffsetTabChildrenUnitGroupExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.childrenUnitGroupQueryAction);
        list.add(this.unOffsetTabChildrenUnitGroupExportTask);
