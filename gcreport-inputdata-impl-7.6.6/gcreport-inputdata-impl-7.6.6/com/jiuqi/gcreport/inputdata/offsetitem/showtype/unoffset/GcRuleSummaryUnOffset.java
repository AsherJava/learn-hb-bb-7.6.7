...
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnOffsetTabFixedExportTask.UnOffsetTabRuleSummaryExportTask;
...
@Component
public class GcRuleSummaryUnOffset
implements GcOffsetItemShowType {
    @Autowired
    private RuleSummaryQueryAction ruleSummaryQueryAction;
    @Autowired
    private UnOffsetTabRuleSummaryExportTask unOffsetTabRuleSummaryExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.ruleSummaryQueryAction);
        list.add(this.unOffsetTabRuleSummaryExportTask);
