...
import com.jiuqi.gcreport.inputdata.offsetitem.action.query.unoffsetparent.UnitGroupParentQueryAction;
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnoffsetParentTabFixedExportTask.UnOffsetParentTabUnitGroupExportTask;
...
@Component
public class GcUnitGroupUnOffsetParent
implements GcOffsetItemShowType {
    @Autowired
    private UnitGroupParentQueryAction unitGroupParentQueryAction;
    @Autowired
    private UnOffsetParentTabUnitGroupExportTask unOffsetParentTabUnitGroupExportTask;
    @Autowired
    ...
    public String getCode() {
        return FilterMethodEnum.UNITGROUP.getCode();
    }

    public String getTitle() {
        return FilterMethodEnum.UNITGROUP.getTitle();
    }
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.unitGroupParentQueryAction);
        list.add(this.unOffsetParentTabUnitGroupExportTask);
