 ...
 */
package com.jiuqi.gcreport.inputdata.offsetitem.showtype.common;
...
@Component
public class GcCommonUnOffsetInput
implements GcOffsetItemShowType {
    @Autowired
    private ManualOffsetButton queryUnOffsetInput;
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add((GcOffSetItemAction)this.queryUnOffsetInput);
        return list;
    }
}
