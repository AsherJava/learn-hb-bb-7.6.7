...
import com.jiuqi.gcreport.inputdata.offsetitem.action.query.unoffsetparent.RuleParentQueryAction;
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnoffsetParentTabFixedExportTask.UnOffsetParentTabRuleExportTask;
...
@Component
public class GcRuleQueryUnOffsetParent
implements GcOffsetItemShowType {
    @Autowired
    private RuleParentQueryAction ruleParentQueryAction;
    @Autowired
    private UnOffsetParentTabRuleExportTask unOffsetParentTabRuleExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.ruleParentQueryAction);
        list.add(this.unOffsetParentTabRuleExportTask);
