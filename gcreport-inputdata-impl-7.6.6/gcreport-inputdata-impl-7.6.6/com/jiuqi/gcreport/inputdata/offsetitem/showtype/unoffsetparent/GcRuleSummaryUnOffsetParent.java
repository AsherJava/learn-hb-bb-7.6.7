...
import com.jiuqi.gcreport.inputdata.offsetitem.action.query.unoffsetparent.RuleSummaryParentQueryAction;
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnoffsetParentTabFixedExportTask.UnOffsetParentTabRuleSummaryExportTask;
...
@Component
public class GcRuleSummaryUnOffsetParent
implements GcOffsetItemShowType {
    @Autowired
    private RuleSummaryParentQueryAction ruleSummaryParentQueryAction;
    @Autowired
    private UnOffsetParentTabRuleSummaryExportTask unOffsetParentTabRuleSummaryExportTask;
    @Autowired
    ...
    public String getCode() {
        return FilterMethodEnum.RULESUMMARY.getCode();
    }

    public String getTitle() {
        return FilterMethodEnum.RULESUMMARY.getTitle();
    }
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.ruleSummaryParentQueryAction);
        list.add(this.unOffsetParentTabRuleSummaryExportTask);
