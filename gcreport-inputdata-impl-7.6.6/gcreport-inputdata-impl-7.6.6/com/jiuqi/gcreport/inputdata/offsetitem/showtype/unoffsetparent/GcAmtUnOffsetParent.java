...
import com.jiuqi.gcreport.inputdata.offsetitem.action.query.unoffsetparent.AmtParentQueryAction;
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnoffsetParentTabFixedExportTask.UnOffsetParentTabAmtExportTask;
...
@Component
public class GcAmtUnOffsetParent
implements GcOffsetItemShowType {
    @Autowired
    private AmtParentQueryAction amtParentQueryAction;
    @Autowired
    private UnOffsetParentTabAmtExportTask unOffsetParentTabAmtExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.amtParentQueryAction);
        list.add(this.unOffsetParentTabAmtExportTask);
