...
import com.jiuqi.gcreport.inputdata.offsetitem.factory.UnOffsetTabFixedExportTask.UnOffsetTabUnitExportTask;
...
@Component
public class GcUnitUnOffset
implements GcOffsetItemShowType {
    @Autowired
    private UnitQueryAction unitQueryAction;
    @Autowired
    private UnOffsetTabUnitExportTask unOffsetTabUnitExportTask;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.unitQueryAction);
        list.add(this.unOffsetTabUnitExportTask);
