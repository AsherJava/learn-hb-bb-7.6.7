...
@Component
public class AmtParentQueryAction
implements GcOffSetItemAction {
    ...
    public Object execute(GcOffsetExecutorVO gcOffsetExecutorVO) {
        ...
        if (StringUtils.isEmpty(queryParamsVO.getOrgId())) {
            return this.amtQueryAction.execute(gcOffsetExecutorVO);
        }
        ...
        if (this.queryActionUtils.isUnitTreeSort(FilterMethodEnum.AMT.getCode(), queryParamsVO.getDataSourceCode(), GcOffsetItemNotOffsetPageImpl.newInstance().getPageCode())) {
