...
@Component
public class ChildrenUnitGroupParentQueryAction
implements GcOffSetItemAction {
    ...
    public Object execute(GcOffsetExecutorVO gcOffsetExecutorVO) {
        ...
        if (StringUtils.isEmpty(queryParamsVO.getOrgId())) {
            return this.childrenUnitGroupQueryAction.execute(gcOffsetExecutorVO);
        }
        ...
        this.childrenUnitGroupQueryAction.handleChildrenUnitGroup(queryParamsVO, pagination);
        this.childrenUnitGroupQueryAction.handleSumData(pagination);
