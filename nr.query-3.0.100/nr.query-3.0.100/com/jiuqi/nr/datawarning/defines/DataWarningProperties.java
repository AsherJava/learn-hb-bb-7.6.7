...
import com.jiuqi.nr.datawarning.defines.DataWarningPropertiesDeserializer;
import com.jiuqi.nr.datawarning.defines.DataWarningPropertiesSerializer;
...
@Service
@JsonSerialize(using=DataWarningPropertiesSerializer.class)
@JsonDeserialize(using=DataWarningPropertiesDeserializer.class)
public class DataWarningProperties {
    private static final Logger log = LoggerFactory.getLogger(DataWarningProperties.class);
    public static final String DATAWARNINGPROPERTIES_FIELDVALUE = "fieldValue";
    public static final String DATAWARNINGPROPERTIES_PREFIELDLABEL = "preFieldLabel";
    public static final String DATAWARNINGPROPERTIES_FIELDCODE = "fieldCode";
    public static final String DATAWARNINGPROPERTIES_FIELDLABEL = "fieldLabel";
    public static final String DATAWARNINGPROPERTIES_FIELDCOMPAREVALUE = "fieldCompareValue";
    public static final String DATAWARNINGPROPERTIES_FIELDCOMPAREINPUT = "fieldCompareInput";
    public static final String DATAWARNINGPROPERTIES_FIELDFORMULAINPUT = "fieldFormulaInput";
    public static final String DATAWARNINGPROPERTIES_FIELDCOMPAREVALLABEL = "fieldCompareValLabel";
    public static final String DATAWARNINGPROPERTIES_PREVIEWBACKGROUNDCOLOR = "previewBackgroundColor";
    public static final String DATAWARNINGPROPERTIES_PREVIEWTEXTCOLOR = "previewTextColor";
    public static final String DATAWARNINGPROPERTIES_PREVIEWTEXTFONTWEIGHT = "previewTextFontWeight";
    public static final String DATAWARNINGPROPERTIES_PREVIEWTEXTFONTSTYLE = "previewTextFontStyle";
    public static final String DATAWARNINGPROPERTIES_FIELDSETTINGCODE = "fieldSettingCode";
    public static final String DATAWARNINGPROPERTIES_FIELDREMARKTEXTAEA = "fieldRemarkTextAea";
    public static final String DATAWARNINGPROPERTIES_FIELDICONCOMPARELIST = "fieldIconCompareList";
    public static final String DATAWARNINGPROPERTIES_ICONINPUTLIST = "iconInputList";
    public static final String DATAWARNINGPROPERTIES_ONLYICONCHECKBOX = "onlyIconCheckBox";
    public static final String DATAWARNINGPROPERTIES_REVERSEICONBTN = "reverseIconBtn";
    public static final String DATAWARNINGPROPERTIES_MINBARMODEL = "minBarModel";
    public static final String DATAWARNINGPROPERTIES_MINBARINPUTMODEL = "minBarInputModel";
    public static final String DATAWARNINGPROPERTIES_MAXBARMODEL = "maxBarModel";
    public static final String DATAWARNINGPROPERTIES_MAXBARINPUTMODEL = "maxBarInputModel";
    public static final String DATAWARNINGPROPERTIES_BARFILLCOLOR = "barFillColor";
    public static final String DATAWARNINGPROPERTIES_BARBORDERCOLOR = "barBorderColor";
    public static final String DATAWARNINGPROPERTIES_BARDIRECTION = "barDirection";
    public static final String DATAWARNINGPROPERTIES_ONLYSHOWBAR = "onlyShowBar";
    public static final String DATAWARNINGPROPERTIES_NEGATIVEFILLCOLORRADIO = "negativefillColorRadio";
    public static final String DATAWARNINGPROPERTIES_NEGATIVEFILLCOLORVALUE = "negativefillColorValue";
    public static final String DATAWARNINGPROPERTIES_NEGATIVEBORDERCOLORRADIO = "negativeBorderColorRadio";
    public static final String DATAWARNINGPROPERTIES_NEGATIVEBORDERCOLORVALUE = "negativeBorderColorValue";
    public static final String DATAWARNINGPROPERTIES_AXISSETTINGPOSRADIO = "axisSettingPosRadio";
    public static final String DATAWARNINGPROPERTIES_AXISCOLORVALUE = "axisColorValue";
    public static final String DATAWARNINGPROPERTIES_FIRSTGRADUALCHANGECOLOR = "firstGradualChangeColor";
    public static final String DATAWARNINGPROPERTIES_SECONDGRADUALCHANGECOLOR = "secondGradualChangeColor";
    public static final String DATAWARNINGPROPERTIES_THIRDGRADUALCHANGECOLOR = "thirdGradualChangeColor";
    public static final String DATAWARNINGPROPERTIES_MIDDLEBARMODEL = "middleBarModel";
    public static final String DATAWARNINGPROPERTIES_MIDDLEBARINPUTMODEL = "middleBarInputModel";
    public static final String DATAWARNINGPROPERTIES_FIELDFORMULAISCHECK = "fieldFormulaIsCheck";
    public static final String DATAWARNINGPROPERTIES_FIELDSETTINGTITLE = "fieldSettingTitle";
    public static final String DATAWARNINGPROPERTIES_CELLTOPORLASTSELECTVALUE = "cellTopOrLastSelectValue";
    public static final String DATAWARNINGPROPERTIES_CELLTOPORLASTSELECTLABEL = "cellTopOrLastSelectLabel";
    public static final String DATAWARNINGPROPERTIES_CELLTOPORLASTISPERCENT = "cellTopOrLastIsPercent";
    public static final String DATAWARNINGPROPERTIES_CELLAVERAGEVAL = "cellAverageVal";
    public static final String DATAWARNINGPROPERTIES_FIELDCOMPAREINPUTTWO = "fieldCompareInputTwo";
    public static final String DATAWARNINGPROPERTIES_ICONGROUPVALUE = "iconGroupValue";
    public static final String DATAWARNINGPROPERTIES_BARFILLMODEL = "barFillModel";
    public static final String DATAWARNINGPROPERTIES_BARBORDERMODEL = "barBorderModel";
    public static final String DATAWARNINGPROPERTIES_PREISENABLE = "preIsEnable";
    public static final String DATAWARNINGPROPERTIES_NEGATIVEHIDDENSETTINGMODEL = "negativeHiddenSettingModel";
    public static final String DATAWARNINGPROPERTIES_BARSTYLE = "barStyle";
