...
public class TransUtil {
    ...
    public static String transModelType(QueryModelType type) {
        return type.toString();
    }

    public QueryModelType transModelType(String type) {
        return QueryModelType.valueOf(type);
    }

    public static String transModelCategory(QueryModelCategory modelCategory) {
        return modelCategory.toString();
    }

    public QueryModelCategory transModelCategory(String modelCategory) {
        return QueryModelCategory.valueOf(modelCategory);
    }

    public QueryBlockType transBlockType(String blockType) {
        return QueryBlockType.getType(blockType);
    }

    public String transBlockType(QueryBlockType blockType) {
        return blockType.toString();
    }

    public BigDecimal transDoubleToBigDecimal(Double value) {
        return BigDecimal.valueOf(value);
    }

    public Double transDoubleToBigDecimal(BigDecimal value) {
