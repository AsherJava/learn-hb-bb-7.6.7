...
public class DataSetTitleNode
extends DataSetDimensionNode {
    private static final long serialVersionUID = -6088001647305640797L;

    public DataSetTitleNode(String entityTableName, IEntityModel entityModel, String sourceTableName, String sourceFieldName) {
        super(entityTableName, entityModel, sourceTableName, sourceFieldName);
    }

    public DataSetTitleNode(String entityTableName, String entityFieldName) {
