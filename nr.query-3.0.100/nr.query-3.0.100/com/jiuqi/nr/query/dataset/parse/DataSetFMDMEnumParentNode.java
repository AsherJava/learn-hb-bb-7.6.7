...
public class DataSetFMDMEnumParentNode
extends DataSetFMDMEnumNode {
    private static final long serialVersionUID = 579464649006954858L;

    public DataSetFMDMEnumParentNode(String entityTableName, IEntityModel entityModel, String sourceTableName, String sourceFieldName, DataSetDimensionNode fmdmNode) {
        super(entityTableName, entityModel, sourceTableName, sourceFieldName, fmdmNode);
    }

    public DataSetFMDMEnumParentNode(String entityTableName, String entityFieldName, DataSetDimensionNode fmdmNode) {
