    ...
    public static void printPDF(ITemplateDocument tmplDoc, IPaginateInteractor paginateInteractor, IPaintInteractor paintInteractor, OutputStream out, IProcessMonitor monitor) {
        block2: {
            ...
            try {
                ...
                drawManager.print((IContentStream[])streams, paintInteractor, (IPrintDevice)device, (IProcessMonitor)new SimpleProcessMonitor(System.err, System.err, System.err));
            }
            catch (Exception e) {
