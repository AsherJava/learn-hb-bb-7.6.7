...
public class ChartServices {
    private static final Logger log = LoggerFactory.getLogger(ChartServices.class);
    @Autowired
     ...
     */
    public byte[] Export(String chartID, Map<String, List<String>> masterValues, String moduleCode) {
        /*
    ...
    public String getCurrentId(String groupId) {
