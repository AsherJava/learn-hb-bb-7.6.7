...
@Excel(title="\u4e1a\u52a1\u534f\u540c\u90e8\u5206\u786e\u8ba4\u660e\u7ec6\u5355\u636e")
public class ClbrBillPartConfirmDetailsExcelModel {
    ...
    @ExcelColumn(index=5, title={"\u63a5\u6536\u65b9\u5355\u4f4d"})
    private String oppRelationTitle;
    @ExcelColumn(index=6, title={"\u63a5\u6536\u65b9\u534f\u540c\u4e1a\u52a1\u7c7b\u578b"})
    private String oppClbrTypeTitle;
    @ExcelColumn(index=7, title={"\u534f\u540c\u63a5\u6536\u65b9\u5355\u636e\u7f16\u53f7"})
    private String oppClbrBillCode;
    @ExcelColumn(index=8, title={"\u5355\u636e\u65e5\u671f"})
    private String createTime;
    @ExcelColumn(index=9, title={"\u786e\u8ba4\u65e5\u671f"})
