...
@Excel(title="\u4e1a\u52a1\u534f\u540c\u672a\u786e\u8ba4\u660e\u7ec6\u5355\u636e")
public class ClbrBillRejectDetailsExcelModel {
    @ExcelColumn(index=0, title={"\u5355\u636e\u7f16\u53f7"})
    private String clbrBillCode;
    @ExcelColumn(index=1, title={"\u53d1\u8d77\u65b9\u5355\u4f4d"})
    private String relationTitle;
    @ExcelColumn(index=2, title={"\u53d1\u8d77\u65b9\u534f\u540c\u4e1a\u52a1\u7c7b\u578b"})
    private String clbrTypeTitle;
    @ExcelColumn(index=3, title={"\u91d1\u989d"})
    private double amount;
    @ExcelColumn(index=4, title={"\u63a5\u6536\u65b9\u5355\u4f4d"})
    private String oppRelationTitle;
    @ExcelColumn(index=5, title={"\u63a5\u6536\u65b9\u534f\u540c\u4e1a\u52a1\u7c7b\u578b"})
    private String oppClbrTypeTitle;
    @ExcelColumn(index=6, title={"\u5355\u636e\u65e5\u671f"})
    private String createTime;
    @ExcelColumn(index=7, title={"\u9a73\u56de\u4eba"})
    private String rejectUserName;
    @ExcelColumn(index=8, title={"\u9a73\u56de\u65f6\u95f4"})
