 ...
 */
package com.jiuqi.bde.penetrate.impl.config;
...
@Component
public class BdePenetrateCacheConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_PENETRACTE_MANAGE";
    public static final String CACHE_NAME = "BDE_PENETRACTE";
