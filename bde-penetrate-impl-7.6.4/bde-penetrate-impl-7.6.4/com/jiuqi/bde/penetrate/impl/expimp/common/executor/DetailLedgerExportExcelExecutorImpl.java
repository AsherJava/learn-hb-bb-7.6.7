...
@Component
public class DetailLedgerExportExcelExecutorImpl
extends AbstractExportExcelExecutor {
    @Autowired
    CommonPenetrateExportExcelService totalExportExcelService;

    public String getName() {
        return "CommonDetailLedgerExportExcelExecutor";
    }
    ...
    public Object dataExport(HttpServletRequest request, HttpServletResponse response, ExportContext context) throws Exception {
        ...
        String exportSituation = this.totalExportExcelService.exportExcel(response, context.isTemplateExportFlag(), param);
