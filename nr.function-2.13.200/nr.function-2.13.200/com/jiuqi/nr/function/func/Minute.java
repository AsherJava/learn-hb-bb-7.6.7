...
implements IReportFunction {
    private static final long serialVersionUID = 7644707764091282890L;
    ...
    public String title() {
        return "\u8fd4\u56de\u65f6\u95f4\u503c\u4e2d\u5206\u949f\u7684\u6570\u503c\uff0c\u4ecb\u4e8e0\u523059\u4e4b\u95f4\u7684\u6574\u6570";
    }
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        if (!(obj instanceof Calendar)) {
            throw new SyntaxException("Minute()\u51fd\u6570\u7684\u7b2c\u4e00\u4e2a\u53c2\u6570\u5fc5\u987b\u4e3a\u65e5\u671f\u7c7b\u578b");
        }
        return DataBuffer.valueOf((int)((Calendar)obj).get(12));
    }
}
