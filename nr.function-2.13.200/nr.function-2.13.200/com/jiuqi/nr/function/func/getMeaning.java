    ...
    public int validate(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        try {
            ...
            if (entityDefine == null) {
                throw new SyntaxException("\u672a\u627e\u5230\u6807\u8bc6\u4e3a" + tableCode + "\u7684\u679a\u4e3e");
            }
        }
        catch (Exception e) {
