...
public final class RDollar
extends Function
implements IReportFunction {
    private static final Logger logger = LogFactory.getLogger(RDollar.class);
    private static final long serialVersionUID = -5568678580343321291L;
    ...
    public static final String callFunction(String text, int length) {
        try {
            ...
            byte[] newBytes = Arrays.copyOfRange(bytes, bytes.length - length, bytes.length);
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        if (!(obj instanceof String)) {
            throw new SyntaxException("Right()\u7684\u7b2c\u4e00\u4e2a\u53c2\u6570\u5fc5\u987b\u4e3a\u5b57\u7b26\u4e32\u7c7b\u578b");
        }
        ...
        if (!(obj instanceof Number)) {
            throw new SyntaxException("Right()\u7684\u7b2c\u4e8c\u4e2a\u53c2\u6570\u5fc5\u987b\u4e3a\u6570\u503c\u7c7b\u578b");
        }
        Number length = (Number)obj;
        if (length.intValue() < 0) {
            length = 0;
        }
        return RDollar.callFunction(text, length.intValue());
    }
    ...
    protected void toSQL(IContext context, List<IASTNode> children, StringBuilder buffer, ISQLInfo info) throws InterpretException {
        ...
        StringBuilder judgeExpr = new StringBuilder();
        children.get(0).interpret(context, str, Language.SQL, (Object)info);
        children.get(1).interpret(context, len, Language.SQL, (Object)info);
        if (info.isDatabase(new String[]{"ORACLE", "DM", "KINGBASE"})) {
            judgeExpr.append("Lengthb(").append((CharSequence)str).append(")>").append((CharSequence)len);
            buffer.append(" (CASE WHEN ");
            buffer.append((CharSequence)judgeExpr).append(" THEN ");
            buffer.append("SUBSTRB(");
            buffer.append((CharSequence)str);
            buffer.append(", ");
            buffer.append("LENGTHB(");
            buffer.append((CharSequence)str);
            buffer.append(")-(");
            buffer.append((CharSequence)len);
            buffer.append(") + 1)");
            buffer.append(" ELSE ");
            buffer.append((CharSequence)str);
            buffer.append(" END) ");
