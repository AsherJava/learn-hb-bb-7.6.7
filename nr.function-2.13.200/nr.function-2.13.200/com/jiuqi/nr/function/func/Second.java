...
implements IReportFunction {
    private static final long serialVersionUID = -1944426049242867607L;
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        if (!(obj instanceof Calendar)) {
            throw new SyntaxException("Second()\u51fd\u6570\u7684\u7b2c\u4e00\u4e2a\u53c2\u6570\u5fc5\u987b\u4e3a\u65e5\u671f\u7c7b\u578b");
        }
        return DataBuffer.valueOf((int)((Calendar)obj).get(13));
    }
}
