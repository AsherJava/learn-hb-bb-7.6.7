...
extends Function {
    ...
    private boolean evalArray(Object value, ArrayData paramValue, ParameterModel param) throws SyntaxException {
        if (param.isRangeParameter()) {
            ...
            if (min != null && DataType.compare((int)param.getDataType(), (Object)value, (Object)min) < 0) {
                return false;
            }
            return max == null || DataType.compare((int)param.getDataType(), (Object)value, (Object)max) <= 0;
        }
        for (Object item : paramValue) {
            if (DataType.compare((int)param.getDataType(), (Object)value, item) != 0) continue;
            return true;
        }
        return false;
    }
    ...
    private boolean evalSimple(Object value, Object paramValue, ParameterModel param) throws SyntaxException {
        return DataType.compare((int)param.getDataType(), (Object)value, (Object)paramValue) == 0;
    }
