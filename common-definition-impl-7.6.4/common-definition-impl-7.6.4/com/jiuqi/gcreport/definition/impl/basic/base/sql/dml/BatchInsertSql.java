...
implements EntDmlBatchSql {
    ...
    public static BatchInsertSql newInstance(String tableName, int size) {
        return new BatchInsertSql(tableName, size);
    }

    private BatchInsertSql(String tableName, int size) {
        super(tableName);
        this.size = size;
