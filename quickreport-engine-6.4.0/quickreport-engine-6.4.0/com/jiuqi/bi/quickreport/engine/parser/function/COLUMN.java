...
implements IFormatable {
    ...
    public COLUMN() {
        this.parameters().add(new Parameter("reference", 0, "\u9700\u8981\u5f97\u5230\u5176\u5217\u53f7\u7684\u5355\u5143\u683c\u6216\u5355\u5143\u683c\u533a\u57df\u3002", true));
    }
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        if (parameters.isEmpty()) {
            return this.getLocalCol((ReportContext)context);
        }
        return this.getRefCol((ReportContext)context, parameters.get(0));
    }

    private int getLocalCol(ReportContext context) throws SyntaxException {
        if (context.getCurrentCell() == null) {
            throw new SyntaxException("\u516c\u5f0f\u6267\u884c\u73af\u5883\u5f02\u5e38\uff0c\u65e0\u6cd5\u83b7\u53d6\u5f53\u524d\u884c\u53f7\u3002");
        }
        return context.getCurrentCell().getPosition().col();
    }

    private int getRefCol(ReportContext context, IASTNode node) throws SyntaxException {
        if (node instanceof ReportCellNode) {
            return ((ReportCellNode)node).getFirstCol(context);
        }
        if (node instanceof ReportRegionNode) {
            return ((ReportRegionNode)node).getFirstCol(context);
        }
