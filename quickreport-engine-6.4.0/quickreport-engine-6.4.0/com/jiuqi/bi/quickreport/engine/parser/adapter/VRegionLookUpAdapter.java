...
public final class VRegionLookUpAdapter
extends FunctionAdapter {
    public VRegionLookUpAdapter() throws QuickReportError {
        super(VRegionLookUpAdapter.findVRLookUp());
    }

    private static IFunction findVRLookUp() throws QuickReportError {
        try {
            return FunctionProvider.LOOKUP_PROVIDER.find(null, "VRegionLookUp");
        }
