...
implements IDbfTable {
    private static final Logger logger = LoggerFactory.getLogger(DbfTable.class);
    ...
    private FileOutputStream destfileStream = null;
    private BufferedInputStream binaryReader = null;
    private RandomAccessFile accessFile = null;
    private BufferedOutputStream binaryWriter = null;
     ...
     */
    public DbfTable(String fileName, String enCoding, boolean create, boolean batchMode) throws DbfException {
        try {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public DbfTable(String fileName, String enCoding, boolean create) throws DbfException {
        try {
            this.dbfFileName = fileName;
            this.encoding = enCoding;
            this.openDbfFile();
    ...
    public DbfTable(String fileName, String encodingName) throws DbfException {
    ...
    public DbfTable(String fileName) throws DbfException {
        this.dbfFileName = fileName.trim();
        try {
            this.openDbfFile();
        }
    ...
    public void closeFileStream() throws DbfException {
        try {
            ...
            if (this.destfileStream != null) {
                this.destfileStream.close();
                this.destfileStream = null;
            }
        }
        catch (Exception e) {
    ...
    public void getFileStream() throws DbfException {
        try {
            ...
            this.fileStream = new FileInputStream(dbfFile);
            if (dbfFile.length() > 0xA00000L || this.batchDataMode) {
    ...
    public void getWirteFileStream() throws DbfException {
        try {
            this.destfileStream = new FileOutputStream(SinglePathUtil.normalize(this.dbfFileName));
            this.binaryWriter = new BufferedOutputStream(this.destfileStream);
            this.isFileOpened = true;
        }
        catch (Exception e) {
            throw new DbfException("fail to read  " + this.dbfFileName + ".");
    ...
    private void writeHeader() throws DbfException {
        try {
            ...
            if (this.bufferReadWrite) {
                ...
                this.binaryWriter.write(headBuffer);
            } else {
                this.binaryWriter.write(this.dbfHeader.getVersion());
                this.binaryWriter.write(this.dbfHeader.getLastModifyYear());
                this.binaryWriter.write(this.dbfHeader.getLastModifyMonth());
                this.binaryWriter.write(this.dbfHeader.getLastModifyDay());
                ...
                this.binaryWriter.write(this.dbfHeader.getReserved());
                this.binaryWriter.write(this.dbfHeader.getTableFlag());
                this.binaryWriter.write(this.dbfHeader.getCodePageFlag());
                this.binaryWriter.write(this.dbfHeader.getReserved2());
            }
        }
        catch (Exception e) {
    ...
    private void writeOthers() throws DbfException {
        ...
        try {
            ...
            this.binaryWriter.write(strByte);
        }
        catch (Exception e) {
            throw new DbfException(e.getMessage(), e);
        }
    ...
    private void readCrcCode() throws DbfException {
        ...
        try {
            this.fileStream.skip(this.fileStream.available() - 16);
            boolean isFile = true;
    ...
    private void generateCrcCode() throws DbfException {
        try {
            ...
            if (offset <= this.fileStream.available()) {
                this.fileStream.skip(offset);
            } else {
                int offset2;
                int skipOffset;
                for (offset2 = offset; offset2 > this.fileStream.available(); offset2 -= skipOffset) {
                    skipOffset = this.fileStream.available();
                    this.fileStream.skip(skipOffset);
                }
                if (offset2 > 0 && offset2 < this.fileStream.available()) {
                    this.fileStream.skip(offset2);
                }
            }
    ...
    private void writeCrcCode() throws DbfException {
        try {
            ...
            int filezie = this.dbfHeader.getHeaderLength2() + this.recordLength * this.dbfHeader.getRecordCount() + this.dbCrcCode.getLength();
            if (filezie != this.fileStream.available()) {
                // empty if block
            }
            this.binaryWriter.write(BitConverter.getBytes(this.dbCrcCode.getVersion()));
            this.binaryWriter.write(BitConverter.getBytes(this.dbCrcCode.getPosition()));
            this.binaryWriter.write(BitConverter.getBytes(this.dbCrcCode.getCrcCode()));
            this.binaryWriter.write(BitConverter.getBytes(this.dbCrcCode.getReserved()));
        ...
        try {
            for (int k = 0; k < this.fieldCount; ++k) {
                ...
                if (this.bufferReadWrite) {
                    ...
                    this.binaryWriter.write(fieldBuffer, 0, 32);
                    continue;
                }
                this.binaryWriter.write(field.getNameBytes(), 0, 11);
                this.writeByte(field.getTypeChar());
                this.binaryWriter.write(BitConverter.getBytes(field.getOffset()));
                ...
                this.binaryWriter.write(field.getReserved(), 0, 13);
            }
        }
        catch (Exception e) {
    ...
    public void getDbfRecords() throws DbfException {
        try {
            long otherSize = this.fileSize - (long)this.fileStream.available();
            long startPos = 0L;
            long skipLen = 0L;
            if (this.fieldCount < 2000) {
                startPos = this.dbfHeader.getHeaderLength2();
                skipLen = startPos - otherSize;
            } else {
                startPos = 32 + this.fieldCount * 32 + 1 + 263;
                skipLen = startPos - otherSize;
            }
            if (this.accessFile != null) {
            ...
            try {
                if (len > 2048000000) {
                    ...
                    while (len1 > 0) {
                        ...
                        this.fileStream.read(tempdata, 0, len1);
                ...
                if (this.accessFile != null && (accessFileFirst || len > 100)) {
                    ...
                    this.fileStream.skip(len);
                } else {
                    this.fileStream.read(b, 0, len);
                    if (this.accessFile != null) {
                        this.accessFile.skipBytes(len);
                    }
                }
            }
            catch (Exception e) {
    ...
    private void writeBytes(byte[] value, int len) throws DbfException {
        try {
            this.binaryWriter.write(value, 0, len);
        }
        catch (Exception e) {
            throw new DbfException(e.getMessage(), e);
        }
    ...
    private void writeRecordBuffer(int recordIndex) throws IOException {
        ...
        if (this.fieldCount < 2000) {
            this.binaryWriter.write(this.recordBuffer, 0, this.dbfHeader.getRecordLength2());
        } else {
            this.binaryWriter.write(this.recordBuffer, 0, this.recordLength);
        }
    }
