...
@Component
public class ICRTableNODDLDeployExecutor
implements NODDLDeployExecutor {
    ...
    public List<String> preDeploy(String taskKey) {
        try {
            return this.integrityCheckObserver.getICRTableDeployTable(taskKey);
        }
        catch (Exception e) {
    ...
    public void doDeploy(String taskKey) {
        this.integrityCheckObserver.registerICRTable(taskKey);
    }
