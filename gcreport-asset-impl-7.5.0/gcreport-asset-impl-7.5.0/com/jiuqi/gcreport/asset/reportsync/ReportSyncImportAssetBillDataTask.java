...
@Component
public class ReportSyncImportAssetBillDataTask
implements IReportSyncImportTask {
    public Collection<String> exec(ReportSyncExportTaskContext reportSyncExportTaskContext) {
        ...
        logMsg.addAll(BillDataSyncTool.importCommonBillTxt((File)rootFolder, (String)"GC_COMBINEDASSETBILL"));
        logMsg.addAll(BillDataSyncTool.importCommonBillTxt((File)rootFolder, (String)"GC_COMMONASSETBILL"));
        return logMsg;
    }
