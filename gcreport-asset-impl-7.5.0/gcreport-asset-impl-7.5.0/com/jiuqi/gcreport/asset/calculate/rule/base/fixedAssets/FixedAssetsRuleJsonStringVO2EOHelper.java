...
public class FixedAssetsRuleJsonStringVO2EOHelper {
    private UnionRuleVO unionRuleVO;
    private final String fixedAssetsType = "CUSTOMIZE";

    private FixedAssetsRuleJsonStringVO2EOHelper() {
    }

    public static FixedAssetsRuleJsonStringVO2EOHelper newInstance(UnionRuleVO unionRuleVO) {
        FixedAssetsRuleJsonStringVO2EOHelper helper = new FixedAssetsRuleJsonStringVO2EOHelper();
    ...
    private Map<String, Object> handleSaveOneDetailedSetting(Map<String, Object> detailedSetting, String debitOrCredit, int fetchConfigGroupIndex, int rowDebitOrCreditIndex) {
        if (!Objects.isNull(detailedSetting.get("type")) && !"CUSTOMIZE".equals(detailedSetting.get("type"))) {
            Object subjectCode = detailedSetting.get("subjectCode");
            if (subjectCode instanceof String) {
                detailedSetting.put("subjectCode", subjectCode);
            } else {
                detailedSetting.put("subjectCode", null);
            }
