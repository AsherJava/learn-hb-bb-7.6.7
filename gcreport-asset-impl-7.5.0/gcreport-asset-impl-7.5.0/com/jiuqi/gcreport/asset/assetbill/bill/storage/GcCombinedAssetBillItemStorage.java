...
public class GcCombinedAssetBillItemStorage {
    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = GcCombinedAssetBillItemStorage.getCreateDataMode(tenantName);
        DataModelDTO dataModelDTO = new DataModelDTO();
        dataModelDTO.setName("GC_COMBINEDASSETBILLITEM");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_COMBINEDASSETBILLITEM");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u7ec4\u5408\u8d44\u4ea7\u5355\u636e\u5b50\u8868");
        ...
        dataModelDO.addColumn("DPCAYEAR").columnTitle("\u6298\u65e7\u5e74\u9650").columnType(DataModelType.ColumnType.INTEGER).lengths(new Integer[]{4}).columnAttr(DataModelType.ColumnAttr.FIXED);
