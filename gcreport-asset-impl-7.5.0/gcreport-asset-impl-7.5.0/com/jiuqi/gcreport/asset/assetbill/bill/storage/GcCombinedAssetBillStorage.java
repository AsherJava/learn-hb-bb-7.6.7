...
public class GcCombinedAssetBillStorage {
    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = GcCombinedAssetBillStorage.getCreateDataMode(tenantName);
        DataModelDTO dataModelDTO = new DataModelDTO();
        dataModelDTO.setName("GC_COMBINEDASSETBILL");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_COMBINEDASSETBILL");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u7ec4\u5408\u8d44\u4ea7\u5355\u636e\u4e3b\u8868");
        ...
        dataModelDO.addColumn("DPCAYEAR").columnTitle("\u6298\u65e7\u5e74\u9650(\u6708)").columnType(DataModelType.ColumnType.INTEGER).lengths(new Integer[]{4}).columnAttr(DataModelType.ColumnAttr.FIXED);
        ...
        dataModelDO.addIndex("IDX_COMBASSET_BILLCODE").columnList(new String[]{"BILLCODE"}).unique(Boolean.valueOf(true));
        dataModelDO.addIndex("IDX_COMBASSET_UNIT").columnList(new String[]{"UNITCODE"});
        return dataModelDO;
    }
}
