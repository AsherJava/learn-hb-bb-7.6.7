 ...
 *  com.jiuqi.gcreport.asset.api.CombinedAssetBillClient
...
import com.jiuqi.gcreport.asset.api.CombinedAssetBillClient;
...
@RestController
public class CombinedAssetBillController
implements CombinedAssetBillClient {
    @Autowired
    private CombinedAssetBillService assetBillService;

    public String getAllBillListJson(String type) {
        return this.assetBillService.getAllBillListJson(type);
    }
    ...
    public BusinessResponseEntity<String> queryIdsByBillCode(String tableName, String billCode) {
        return BusinessResponseEntity.ok((Object)this.assetBillService.getIdsByBillCode(tableName, billCode));
    }
}
