...
@Excel(title="\u5e74\u7ed3\u79d1\u76ee\u6620\u5c04")
public class CarryOverSubjectMappingExcelModel {
    ...
    public CarryOverSubjectMappingExcelModel() {
    }

    public CarryOverSubjectMappingExcelModel(String srcSubjectCode, String destSubjectCode) {
