...
public class OrgDataCacheUtil {
    private static StringRedisTemplate stringRedisTemplate;
    private static Cache<String, String> importDataResultCache;
    private static Map<String, OrgDataCacheExtend> cacheExtends;

    public static Map<String, OrgDataCacheExtend> getCacheExtends() {
        if (cacheExtends == null) {
            cacheExtends = ApplicationContextRegister.getBeansOfType(OrgDataCacheExtend.class);
        }
        return cacheExtends;
    }
    ...
    public static void setImportDataResult(String key, String result) {
        if (EnvConfig.getRedisEnable()) {
            OrgDataCacheUtil.initRedisTemplate();
