...
public class OrgDataKryoSerializer {
    private static Logger logger = LoggerFactory.getLogger(OrgDataKryoSerializer.class);
    public static final byte[] EMPTY_BYTE_ARRAY = new byte[0];
    private static final ThreadLocal<Kryo> kryos = ThreadLocal.withInitial(Kryo::new);

    protected Kryo getKryo() {
        Kryo kryo = kryos.get();
        kryo.register(OrgCacheDO.class);
     ...
     */
    public byte[] serialize(OrgCacheDO obj) throws SerializationException {
        /*
     ...
     */
    public OrgCacheDO deserialize(byte[] bytes) throws SerializationException {
        ...
        try (Input input = new Input(bytes);){
            OrgCacheDO orgCacheDO = (OrgCacheDO)kryo.readObject(input, OrgCacheDO.class);
            return orgCacheDO;
        }
        catch (Exception e) {
