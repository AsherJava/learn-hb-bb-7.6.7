...
import com.jiuqi.nr.datascheme.internal.service.impl.FieldDynamicNodeProvider;
...
implements VerificationParser {
    ...
    public ValidationRule parse(String verification, DataField dataField) throws SyntaxException {
        ValidationRuleDTO dto;
        Assert.notNull((Object)verification, (String)"verification must not be null");
