...
public class GcBillPushOrgsItemStorage {
    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = GcBillPushOrgsItemStorage.getCreateDataMode(tenantName);
        DataModelDTO dataModelDTO = new DataModelDTO();
        dataModelDTO.setName("GC_BILLPUSHORGSITEM");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_BILLPUSHORGSITEM");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u6279\u91cf\u751f\u6210\u7ec4\u7ec7\u673a\u6784\u5b50\u8868");
