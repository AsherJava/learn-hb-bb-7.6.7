...
public class EditGroupTableGZWAction
extends RenameTableAction {
    private BSGroupService groupService;
    private static final String ID = "com.jiuqi.nr.batch.gather.gzw.web.app.action.edit.group";

    public EditGroupTableGZWAction(BSGroupService groupService) {
    ...
    public ActionInteractSetting getInteractSetting() {
        return BatchGatherPluginGZWConst.createGroupModal("\u7f16\u8f91\u5206\u7ec4");
    }
    ...
    public ActionResult run(ActionContext actionContext, String param) throws Exception {
        ...
        if (groupDefine != null) {
            return AddGroupToolBarGZWAction.returnActionResult(this.groupService.renameSchemeGroup(groupDefine.getKey(), groupDefine.getTitle()));
        }
        return BatchGatherPluginGZWConst.getFailActionResult(GroupServiceState.FAIL.code);
    }
}
