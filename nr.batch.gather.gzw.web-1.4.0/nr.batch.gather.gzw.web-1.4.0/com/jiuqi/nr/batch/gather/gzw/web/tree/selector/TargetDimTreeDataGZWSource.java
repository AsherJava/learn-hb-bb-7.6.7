...
public class TargetDimTreeDataGZWSource
extends TreeBuilder {
    ...
    public TargetDimTreeDataGZWSource(IEntityMetaService entityMetaService, ICalibreDefineService calibreDefineService, IRunTimeViewController rtController, ITreeContext context) {
    ...
    private List<IBaseNodeData> getBaseDataNodeData(IBaseNodeData parent) {
        ...
        if (this.taskDefine != null && (entityRefer = this.entityMetaService.getEntityRefer(this.taskDefine.getDw())) != null) {
    ...
    private List<IBaseNodeData> getCalibreNodeData(IBaseNodeData parent) {
        ...
        if (this.taskDefine != null) {
            ...
            calibreDefineDTO.setEntityId(this.taskDefine.getDw());
