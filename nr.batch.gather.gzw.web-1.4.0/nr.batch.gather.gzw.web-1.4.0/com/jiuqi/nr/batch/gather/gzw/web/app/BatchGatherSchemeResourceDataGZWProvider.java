...
public class BatchGatherSchemeResourceDataGZWProvider
implements IResourceDataProvider {
    ...
    public BatchGatherSchemeResourceDataGZWProvider(String taskKey, BSGroupService groupService, BSSchemeService schemeService) {
