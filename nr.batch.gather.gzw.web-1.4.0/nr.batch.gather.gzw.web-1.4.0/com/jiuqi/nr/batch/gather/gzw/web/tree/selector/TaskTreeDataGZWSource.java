...
public class TaskTreeDataGZWSource
extends TreeBuilder {
    ...
    public TaskTreeDataGZWSource(IRunTimeViewController rtViewService, IRuntimeDataSchemeService dataSchemeService, DefinitionAuthorityProvider authorityProvider) {
