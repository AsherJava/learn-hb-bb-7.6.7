...
@Component
public class BatchGatherSchemeManageGZWApp
implements IResourceCategoryApp {
    public static final String APP_ID = "batch-gather-GZW";
    @Resource
    ...
    public GlobalCondition getGlobalCondition() {
        ...
        pluginInfo.setPluginName("batch-gather-plugin-gzw");
        pluginInfo.setPluginType("batch-gather-plugin-gzw");
