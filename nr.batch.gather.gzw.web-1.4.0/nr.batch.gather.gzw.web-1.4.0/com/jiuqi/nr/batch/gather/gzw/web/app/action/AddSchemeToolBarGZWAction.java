...
public class AddSchemeToolBarGZWAction
extends AbstractToolbarAction {
    private static final String ID = "com.jiuqi.nr.batch.gather.gzw.web.app.action.new.scheme";
    ...
    public AddSchemeToolBarGZWAction(BatchGatherGZWContextData contextData, BSSchemeService schemeService) {
    ...
    public ActionResult run(ActionContext actionContext, String param) throws Exception {
        ...
        if (schemeDefine != null) {
            ActionResult actionResult = AddSchemeToolBarGZWAction.returnActionResult(this.schemeService.saveSummaryScheme(schemeDefine));
    ...
    private ResourceData translateSummaryScheme(SummaryScheme scheme) {
        ...
        rd.setResourceType("com.jiuqi.nr.batch.gather.gzw.web.app.scheme.resource.type");
    ...
    public static ActionResult returnActionResult(SchemeServiceState schemeServiceState) {
        switch (schemeServiceState) {
            ...
            case INVALID_TASK: {
                return BatchGatherPluginGZWConst.getFailActionResult(schemeServiceState.title);
            }
            case SUCCESS: {
                return BatchGatherPluginGZWConst.getSuccessActionResult(schemeServiceState.title, BatchGatherPluginGZWConst.getResourceNode());
            }
        }
        return BatchGatherPluginGZWConst.getFailActionResult(SchemeServiceState.FAIL.title);
    }
