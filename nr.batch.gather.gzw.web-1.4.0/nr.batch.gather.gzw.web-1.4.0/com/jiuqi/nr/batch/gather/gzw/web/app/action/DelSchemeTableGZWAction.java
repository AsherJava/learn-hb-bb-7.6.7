...
public class DelSchemeTableGZWAction
extends DelTableAction {
    public static final String ID = "com.jiuqi.nr.batch.gather.gzw.web.app.action.DelSchemeTableAction";
    private final BSSchemeService schemeService;

    public DelSchemeTableGZWAction(BSSchemeService schemeService) {
    ...
    public ActionResult run(ActionContext actionContext) throws Exception {
        ...
        return AddSchemeToolBarGZWAction.returnActionResult(this.schemeService.removeSummaryScheme(key));
    }
}
