...
public class EditSchemeTableGZWAction
extends AbstractTableAction {
    private static final String ID = "com.jiuqi.nr.batch.gather.gzw.web.app.action.edit.scheme";
    private final BSSchemeService schemeService;

    public EditSchemeTableGZWAction(BSSchemeService schemeService) {
    ...
    public ActionResult run(ActionContext actionContext, String param) throws Exception {
        ...
        if (schemeDefine != null) {
            return AddSchemeToolBarGZWAction.returnActionResult(this.schemeService.updateSummarySchemeDefine(schemeDefine));
        }
        return BatchGatherPluginGZWConst.getFailActionResult(SchemeServiceState.FAIL.code);
    }
}
