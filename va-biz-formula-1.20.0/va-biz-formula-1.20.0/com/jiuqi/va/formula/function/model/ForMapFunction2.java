...
@Component
public class ForMapFunction2
extends ModelFunction {
    private static final long serialVersionUID = 1L;

    public ForMapFunction2() {
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        return cxt.valueOf(resultDatas, dataType);
    }

    private void executeItem(IFormulaContext cxt, List<Object> dataSources, IASTNode expression, List<Object> resultDatas, int index) {
        ...
        try {
            ...
            if (evalData instanceof ArrayData) {
                ((ArrayData)evalData).forEach(resultDatas::add);
            } else {
                resultDatas.add(evalData);
            }
        }
        catch (SyntaxException e) {
            throw new FormulaException(BizFormualI18nUtil.getMessage("va.bizformula.execute.formap2.exception") + e.getMessage(), e);
        }
    }
    ...
    public String toDescription() {
        ...
        buffer.append("    ").append("    ").append("ForMap2(Left([ARRAY1],1), ToArray('sss','syy','zzz'))").append(FunctionUtils.LINE_SEPARATOR);
        buffer.append("    ").append("\u8fd4\u56de\uff1a").append(FunctionUtils.LINE_SEPARATOR);
        buffer.append("    ").append("    ").append("['s','s','z']");
    ...
    public FormulaDescription toFormulaDescription() {
        ...
        formulaExample.setFormula("ForMap2(Left([ARRAY1],1), ToArray('sss','syy','zzz'))");
        formulaExample.setReturnValue("['s','s','z']");
