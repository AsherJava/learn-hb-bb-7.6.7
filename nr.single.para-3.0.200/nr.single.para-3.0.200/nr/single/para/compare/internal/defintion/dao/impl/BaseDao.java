...
import nr.single.para.compare.definition.exception.BeanParaException;
import nr.single.para.compare.definition.exception.DBAnno;
import nr.single.para.compare.definition.exception.DBParaException;
...
public abstract class BaseDao {
    ...
    protected <T> RowMapper<T> getRowMapper(Class<? extends T> t) {
        return (rs, rowNum) -> {
            ...
            catch (IllegalAccessException | InstantiationException | BeanParaException e) {
