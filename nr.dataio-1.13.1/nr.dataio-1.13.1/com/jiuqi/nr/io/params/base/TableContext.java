...
implements Cloneable {
    ...
    private DimensionValueSet dimensionSetRange;
    ...
    public TableContext(String taskKey, String formSchemeKey, String formKey, DimensionValueSet dimensionSet, OptTypes optType, String fileType) {
    ...
    public TableContext(String taskKey, String formSchemeKey, String formKey, DimensionValueSet dimensionSet, OptTypes optType, String fileType, String split, String syncTaskID) {
        this.taskKey = taskKey;
        this.formSchemeKey = formSchemeKey;
        this.formKey = formKey;
        this.dimensionSet = dimensionSet;
    ...
    public TableContext clone() {
        ...
        try {
            tableContext = (TableContext)super.clone();
    ...
    public DimensionValueSet getDimensionSetRange() {
        return this.dimensionSetRange;
    }

    public void setDimensionSetRange(DimensionValueSet dimensionSetRange) {
        this.dimensionSetRange = dimensionSetRange;
    }
    ...
    public int getMdCodeCheckRule() {
        return this.mdCodeCheckRule;
    }

    public void setMdCodeCheckRule(int mdCodeCheckRule) {
        this.mdCodeCheckRule = mdCodeCheckRule;
    }
}
