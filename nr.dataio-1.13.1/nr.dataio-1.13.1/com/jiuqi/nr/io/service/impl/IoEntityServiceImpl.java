...
@Component
public class IoEntityServiceImpl
implements IoEntityService {
    private static final Logger log = LoggerFactory.getLogger(IoEntityServiceImpl.class);
    @Autowired
    ...
    @Override
    public IEntityTable getIEntityTable(EntityViewDefine entityView, TableContext tableContext, ExecutorContext context) throws Exception {
        IEntityQuery entityQuery = this.entityDataService.newEntityQuery();
        entityQuery.setEntityView(entityView);
        entityQuery.setAuthorityOperations(AuthorityType.None);
