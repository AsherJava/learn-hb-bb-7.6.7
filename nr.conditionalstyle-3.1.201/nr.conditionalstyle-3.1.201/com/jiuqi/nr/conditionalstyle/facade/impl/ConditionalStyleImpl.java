...
@DBAnno.DBTable(dbTable="NR_PARAM_CONDITIONAL_STYLE")
public class ConditionalStyleImpl
implements ConditionalStyle {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ConditionalStyleImpl) {
            ConditionalStyleImpl cs = new ConditionalStyleImpl();
