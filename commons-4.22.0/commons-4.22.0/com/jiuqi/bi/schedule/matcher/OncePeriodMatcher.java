...
public class OncePeriodMatcher
implements IPeriodMatcher {
    ...
    public boolean match(Calendar now, Task task) {
        ...
        int year = now.get(1);
        return year == task.getExecYear() && mouth == task.getExecMouth() && day == task.getExecMouthDay() && hour == task.getExecHour() && minute == task.getExecMinute();
    }
}
