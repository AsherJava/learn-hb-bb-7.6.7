...
public class WorkingPaperDxsItemDTO {
    ...
    public static WorkingPaperDxsItemDTO empty() {
        WorkingPaperDxsItemDTO emptyWorkingPaperDxsItemDTO = new WorkingPaperDxsItemDTO();
    ...
    public String getElmMode() {
        return this.elmMode;
    }

    public void setElmMode(String elmMode) {
