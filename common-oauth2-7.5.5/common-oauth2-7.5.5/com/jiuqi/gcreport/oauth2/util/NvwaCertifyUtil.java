...
public class NvwaCertifyUtil {
    private static final Logger logger = LoggerFactory.getLogger(NvwaCertifyUtil.class);

    public static GcCertifyExtInfo getExtInfoFromJson(NvwaCertify nvwaCertify) {
        ...
        GcCertifyExtInfo ext = null;
        try {
            ext = JsonUtils.readValue(extraInfo, GcCertifyExtInfo.class);
        }
        catch (Exception e) {
            logger.warn("\u8bf7\u68c0\u67e5\u8ba4\u8bc1\u670d\u52a1\u6269\u5c55\u4fe1\u606f\u914d\u7f6e\u662f\u5426\u6b63\u786e\uff0cextraInfo=" + extraInfo, e);
            throw new IllegalArgumentException("\u8bf7\u68c0\u67e5\u8ba4\u8bc1\u670d\u52a1\u6269\u5c55\u4fe1\u606f\u914d\u7f6e\u662f\u5426\u6b63\u786e", e);
        }
        Assert.hasText(ext.getAuthUrl(), "\u8ba4\u8bc1\u670d\u52a1\u6269\u5c55\u4fe1\u606fauthUrl\u4e0d\u80fd\u4e3a\u7a7a");
        Assert.hasText(ext.getTokenUrl(), "\u8ba4\u8bc1\u670d\u52a1\u6269\u5c55\u4fe1\u606ftokenUrl\u4e0d\u80fd\u4e3a\u7a7a");
        Assert.hasText(ext.getUserInfoUrl(), "\u8ba4\u8bc1\u670d\u52a1\u6269\u5c55\u4fe1\u606fuserInfoUrl\u4e0d\u80fd\u4e3a\u7a7a");
        return ext;
    }
}
