...
import com.jiuqi.gcreport.offsetitem.factory.action.button.CopyOffsetButton;
...
import com.jiuqi.gcreport.offsetitem.factory.action.query.offset.OffsetQueryAction;
...
@Component
public class GcOffsetShowType
implements GcOffsetItemShowType {
    @Autowired
    private OffsetQueryAction offsetQueryAction;
    @Autowired
    ...
    @Autowired
    private CopyOffsetButton copyOffsetButton;
    @Autowired
    ...
    public String getCode() {
        return FilterMethodEnum.OFFSET.getCode();
    }

    public String getTitle() {
        return FilterMethodEnum.OFFSET.getTitle();
    }
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.offsetQueryAction);
        ...
        list.add((GcOffSetItemAction)this.copyOffsetButton);
        list.add((GcOffSetItemAction)this.gcAdjustButton);
        return list;
    }

    public boolean isEnableMemorySort() {
        return super.isEnableMemorySort();
    }
}
