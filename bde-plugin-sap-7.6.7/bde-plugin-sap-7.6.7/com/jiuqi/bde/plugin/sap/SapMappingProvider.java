...
@Component
public class SapMappingProvider
implements IOrgMappingTypeProvider {
    ...
    public List<OrgMappingTypeDTO> listMappingType(DataSchemeDTO dto) {
        ...
        for (SapOrgMappingType orgMappingType : SapOrgMappingType.values()) {
            list.add(SapMappingProvider.buildOrgMappingType(dto, orgMappingType));
        }
        return list;
    }

    private static OrgMappingTypeDTO buildOrgMappingType(DataSchemeDTO dto, SapOrgMappingType orgMappingType) {
