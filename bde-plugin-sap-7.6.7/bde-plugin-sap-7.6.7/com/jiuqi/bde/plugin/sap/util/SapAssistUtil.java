...
@Component
public class SapAssistUtil {
    @Value(value="classpath:/template/sapSchemeInitDefine.json")
    private Resource schemeInitTmplateDefine;
    private String schemeInitTmplateJson;

    public List<SapDefaultAssistPojo> getDefaultAssistList() {
        if (this.schemeInitTmplateJson == null) {
            try (BufferedInputStream br = new BufferedInputStream(this.schemeInitTmplateDefine.getInputStream());){
                ...
                throw new BusinessRuntimeException("SAP\u63d2\u4ef6\u9ed8\u8ba4\u521d\u59cb\u5316\u65b9\u6848\u52a0\u8f7d\u5931\u8d25", (Throwable)e);
            }
        }
        return (List)JsonUtils.readValue((String)this.schemeInitTmplateJson, (TypeReference)new TypeReference<List<SapDefaultAssistPojo>>(){});
    }
}
