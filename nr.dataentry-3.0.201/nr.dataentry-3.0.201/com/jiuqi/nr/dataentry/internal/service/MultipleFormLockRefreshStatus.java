...
@Component
public class MultipleFormLockRefreshStatus
implements IRefreshStatus {
    ...
    public boolean getEnable(String taskKey, String formSchemeKey) {
        ...
        return StringUtils.isNotEmpty((String)multiUserLock) && multiUserLock.equals("1");
    }

    @Override
    public String getName() {
        return "multipleFormLock";
    }
    ...
    public Map<String, String> getStatus(JtableContext context) throws Exception {
        ...
        Map<String, String> formLockMap = this.formLockService.getLockedFormKeysMapByUser(formLockParam, false);
        return formLockMap;
    }
}
