...
public class RegionMatchInfo {
    ...
    public RegionMatchInfo(RegionData region, Grid2Data sampleGD, ReportLinkDataCache linkDataCache, int preAreaEnd) {
        this.region = region;
        if (DataRegionKind.DATA_REGION_COLUMN_LIST.getValue() == this.region.getType()) {
