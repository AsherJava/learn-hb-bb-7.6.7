...
public class ExcelErrorUtil {
    ...
    public static Workbook exportExcel(ImportResultObject res, ImportResultExcelFileObject tempRes, Workbook wb) {
        ...
        Integer sheetIs = 0;
        Integer index = 1;
        Map<String, Object> resMap = ExcelErrorUtil.getSheet(null, workbookNew, sheetIs, style, index, wb);
        ...
        if (null != tempRes.getFileError().getErrorCode()) {
            ...
            fails.add(one);
            resMap = ExcelErrorUtil.getSheet(sheet, workbookNew, sheetIs, style, index, wb);
     ...
     */
    private static Map<String, Object> getSheet(Sheet sheet, Workbook wb, Integer sheetCount, CellStyle style, Integer index, Workbook oldWorkBook) {
        Integer n;
        Integer n2;
        int lastRow;
        HashMap<String, Object> resMap = new HashMap<String, Object>();
        if (null == sheet) {
            sheet = wb.createSheet("(\u9519\u8bef\u4fe1\u606f\u6620\u5c04\u8868)");
            wb.setSheetOrder("(\u9519\u8bef\u4fe1\u606f\u6620\u5c04\u8868)", sheetCount);
            ...
            sheet = wb.createSheet("(\u9519\u8bef\u4fe1\u606f\u6620\u5c04\u8868)" + sheetCount);
            wb.setSheetOrder("(\u9519\u8bef\u4fe1\u606f\u6620\u5c04\u8868)" + sheetCount, sheetCount);
            resMap.put(KEY_ROW, 1);
        } else {
            lastRow = sheet.getLastRowNum();
            if (lastRow <= 100000) {
        ...
        String[] title = new String[]{"\u5e8f\u53f7", "\u9519\u8bef\u4fe1\u606f", "sheet\u9875", "\u62a5\u8868\u540d\u79f0"};
        ...
        if (oldWorkBook instanceof StreamingWorkbook) {
            ...
            Comment comment = draw.createCellComment(new XSSFClientAnchor(0, 0, 0, 0, 0, 0, 2, 2));
    ...
    private static void copySheets(Sheet newSheet, Sheet sheet) {
        ...
        for (Object srcRow : sheet) {
            ...
            ++i;
            if (sheet instanceof StreamingSheet || srcRow.getLastCellNum() <= maxColumnNum) continue;
