...
public class FlowData {
    ...
    public List<Integer> promptStatus;
    public boolean UnitSubmitForForce = false;
    ...
    public void init(TaskFlowsDefine taskFlowsDefine) {
        ...
        for (Role identity : byIdentitys) {
            if (!taskFlowsDefine.isUnitSubmitForForce() || !sysIdentityService.isSystemIdentity(identityId) && !identity.getId().toString().equals(selectedRoleForceKey)) continue;
