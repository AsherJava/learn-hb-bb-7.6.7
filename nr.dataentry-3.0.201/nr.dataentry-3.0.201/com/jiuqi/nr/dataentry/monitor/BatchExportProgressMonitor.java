...
public class BatchExportProgressMonitor
implements AsyncTaskMonitor {
    private AsyncTaskMonitor asyncTaskMonitor;
    private double coefficient;
    private double progress;

    public BatchExportProgressMonitor(AsyncTaskMonitor asyncTaskMonitor, double coefficient, double progress) {
    ...
    public void finish(String result, Object detail) {
        this.asyncTaskMonitor.progressAndMessage(this.progress + this.coefficient, "export_in_progress_info");
    }
