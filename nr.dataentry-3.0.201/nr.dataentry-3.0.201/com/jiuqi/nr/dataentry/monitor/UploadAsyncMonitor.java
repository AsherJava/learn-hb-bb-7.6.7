...
public class UploadAsyncMonitor
implements AsyncTaskMonitor {
    private AsyncTaskMonitor asyncTaskMonitor;
    private double coefficient;
    private double progress;

    public UploadAsyncMonitor(AsyncTaskMonitor asyncTaskMonitor, double coefficient, double progress) {
    ...
    public void canceling(String result, Object detail) {
        this.asyncTaskMonitor.canceling(result, detail);
    }
    ...
    public void error(String cause, Throwable t) {
        this.asyncTaskMonitor.error(cause, t);
    }

    public boolean isFinish() {
        return this.asyncTaskMonitor.isFinish();
    }

    public double getLastProgress() {
        return (this.asyncTaskMonitor.getLastProgress() - this.progress) / this.coefficient;
    }
