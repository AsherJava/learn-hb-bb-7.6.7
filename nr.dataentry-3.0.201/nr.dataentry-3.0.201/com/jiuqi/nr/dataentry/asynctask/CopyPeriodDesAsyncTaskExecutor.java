...
@RealTimeJob(group="ASYNCTASK_COPYDESFROMLASTPERIOD", groupTitle="\u540c\u6b65\u4e0a\u671f\u51fa\u9519\u8bf4\u660e", subject="\u62a5\u8868", tags={"\u957f\u4efb\u52a1"})
public class CopyPeriodDesAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final Logger logger = LoggerFactory.getLogger(CopyPeriodDesAsyncTaskExecutor.class);
    public static final String NAME = "ASYNCTASK_COPYDESFROMLASTPERIOD";
    ...
    public void executeWithNpContext(JobContext jobContext) {
        ...
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                ...
                cpoyErrorDesService.copyErrorDesfromLastPeriod(context, (AsyncTaskMonitor)asyncTaskMonitor);
            }
        }
