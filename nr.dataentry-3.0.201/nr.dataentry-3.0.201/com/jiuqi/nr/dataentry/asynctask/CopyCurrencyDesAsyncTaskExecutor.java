...
@RealTimeJob(group="ASYNCTASK_COPYDESTOOTHERCURRENCY", groupTitle="\u5e01\u79cd\u95f4\u540c\u6b65\u51fa\u9519\u8bf4\u660e", subject="\u62a5\u8868", tags={"\u957f\u4efb\u52a1"})
public class CopyCurrencyDesAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final Logger logger = LoggerFactory.getLogger(CopyPeriodDesAsyncTaskExecutor.class);
    public static final String NAME = "ASYNCTASK_COPYDESTOOTHERCURRENCY";
    ...
    public void executeWithNpContext(JobContext jobContext) {
        ...
        ICpoyErrorDesService cpoyErrorDesService = (ICpoyErrorDesService)BeanUtil.getBean(ICpoyErrorDesService.class);
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                JtableContext context = (JtableContext)SimpleParamConverter.SerializationUtils.deserialize((String)((String)params.get("NR_ARGS")));
                cpoyErrorDesService.copyErrorDesToOtherCurrency(context, (AsyncTaskMonitor)asyncTaskMonitor);
            }
        }
