...
@Component
@RealTimeJob(group="ASYNCTASK_BATCHCOPY", groupTitle="\u6279\u91cf\u590d\u5236", subject="\u62a5\u8868", tags={"\u957f\u4efb\u52a1"})
public class BatchCopyAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final Logger logger = LoggerFactory.getLogger(BatchCopyAsyncTaskExecutor.class);

    public void execute(JobContext jobContext) {
        IBatchCopyService batchCopyService = (IBatchCopyService)BeanUtil.getBean(IBatchCopyService.class);
        ...
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                BatchCopyInfo batchCopyInfo = (BatchCopyInfo)((Object)SimpleParamConverter.SerializationUtils.deserialize((String)((String)params.get("NR_ARGS"))));
                batchCopyService.batchCopyForm(batchCopyInfo, (AsyncTaskMonitor)asyncTaskMonitor);
            }
        }
    ...
    public String getTaskPoolType() {
        return AsynctaskPoolType.ASYNCTASK_BATCHCOPY.getName();
    }
}
