...
@RealTimeJob(group="ASYNCTASK_BATCHREFRESHSTATUS", groupTitle="\u6279\u91cf\u5237\u65b0\u72b6\u6001", subject="\u62a5\u8868", tags={"\u957f\u4efb\u52a1"})
public class BatchRefreshStatusTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final Logger logger = LoggerFactory.getLogger(BatchRefreshStatusTaskExecutor.class);
    public static final String NAME = "ASYNCTASK_BATCHREFRESHSTATUS";

    public void executeWithNpContext(JobContext jobContext) {
        String errorInfo = "task_error_info";
        String cancelInfo = "task_cancel_info";
        SCBatchRefreshStatusService scBatchRefreshStatusService = (SCBatchRefreshStatusService)BeanUtil.getBean(SCBatchRefreshStatusService.class);
        ...
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                RefreshStatusObj refreshStatusObj = (RefreshStatusObj)SimpleParamConverter.SerializationUtils.deserialize((String)((String)params.get("NR_ARGS")));
                scBatchRefreshStatusService.refreshAllStatus(refreshStatusObj, (AsyncTaskMonitor)asyncTaskMonitor);
            }
            if (asyncTaskMonitor.isCancel()) {
                asyncTaskMonitor.canceled("stop_execute", (Object)cancelInfo);
                LogHelper.info((String)"\u6279\u91cf\u5237\u65b0\u72b6\u6001", (String)"\u53d6\u6d88\u4efb\u52a1\u6267\u884c", (String)"");
            }
        }
