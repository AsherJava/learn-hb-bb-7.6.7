...
@RealTimeJob(group="ASYNCTASK_BATCHEXPORT", cancellable=true, rollback=true, groupTitle="\u6279\u91cf\u5bfc\u51fa", subject="\u62a5\u8868", tags={"\u957f\u4efb\u52a1"})
public class BatchExportAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final Logger logger = LoggerFactory.getLogger(BatchExportAsyncTaskExecutor.class);
    ...
    public void executeWithNpContext(JobContext jobContext) {
        ...
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                BatchExportInfo batchExportInfo = (BatchExportInfo)SimpleParamConverter.SerializationUtils.deserialize((String)((String)params.get("NR_ARGS")));
                batchExportService.export(batchExportInfo, (AsyncTaskMonitor)asyncTaskMonitor);
            }
        }
