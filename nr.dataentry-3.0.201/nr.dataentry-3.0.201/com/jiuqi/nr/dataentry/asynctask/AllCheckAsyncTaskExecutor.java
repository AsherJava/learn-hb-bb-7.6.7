...
@RealTimeJob(group="ASYNCTASK_ALLCHECK", groupTitle="\u5168\u5ba1", subject="\u62a5\u8868", tags={"\u77ed\u4efb\u52a1"})
...
extends NpRealTimeTaskExecutor {
    ...
    public void executeWithNpContext(JobContext jobContext) {
        ...
        IAllCheckService allCheckService = (IAllCheckService)BeanUtil.getBean(IAllCheckService.class);
        String taskId = jobContext.getInstanceId();
        AbstractRealTimeJob job = jobContext.getRealTimeJob();
        Map params = job.getParams();
        RealTimeTaskMonitor asyncTaskMonitor = new RealTimeTaskMonitor(taskId, AsynctaskPoolType.ASYNCTASK_ALLCHECK.getName(), jobContext);
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                AllCheckInfo batchCheckInfo = (AllCheckInfo)((Object)SimpleParamConverter.SerializationUtils.deserialize((String)((String)params.get("NR_ARGS"))));
                allCheckService.allCheckForm(batchCheckInfo, (AsyncTaskMonitor)asyncTaskMonitor);
            }
        }
    ...
    public String getTaskPoolType() {
        return AsynctaskPoolType.ASYNCTASK_ALLCHECK.getName();
    }
}
