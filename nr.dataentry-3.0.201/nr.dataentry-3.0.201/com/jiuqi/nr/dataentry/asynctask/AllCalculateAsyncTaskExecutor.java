...
@RealTimeJob(group="ASYNCTASK_ALLCALCULATE", groupTitle="\u5168\u7b97", subject="\u62a5\u8868", tags={"\u77ed\u4efb\u52a1"})
public class AllCalculateAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final Logger logger = LoggerFactory.getLogger(AllCalculateAsyncTaskExecutor.class);
    ...
    public void executeWithNpContext(JobContext jobContext) {
        ...
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                ...
                if (definitionAuthorityProvider.canReadFormulaScheme(batchCalculateInfo.getFormulaSchemeKey())) {
