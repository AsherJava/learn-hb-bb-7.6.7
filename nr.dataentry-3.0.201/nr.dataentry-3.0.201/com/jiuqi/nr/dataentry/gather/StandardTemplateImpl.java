...
public class StandardTemplateImpl
implements TemplateItem {
    private static final Logger logger = LoggerFactory.getLogger(StandardTemplateImpl.class);
    ...
    public String getContent() {
        ...
        String content = "";
        try {
            ClassPathResource templateResource = new ClassPathResource("template/template_default.json");
