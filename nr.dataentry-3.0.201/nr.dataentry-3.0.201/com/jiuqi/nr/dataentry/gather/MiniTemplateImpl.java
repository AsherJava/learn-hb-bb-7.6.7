...
public class MiniTemplateImpl
implements TemplateItem {
    private static final Logger logger = LoggerFactory.getLogger(MiniTemplateImpl.class);
    ...
    public String getContent() {
        ...
        String content = "";
        try {
            ClassPathResource templateResource = new ClassPathResource("template/template_mini.json");
