...
import com.jiuqi.nr.dataentry.templTransfer.TemplTransferFactory;
...
@Component
public class TempelTransferInit
implements ApplicationInitialization {
    private static final Logger LOGGER = LoggerFactory.getLogger(TempelTransferInit.class);
    @Autowired
    private TemplTransferFactory templTransferFactory;

    public void init(boolean isSysTenant) {
        try {
            LOGGER.info("\u5f00\u59cb\u5411\u5973\u5a32\u5bfc\u5165\u5bfc\u51fa\u6ce8\u518c\u6570\u636e\u5f55\u5165\u6a21\u677f\u6a21\u5757");
            ...
            TransferFactoryManager.getInstance().register((TransferFactory)this.templTransferFactory);
            LOGGER.info("\u6ce8\u518c\u5de5\u5382- \u6570\u636e\u5f55\u5165\u6a21\u677f\u5b8c\u6210");
        }
        catch (TransferException e) {
            LOGGER.error("\u6570\u636e\u5f55\u5165\u6a21\u677f\u5bfc\u5165\u5bfc\u51fa\u6a21\u5757\u6ce8\u518c\u5931\u8d25", e);
        }
    }
}
