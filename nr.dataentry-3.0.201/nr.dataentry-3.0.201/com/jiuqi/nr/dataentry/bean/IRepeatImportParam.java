...
public class IRepeatImportParam
implements Serializable {
    private List<IRepeatEntityNode> entityNodes;
    private List<IRepeatFormNode> formNodes;
    ...
    public List<IRepeatEntityNode> getEntityNodes() {
        if (this.entityNodes == null) {
            this.entityNodes = new ArrayList<IRepeatEntityNode>();
        }
        return this.entityNodes;
    }

    public void setEntityNodes(List<IRepeatEntityNode> entityNodes) {
        this.entityNodes = entityNodes;
    }

    public List<IRepeatFormNode> getFormNodes() {
        if (this.formNodes == null) {
            this.formNodes = new ArrayList<IRepeatFormNode>();
        }
        return this.formNodes;
    }

    public void setFormNodes(List<IRepeatFormNode> formNodes) {
