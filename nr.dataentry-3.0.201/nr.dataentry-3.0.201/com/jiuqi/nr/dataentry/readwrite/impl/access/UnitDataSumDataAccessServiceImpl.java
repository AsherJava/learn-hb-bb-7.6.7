...
@Service
public class UnitDataSumDataAccessServiceImpl
implements IDataExtendAccessItemService {
    private static final Logger logger = LoggerFactory.getLogger(UnitDataSumDataAccessServiceImpl.class);
    private static final String SUM_DATA_MSG = "\u6c47\u603b\u6570\u636e\uff0c\u4e0d\u53ef\u5199";
    private Function<String, String> noAccessResion = code -> Optional.ofNullable(code).filter(e -> e.equals("1")).orElse(SUM_DATA_MSG);
