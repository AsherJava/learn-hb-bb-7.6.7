...
@Component
public class DecimalReadWriteAccessImpl
implements IReadWriteAccess {
    ...
    public ReadWriteAccessDesc writeable(ReadWriteAccessItem item, JtableContext context) throws Exception {
        ...
        if (decimal != null && !decimal.equals("")) {
            String message = "\u5f53\u524d\u5c0f\u6570\u4f4d\u6570\u4e0d\u662f\u9ed8\u8ba4\u503c\uff0c\u4e0d\u53ef\u5199";
            if (StringUtils.isNotEmpty((String)this.i18nHelper.getMessage("DECIMAL_DIGITS_CANNOT_WRITTEN"))) {
                message = this.i18nHelper.getMessage("DECIMAL_DIGITS_CANNOT_WRITTEN");
            }
