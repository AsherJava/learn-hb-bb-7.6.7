...
public class DataPublishObserver
implements Observer,
ApplicationListener<NrTaskDeleteEvent> {
    ...
    public String getName() {
        return "\u6570\u636e\u53d1\u5e03\u72b6\u6001\u8868" + this.getClass().getName();
    }
    ...
    private void deployDataPublish(DesignTaskDefine taskDefine, FormSchemeDefine scheme) throws Exception {
        String tableCode = "DE_DAPU_" + scheme.getFormSchemeCode();
        ...
        tableDefine.setDesc("\u4efb\u52a1\u3010" + taskDefine.getTitle() + "\u3011\u62a5\u8868\u65b9\u6848\u3010" + scheme.getTitle() + "\u3011\u5bf9\u5e94\u6570\u636e\u53d1\u5e03\u72b6\u6001\u8868");
        tableDefine.setTitle("\u4efb\u52a1\u3010" + taskDefine.getTitle() + "\u3011\u62a5\u8868\u65b9\u6848\u3010" + scheme.getTitle() + "\u3011\u5bf9\u5e94\u6570\u636e\u53d1\u5e03\u72b6\u6001\u8868");
        ...
        DeployUtil.initField_String(tableKey, "DAPU_RECID", null, createFieldList, modifyFieldList, 50, this.nvwaDataModelDeployUtil);
        DeployUtil.initField_Boolean(tableKey, "DAPU_ISPUBLISH", null, createFieldList, modifyFieldList, this.nvwaDataModelDeployUtil);
        ...
        tableEnityMasterKeys.append(DeployUtil.initField_String(tableKey, "DAPU_FORMSCHEMEKEY", null, createFieldList, modifyFieldList, 50, this.nvwaDataModelDeployUtil)).append(";");
        tableEnityMasterKeys.append(DeployUtil.initField_String(tableKey, "DAPU_FORMKEY", null, createFieldList, modifyFieldList, 50, this.nvwaDataModelDeployUtil)).append(";");
    ...
    public void onApplicationEvent(NrTaskDeleteEvent event) {
        ...
        for (FormSchemeDefine scheme : formSchemeDefines) {
            this.nvwaDataModelDeployUtil.deployDeleteTableByCode("DE_DAPU_" + scheme.getFormSchemeCode());
            this.nvwaDataModelDeployUtil.deployDeleteTableByCode("DE_DAPU_" + scheme.getFormSchemeCode());
        }
    }
}
