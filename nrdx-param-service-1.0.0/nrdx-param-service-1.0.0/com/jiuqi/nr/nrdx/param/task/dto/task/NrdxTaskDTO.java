 ...
 *  com.jiuqi.nr.param.transfer.definition.dto.task.TaskDTO
...
public class NrdxTaskDTO {
    ...
    public static NrdxTaskDTO valueOf(TaskDefine taskDefine) {
        if (taskDefine == null) {
            return null;
        }
        NrdxTaskDTO nrdxTaskDTO = new NrdxTaskDTO();
        nrdxTaskDTO.setMeasureUnit(taskDefine.getMeasureUnit());
        nrdxTaskDTO.setFromPeriod(taskDefine.getFromPeriod());
        nrdxTaskDTO.setToPeriod(taskDefine.getToPeriod());
        nrdxTaskDTO.setTaskPeriodOffset(taskDefine.getTaskPeriodOffset());
        nrdxTaskDTO.setTaskCode(taskDefine.getTaskCode());
        nrdxTaskDTO.setTaskFilePrefix(taskDefine.getTaskFilePrefix());
        nrdxTaskDTO.setKey(taskDefine.getKey());
        nrdxTaskDTO.setTitle(taskDefine.getTitle());
        nrdxTaskDTO.setOrder(taskDefine.getOrder());
        nrdxTaskDTO.setVersion(taskDefine.getVersion());
        nrdxTaskDTO.setOwnerLevelAndId(taskDefine.getOwnerLevelAndId());
        nrdxTaskDTO.setUpdateTime(taskDefine.getUpdateTime());
        nrdxTaskDTO.setDescription(taskDefine.getDescription());
        nrdxTaskDTO.setTaskGatherType(taskDefine.getTaskGatherType());
        nrdxTaskDTO.setFormulaSyntaxStyle(taskDefine.getFormulaSyntaxStyle());
        nrdxTaskDTO.setViewsInEFDC(taskDefine.getEntityViewsInEFDC());
        nrdxTaskDTO.setTaskType(taskDefine.getTaskType());
        nrdxTaskDTO.setCreateUserName(taskDefine.getCreateUserName());
        nrdxTaskDTO.setCreateTime(taskDefine.getCreateTime());
        nrdxTaskDTO.setEfdcSwitch(taskDefine.getEfdcSwitch());
        nrdxTaskDTO.setFillInAutomaticallyDue(taskDefine.getFillInAutomaticallyDue());
        nrdxTaskDTO.setDataScheme(taskDefine.getDataScheme());
        nrdxTaskDTO.setDw(taskDefine.getDw());
        nrdxTaskDTO.setDatetime(taskDefine.getDateTime());
        nrdxTaskDTO.setDims(taskDefine.getDims());
        nrdxTaskDTO.setEntityViewID(taskDefine.getFilterTemplate());
        nrdxTaskDTO.setFilterExpression(taskDefine.getFilterExpression());
        nrdxTaskDTO.setFillingDateType(taskDefine.getFillingDateType().getValue());
        nrdxTaskDTO.setFillingDateDays(taskDefine.getFillingDateDays());
        return nrdxTaskDTO;
    }
