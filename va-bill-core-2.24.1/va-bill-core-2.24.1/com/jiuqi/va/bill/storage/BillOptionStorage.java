...
public class BillOptionStorage {
    public static void init(String tenantName) {
        JDialectUtil jDialect = JDialectUtil.getInstance();
        try {
            JTableModel jtm = BillOptionStorage.getCreateJTM(tenantName);
    ...
    public static JTableModel getCreateJTM(String tenantName) {
        JTableModel jtm = new JTableModel(tenantName, "OPTION_BILL");
        ...
        jtm.index("IDX_OPTION_BILL_NAME").columns(new String[]{"NAME"}).unique();
        return jtm;
    }
}
