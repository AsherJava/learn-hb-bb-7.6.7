...
public class BillCommitAfterQueueListener
extends AbstractBillAfterQueueListener {
    @Override
    protected void doMessage(Map<String, Object> param) {
        this.vaBillQueueMsgHandler.billCommitAfter(param);
    }

    @Override
    protected String getErrorMessage() {
        return BillCoreI18nUtil.getMessage("va.billcore.billqueuereceiver.commitactionfailed");
    }

    public BillCommitAfterQueueListener() {
    }

    public BillCommitAfterQueueListener(String joinName, int maxConsumers, VaBillQueueMsgHandler vaBillQueueMsgHandler, VaBizErrorService vaBizErrorService) {
