...
public class BillRetractAfterQueueListener
extends AbstractBillAfterQueueListener {
    @Override
    protected void doMessage(Map<String, Object> param) {
        this.vaBillQueueMsgHandler.billRetractAfter(param);
    }

    @Override
    protected String getErrorMessage() {
        return BillCoreI18nUtil.getMessage("va.billcore.billqueuereceiver.retractionfailed");
    }

    public BillRetractAfterQueueListener() {
    }

    public BillRetractAfterQueueListener(String joinName, VaBillQueueMsgHandler vaBillQueueMsgHandler, VaBizErrorService vaBizErrorService) {
