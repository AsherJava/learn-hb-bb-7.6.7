...
implements I18nControl {
    ...
    public List<VaI18nResourceItem> getI18nResource(Control control, ModelDefine modelDefine, String schemeName) {
        ...
        VaI18nResourceItem textItem = new VaI18nResourceItem();
        textItem.setName(controlId);
        textItem.setUniqueName(modelDefine.getName() + "#" + schemeName + "#" + controlId);
        textItem.setTitle(control.getProps().get("content").toString());
        pluginResourceList.add(textItem);
