...
implements I18nControl {
    ...
    public List<VaI18nResourceItem> getI18nResource(Control control, ModelDefine modelDefine, String schemeName) {
        ...
        VaI18nResourceItem panelItem = new VaI18nResourceItem();
        panelItem.setName(controlId);
        panelItem.setUniqueName(modelDefine.getName() + "#" + schemeName + "#" + controlId);
        panelItem.setTitle(control.getProps().get("title").toString());
        pluginResourceList.add(panelItem);
