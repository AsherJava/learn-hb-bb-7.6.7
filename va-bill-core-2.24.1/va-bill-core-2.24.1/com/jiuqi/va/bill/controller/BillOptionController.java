...
public class BillOptionController {
    @Autowired
    ...
    List<OptionItemVO> list(@RequestBody OptionItemDTO param) {
        return this.billOptionService.list(param);
    }

    @PostMapping(value={"/option/update"})
    R update(@RequestBody BillOptionDO option) {
        return this.billOptionService.update(option);
    }
}
