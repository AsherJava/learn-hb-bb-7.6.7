...
public class ArbitrarilyMergeQueryCondition {
    private String taskID;
    private String taskName;
    private String schemeID;
    private String schemeName;
    private Instant yearPeriod;
    ...
    private GcConsolidatedSubjectVo[] baseSubjectProp;
    ...
    public Instant getYearPeriod() {
        return this.yearPeriod;
    }

    public void setYearPeriod(Instant yearPeriod) {
    ...
    public GcConsolidatedSubjectVo[] getBaseSubjectProp() {
        return this.baseSubjectProp;
    }

    public void setBaseSubjectProp(GcConsolidatedSubjectVo[] baseSubjectProp) {
