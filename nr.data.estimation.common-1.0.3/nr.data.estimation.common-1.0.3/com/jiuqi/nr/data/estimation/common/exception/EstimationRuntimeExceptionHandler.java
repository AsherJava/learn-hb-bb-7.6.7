 ...
 */
package com.jiuqi.nr.data.estimation.common.exception;
...
@Configuration
@ControllerAdvice
public class EstimationRuntimeExceptionHandler {
    public static final Logger LOGGER = LoggerFactory.getLogger(EstimationRuntimeExceptionHandler.class);

    @ExceptionHandler(value={EstimationRuntimeException.class})
    @ResponseBody
    public Result<String> globalException(EstimationRuntimeException e, HttpServletRequest request, HttpServletResponse response) {
