...
public class FetchBillNode
extends DynamicNode {
    private static final long serialVersionUID = 4192482166340810926L;
    public static final String FN_BILL = "BILL";
    public final String constantType;

    public FetchBillNode(IContext context, Token token, String constantType) {
        super(token);
    ...
    public void toString(StringBuilder stringBuilder) {
        stringBuilder.append(String.format("%s[%s]", FN_BILL, this.constantType));
    }

    protected void toSQL(IContext context, StringBuilder buffer, ISQLInfo info) throws InterpretException {
        throw new InterpretException(String.format("\u672a\u652f\u6301SQL\u8f6c\u6362%s[%s]", FN_BILL, this.constantType));
    }
}
