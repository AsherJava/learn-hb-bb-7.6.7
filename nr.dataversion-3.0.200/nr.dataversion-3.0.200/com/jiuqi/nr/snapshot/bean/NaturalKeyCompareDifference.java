...
public class NaturalKeyCompareDifference {
    ...
    private List<ICompareDifferenceItem> updateItems;
    ...
    public List<ICompareDifferenceItem> getUpdateItems() {
        return this.updateItems;
    }

    public void setUpdateItems(List<ICompareDifferenceItem> updateItems) {
