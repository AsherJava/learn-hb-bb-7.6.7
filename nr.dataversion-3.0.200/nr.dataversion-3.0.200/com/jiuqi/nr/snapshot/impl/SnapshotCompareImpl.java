...
@Service
@Primary
public class SnapshotCompareImpl
implements ISnapshotCompare {
    private static final Logger logger = LoggerFactory.getLogger(SnapshotCompareImpl.class);
    @Autowired
    ...
    @Override
    public List<FormCompareDifference> compareVersionData(Map<String, DimensionValue> dimensionSet, String formSchemeKey, List<String> formKeys, String initialDataVersionId, String compareDataVersionId) {
    ...
    private FormCompareDifference compareFormVersionData(Map<String, DimensionValue> dimensionSetMap, String formSchemeKey, String formKey, String initialDataVersionId, String compareDataVersionId) {
        ...
        for (RegionData region : regions) {
            AbstractCompareStrategy regionDataVersionCompareStrategy = regionDataCompareFactory.getRegionDataVersionCompareStrategy(region, false);
            IRegionCompareDifference regionCompareDifference = regionDataVersionCompareStrategy.compareRegionVersionData(region, tableContext, initialDataVersionId.toString(), compareDataVersionId.toString(), "VERSIONID");
    ...
    private FormCompareDifference compareFormVersionData1(Map<String, DimensionValue> dimensionSetMap, String formSchemeKey, String formKey, String initialDataVersionId, String compareDataVersionId) {
        FormCompareDifference formCompareDifference;
        block109: {
            ArrayList<FileInfo> tableFile;
            List<RegionData> regions;
            ArrayList<IRegionCompareDifference> regionCompareDifferences;
            ...
            block108: {
                ...
                formCompareDifference.setFormCode(form.getFormCode());
                formCompareDifference.setFormName(form.getTitle());
                regionCompareDifferences = new ArrayList<IRegionCompareDifference>();
                formCompareDifference.setUpdateRegions(regionCompareDifferences);
                ...
                if (tableFile.isEmpty() || tableFile.size() != 1 || initialDataVersionId.toString().equals(compareDataVersionId.toString()) || !initialDataVersionId.toString().equals("00000000-0000-0000-0000-000000000000") && !compareDataVersionId.toString().equals("00000000-0000-0000-0000-000000000000")) break block108;
                for (FileInfo fileInfo : tableFile) {
                    ...
                    for (RegionData region : regions) {
                        ...
                        if (region.getRegionTop() == 1) {
                            ...
                            for (FieldDefine fieldDefine3 : listFieldDefine) {
                                ...
                                try {
                                    ...
                                    BigDecimal bigDecimal = BigDecimal.valueOf((Long)number);
                                    BigDecimal bigDecimal1 = BigDecimal.valueOf((Long)number1);
                                ...
                                if (null != linksInRegionByField && !linksInRegionByField.isEmpty()) {
                                    ...
                                    if (StringUtils.isNotEmpty((String)entityKey)) {
                                        ...
                                        String referCode = "";
                                        DataField df = (DataField)fieldDefine3;
                                        ...
                                        List linksInRegionByField2 = this.runtimeView.getLinksInRegionByField(region.getKey(), fieldDefine3.getKey());
                                        String linkKey = null;
                                        if (linksInRegionByField2 != null && !linksInRegionByField2.isEmpty()) {
                                            linkKey = ((DataLinkDefine)linksInRegionByField2.get(0)).getKey();
                                        }
                                        EntityViewDefine entityView = this.runtimeView.getViewByLinkDefineKey(linkKey);
                                        ...
                                        if (entityTables != null) {
                                            IEntityRow findByEntityKeyCompare;
                                            IEntityRow findByEntityKey = entityTables.findByEntityKey(initialValue);
                                            if (findByEntityKey != null) {
                                                differenceItem.setInitialValue(findByEntityKey.getTitle());
                                            }
                                            if ((findByEntityKeyCompare = entityTables.findByEntityKey(compareValue)) != null) {
                                                differenceItem.setCompareValue(findByEntityKeyCompare.getTitle());
                                            }
                                        }
                                    }
                                }
                        ...
                        if (!region.getAllowDuplicateKey()) {
                            ...
                            if (null == (difference = fuk.compareRegionVersionDataFile(regionData, tableContext, initialDataVersionId, compareDataVersionId, initalRows, compareRows)).getNatures() || difference.getNatures().size() <= 0) continue;
                        ...
                        if (initialDataVersionId.toString().equals("00000000-0000-0000-0000-000000000000")) {
                            ...
                            while (fieldDataList.hasNext() && (key = (tableKey = (String)fieldDataList.next())).equals("")) {
                            }
            ...
            if (tableFile.isEmpty() || tableFile.size() != 2) break block109;
            ...
            for (RegionData region : regions) {
                ...
                if (!region.getAllowDuplicateKey()) {
                    ...
                    FloatUniqueKeyRegionCompareDifference difference = fuk.compareRegionVersionDataFile(regionData, tableContext, initialDataVersionId, compareDataVersionId, initalRows1, compareRows1 = (List)compareRows.get(tableKeys.iterator().next()));
    ...
    private IRegionCompareDifference getCompareRegionVersionData(RegionData region, TableContext jtableContext, UUID initialDataVersionId, UUID compareDataVersionId) {
        if (region.getRegionTop() > 1) {
            FloatRegionCompareDifference floatRegionCompareDifference = new FloatRegionCompareDifference();
            floatRegionCompareDifference.setRegionKey(region.getKey());
            floatRegionCompareDifference.setRegionName(region.getTitle());
