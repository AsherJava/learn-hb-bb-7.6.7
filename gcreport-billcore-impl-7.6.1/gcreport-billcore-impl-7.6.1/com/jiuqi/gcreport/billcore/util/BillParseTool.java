...
public class BillParseTool {
    public static BillInfoVo parseBillInfo(String defineCode) {
        ...
        if (infoDTO != null) {
            billInfoVo.setModuleName(infoDTO.getModuleName());
            billInfoVo.setMetaType(infoDTO.getMetaType());
            ...
            for (int i = 0; i < pluginsData.size(); ++i) {
                ...
                BillParseTool.findBindingNode(childrenNode, billInfoVo);
            }
        }
        return billInfoVo;
    }
    ...
    private static void findBindingNode(JsonNode childrenNodes, BillInfoVo billInfoVo) {
        ...
        for (int i = 0; i < childrenNodes.size(); ++i) {
            ...
            if (null != childrenNode.get("binding")) {
                BillParseTool.parseColumnCode(childrenNodes, billInfoVo);
                break;
            }
            JsonNode newChildrenNodes = childrenNode.get("children");
            BillParseTool.findBindingNode(newChildrenNodes, billInfoVo);
        }
    }
