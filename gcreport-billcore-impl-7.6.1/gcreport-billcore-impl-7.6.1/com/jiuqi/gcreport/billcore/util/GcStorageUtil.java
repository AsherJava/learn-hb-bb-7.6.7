...
public class GcStorageUtil {
    ...
    public static List<DataModelColumn> getBillMasterTableTemplateFields() {
        ...
        columns.add(new DataModelColumn().columnName("CREATEUSER").columnTitle("\u521b\u5efa\u4eba").columnType(DataModelType.ColumnType.NVARCHAR).lengths(new Integer[]{36}).mapping("AUTH_USER.ID").mappingType(Integer.valueOf(3)).columnAttr(DataModelType.ColumnAttr.SYSTEM));
        columns.add(new DataModelColumn().columnName("CREATETIME").columnTitle("\u521b\u5efa\u65f6\u95f4").columnType(DataModelType.ColumnType.TIMESTAMP).columnAttr(DataModelType.ColumnAttr.SYSTEM));
