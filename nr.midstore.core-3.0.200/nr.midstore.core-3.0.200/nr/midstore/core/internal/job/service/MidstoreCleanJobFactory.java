...
import nr.midstore.core.internal.job.service.MidstoreCleanJobExecutor;
import org.springframework.stereotype.Component;

@Component
public class MidstoreCleanJobFactory
extends JobFactory
implements IJobAdvanceConfiguration {
    public static final String ID = "midstore_clean_Job";
    public static final String TITLE = "\u4e2d\u95f4\u5e93\u6e05\u7406\u8ba1\u5212\u4efb\u52a1";
    ...
    public JobExecutor createJobExecutor(String jobId) throws JobsException {
        return (JobExecutor)SpringBeanProvider.getBean(MidstoreCleanJobExecutor.class);
    }
