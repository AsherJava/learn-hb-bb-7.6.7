...
import nr.midstore.core.definition.db.BeanMidstoreException;
import nr.midstore.core.definition.db.DBAnno;
import nr.midstore.core.definition.db.DBMidstoreException;
import nr.midstore.core.definition.db.TransUtil;
...
public abstract class BaseDao {
    ...
    protected void buildMethod() {
        ...
        if (upFields.isEmpty()) {
            throw new BeanMidstoreException("\u672a\u627e\u5230\u66f4\u65b0\u5b57\u6bb5\uff0c\u5fc5\u987b\u5b58\u5728\u4e00\u4e2a\u9700\u8981\u66f4\u65b0\u7684\u5b57\u6bb5");
        }
    ...
    protected void readRecord(ResultSet rs, Object obj) {
        try {
            ...
            throw new BeanMidstoreException(e);
        }
    }
    ...
    public int insert(Object obj) throws BeanMidstoreException, DBMidstoreException {
        if (obj == null) {
            throw new DBMidstoreException();
        }
        int ret = 0;
        try {
            ...
            for (String dbFieldName : this.dbFieldList) {
                ...
                if (StringUtils.hasLength(fieldAnno.get())) {
                    ...
                    if (getMethod == null) {
                        this.throwBeanMidstoreException("getMethod\u5b9a\u4e49\u6709\u8bef\uff01\uff01" + obj.getClass().getName() + "." + fieldAnno.get());
                    } else {
                ...
                try {
                    ...
                    this.throwBeanMidstoreException(field.getName() + "\u81ea\u52a8\u586b\u5145\u5f53\u524d\u65f6\u95f4\u5931\u8d25\uff01");
                }
            ...
            this.throwBeanMidstoreException(e);
        }
        return ret;
    }

    public int[] insert(Object[] objs) throws BeanMidstoreException, DBMidstoreException {
    ...
    public int delete(Object obj) throws BeanMidstoreException, DBMidstoreException {
        if (obj == null) {
            throw new DBMidstoreException();
        }
        int ret = 0;
        try {
            if (!StringUtils.hasLength(this.pk)) {
                this.throwBeanMidstoreException("pk\u672a\u5b9a\u4e49");
            }
    ...
    public int deleteAll() throws BeanMidstoreException {
        if (!StringUtils.hasLength(this.pk)) {
            this.throwBeanMidstoreException("pk\u672a\u5b9a\u4e49");
        }
    ...
    public int[] delete(final Object[] objs) throws BeanMidstoreException, DBMidstoreException {
        if (objs == null || objs.length == 0) {
            return null;
        }
        int[] ret = new int[objs.length];
            ...
            ret = this.jdbcTemplate.batchUpdate(sqlStr, new BatchPreparedStatementSetter(){
                ...
                public void setValues(PreparedStatement ps, int i) throws SQLException {
                    ...
                    try {
                        ...
                        BaseDao.this.throwBeanMidstoreException(e);
                    }
                    ps.setObject(1, obj);
                }
    ...
    public int deleteBy(String[] fieldNames, Object[] args) throws BeanMidstoreException, DBMidstoreException {
        ...
        try {
            ...
            for (int i = 0; i < fieldNames.length; ++i) {
                ...
                if (field == null) {
                    this.throwBeanMidstoreException(fieldName + "\u5c5e\u6027\u4e0d\u6b63\u786e\uff01");
                }
                DBAnno.DBField fieldAnno = field.getAnnotation(DBAnno.DBField.class);
                if (i > 0) {
    ...
    public int update(Object obj) throws BeanMidstoreException, DBMidstoreException {
        int ret = 0;
        if (obj == null) {
            throw new DBMidstoreException();
        }
        try {
            ...
            if (StringUtils.hasLength(pkDbField.get())) {
                ...
                if (getMethod == null) {
                    this.throwBeanMidstoreException("getMethod\u5b9a\u4e49\u6709\u8bef\uff01\uff01" + obj.getClass().getName() + "." + pkDbField.get());
                } else {
                    v = getMethod.invoke(obj, ov);
                }
            }
    ...
    public int[] update(Object[] objs) throws BeanMidstoreException, DBMidstoreException {
        if (objs == null || objs.length == 0) {
            throw new DBMidstoreException();
        }
        int[] ret = new int[objs.length];
    ...
    public <T> List<T> list(String sqlWhere, Object[] args, Class<? extends T> t) throws BeanMidstoreException {
    ...
    public <T> List<T> list(String[] fieldNames, Object[] args, Class<? extends T> t) throws BeanMidstoreException {
    ...
    public <T> T getByKey(Object obj, Class<T> t) throws BeanMidstoreException {
        Object result = null;
        try {
            if (!StringUtils.hasLength(this.pk)) {
                this.throwBeanMidstoreException(t + "\u672a\u5b9a\u4e49\u4e3b\u952e\uff01");
            }
            StringBuffer sqlWhere = new StringBuffer();
            Field field = this.fieldMap.get(this.pk);
            DBAnno.DBField dbField = field.getAnnotation(DBAnno.DBField.class);
    ...
    public <T> T getBy(String whereSQL, Object[] obj, Class<? extends T> t) throws BeanMidstoreException {
        Object result = null;
        String sql = "";
    ...
    public <T> List<T> listByForeign(Object obj, String[] filterAttrs1, String[] filterAttrs2, Object[] values, Class<? extends T> t) throws BeanMidstoreException {
        List list = new ArrayList();
        try {
            Object v;
            ...
            if (tableAnno == null) {
                this.throwBeanMidstoreException(foreignClass.getName() + "\u6ca1\u6709\u5173\u8054\u6570\u636e\u5e93\u8868\uff01\uff01");
            }
            DBAnno.DBLink link = null;
            if (this.links == null) {
                this.throwBeanMidstoreException(t.getName() + "\u6ca1\u6709\u8bbe\u7f6e\u6570\u636e\u5e93\u5173\u8054\u5173\u7cfb\uff01\uff01");
            }
            ...
            if (link == null) {
                ...
                if (foreignLinks != null) {
                    ...
                    this.throwBeanMidstoreException(foreignClass.getName() + "\u4e0e" + t + "\u6ca1\u6709\u8bbe\u7f6e\u5173\u8054\u5173\u7cfb\uff01\uff01");
                }
            }
    ...
    public <T> List<T> listByForeign(Object obj, String[] queryParams, Class<? extends T> t) throws BeanMidstoreException {
        List list = new ArrayList();
        try {
            StringBuffer sql = new StringBuffer("select ");
            for (int i = 0; i < this.dbFieldList.size(); ++i) {
    ...
    public int update(Object obj, String[] fieldNames, Object[] args) throws BeanMidstoreException, DBMidstoreException {
        int ret = 0;
    ...
    private BeanMidstoreException throwBeanMidstoreException(Exception e) throws BeanMidstoreException {
        throw new BeanMidstoreException(e);
    }

    private BeanMidstoreException throwBeanMidstoreException(String message) throws BeanMidstoreException {
        throw new BeanMidstoreException(message);
    }
    ...
    protected <T> RowMapper<T> getRowMapper(Class<? extends T> t) {
        return (rs, rowNum) -> {
            ...
            catch (IllegalAccessException | InstantiationException | BeanMidstoreException e) {
    ...
    private boolean clobReadByStream() {
        ...
        try {
            ...
            boolean bl = database.isDatabase("polardb") || database.isDatabase("POSTGRESQL");
            return bl;
        }
