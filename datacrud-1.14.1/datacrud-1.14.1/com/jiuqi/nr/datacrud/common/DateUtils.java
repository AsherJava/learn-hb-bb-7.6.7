...
public class DateUtils {
    ...
    public static final ConcurrentHashMap<String, DateTimeFormatter> patternFormatMap = new ConcurrentHashMap();
    private static final SimpleDateFormat time = new SimpleDateFormat("HH:mm:ss");
    private static final ZoneId zoneId = ZoneId.systemDefault();
    public static final Date minDate = new Date(-30609820800000L);
    public static final Date maxDate = new Date(253402300799000L);
    ...
    public static DateTimeFormatter getFormatter(String pattern) {
        return patternFormatMap.computeIfAbsent(pattern, r -> DateTimeFormatter.ofPattern(pattern).withZone(ZoneId.systemDefault()));
    }
}
