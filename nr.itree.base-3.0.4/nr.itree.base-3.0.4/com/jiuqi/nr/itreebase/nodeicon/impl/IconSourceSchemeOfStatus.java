...
public class IconSourceSchemeOfStatus
implements IconSourceScheme {
    public static final String SOURCE_ID = "state-icon";
    ...
    public IconCategory getCategory() {
        return IconCategory.STATUS_ICONS;
    }
    ...
    static {
        String filePath = "static" + File.separator + "work-flow-icons";
