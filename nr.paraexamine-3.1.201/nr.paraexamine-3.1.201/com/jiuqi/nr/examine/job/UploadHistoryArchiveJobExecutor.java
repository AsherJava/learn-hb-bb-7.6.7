...
@Component
public class UploadHistoryArchiveJobExecutor
extends JobExecutor {
    @Autowired
    private JdbcTemplate jdbcTemplate;
    @Autowired
    PeriodEngineService periodEngineService;
    private static final Logger logger = LoggerFactory.getLogger(UploadHistoryArchiveJobExecutor.class);
    ...
    public void execute(JobContext jobContext) throws JobExecutionException {
        ...
        logger.info("\u5f00\u59cb\u6267\u884c\u8ba1\u5212\u4efb\u52a1\uff1a\u6d41\u7a0b\u5386\u53f2\u72b6\u6001\u8868\u5f52\u6863");
        ...
        try {
            ...
            String fcCodeDatetimeSql = "SELECT FC_CODE,TK_DATETIME FROM NR_PARAM_TASK,NR_PARAM_FORMSCHEME WHERE TK_KEY = ?";
            String fcCode = "FC_CODE";
            String timeType = "TK_DATETIME";
            String frontend = "SYS_UP_HI_";
            String backend = "";
            String tableName = "SYS_UP_HI";
            String zippwd = JqLib.decodePassword((String)zippwdEncode);
            Map fcCodeDatetimeMap = historyArchivePlanRegService.getFcCodeDatetimeMap(this.jdbcTemplate, fcCodeDatetimeSql, "FC_TASK_KEY", fcCode, timeType, logger);
            ...
            logger.error("\u8ba1\u5212\u4efb\u52a1\uff1a\u6d41\u7a0b\u5386\u53f2\u72b6\u6001\u8868\u5f52\u6863\u6267\u884c\u5931\u8d25", e);
        }
    }
}
