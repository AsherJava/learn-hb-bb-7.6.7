...
public class DataModelFeignI18nUtil {
    private static Logger logger = LoggerFactory.getLogger(DataModelFeignI18nUtil.class);
    private static MessageSource messageSource;

    private static MessageSource getMessageSource() {
        if (messageSource == null) {
            messageSource = (MessageSource)ApplicationContextRegister.getBean((String)"vaDataModelFeignMessageSource");
        }
    ...
    public static String getMessage(String key, Object ... args) {
        try {
            ...
            String message = DataModelFeignI18nUtil.getMessageSource().getMessage(key, args, locale);
