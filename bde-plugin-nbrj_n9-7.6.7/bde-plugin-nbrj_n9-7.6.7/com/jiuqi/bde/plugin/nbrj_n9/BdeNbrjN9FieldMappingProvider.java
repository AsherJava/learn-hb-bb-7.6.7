...
@Component
public class BdeNbrjN9FieldMappingProvider
extends BaseMappingProvider {
    @Autowired
    private BdeNbrjN9PluginType pluginType;
    public static final String CODE = "NbrjN9Assist";
    ...
    public List<OrgMappingTypeDTO> listMappingType(DataSchemeDTO dto) {
        ...
        orgMappingDefineDTO.setAdvancedSql(" SELECT KEPTBCODE AS ID, KEPTBCODE AS CODE,KEPTBCODE AS NAME FROM IVOUCHER  GROUP BY KEPTBCODE ");
