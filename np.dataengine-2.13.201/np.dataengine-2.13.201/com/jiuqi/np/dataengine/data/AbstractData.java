 ...
 *  com.jiuqi.nvwa.dataengine.exception.ValueConvertException
 */
...
import com.jiuqi.np.dataengine.data.ErrorData;
...
import com.jiuqi.np.dataengine.data.TimeData;
import com.jiuqi.np.dataengine.data.VoidData;
import com.jiuqi.np.dataengine.exception.DataTypeException;
import com.jiuqi.nvwa.dataengine.common.Convert;
import com.jiuqi.nvwa.dataengine.exception.ValueConvertException;
    ...
    private static AbstractData convertData(Object value, int dataType) throws DataTypeException {
        ...
        try {
            ...
            switch (dataType) {
                ...
                case 10: {
                    return new CurrencyData(DataTypesConvert.toBigDecimal(dataValue));
                }
                case 5: {
                ...
                case 3: {
                    ...
                    try {
                        ...
                        floatData = new CurrencyData(DataTypesConvert.toBigDecimal(dataValue));
                    }
                    return floatData;
                }
                case 7: {
                ...
                case 4: {
                    ...
                    try {
                        ...
                        intData = new CurrencyData(DataTypesConvert.toBigDecimal(dataValue));
                    }
                    return intData;
                }
                case 34: {
