...
import com.jiuqi.np.dataengine.common.DataModelColumn;
...
public class DataModelLinkColumn
extends DataModelColumn
implements Comparable<DataModelLinkColumn>,
Serializable,
Cloneable {
    ...
    public DataModelLinkColumn(ColumnModelDefine field) {
        super(field);
    }

    public DataModelLinkColumn(ColumnModelDefine field, PeriodModifier periodModifier, DimensionValueSet dimensionRestriction) {
        super(field, periodModifier, dimensionRestriction);
    }

    public DataModelLinkColumn(String expression) {
        super(expression);
    }
    ...
    public boolean equals(Object obj) {
        ...
        DataModelLinkColumn other = (DataModelLinkColumn)obj;
    ...
    @Override
    public int compareTo(DataModelLinkColumn o) {
    ...
    public String toString() {
        if (this.reportInfo != null) {
            return this.reportInfo.getReportName() + "[" + (this.dataPosition == null ? this.columModel.getCode() : this.dataPosition.row() + "," + this.dataPosition.col()) + (this.showInfo != null && !StringUtils.isEmpty((String)this.showInfo.getInnerAppend()) ? "," + this.showInfo.getInnerAppend() : "") + "]" + (this.showInfo != null && !StringUtils.isEmpty((String)this.showInfo.getEndAppend()) ? this.showInfo.getEndAppend() : "");
        }
        return super.toString();
    }

    public Object clone() throws CloneNotSupportedException {
        DataModelLinkColumn cloneColumn = (DataModelLinkColumn)super.clone();
