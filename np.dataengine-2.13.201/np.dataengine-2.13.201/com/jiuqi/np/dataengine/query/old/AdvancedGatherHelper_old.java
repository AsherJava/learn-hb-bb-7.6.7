...
import com.jiuqi.np.dataengine.query.old.GroupTreeRow;
...
@Deprecated
public class AdvancedGatherHelper_old {
    public AdvancedGatherHelper_old(ExecutorContext context, ReadonlyTableImpl tableImpl, DefinitionsCache cache, DimensionValueSet masterKeys, List<Integer> groupColumnIndexes, List<FieldGatherType> gatherTypes, QueryParam queryParam, HashMap<Integer, Boolean> setTypes) {
    }
    ...
    public static void getDataRows(List<GroupTreeRow> groupTreeRows, List<DataRowImpl> dataRowImpls, int maxLevel) {
        ...
        for (GroupTreeRow groupTreeRow : groupTreeRows) {
            ...
            AdvancedGatherHelper_old.getDataRows(groupTreeRow.getChildRows(), dataRowImpls, maxLevel - 1);
        }
    }
