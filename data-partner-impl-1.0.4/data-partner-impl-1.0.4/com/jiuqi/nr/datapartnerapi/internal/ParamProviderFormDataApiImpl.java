 ...
 */
package com.jiuqi.nr.datapartnerapi.internal;
...
public class ParamProviderFormDataApiImpl
implements ParamProvider {
    private final String taskKey;
    private final FormDefine formDefine;

    public ParamProviderFormDataApiImpl(String task, FormDefine formDefine) {
        this.taskKey = task;
