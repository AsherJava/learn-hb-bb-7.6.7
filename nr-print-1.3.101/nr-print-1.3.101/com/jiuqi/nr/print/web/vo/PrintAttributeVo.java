 ...
 *  com.jiuqi.nr.definition.facade.print.NumericTextFormatDefine
 ...
 *  com.jiuqi.nr.definition.internal.impl.print.PrintSchemeAttributeDefineImpl
...
import com.jiuqi.nr.print.web.vo.PrintWordVo;
import com.jiuqi.nr.print.web.vo.WatermarkConfigVo;
...
public class PrintAttributeVo {
    ...
    public static PrintAttributeVo toPrintSchemeAttributeDefine(String printSchemeKey, PrintSchemeAttributeDefine define) {
        ...
        Paper paperByType = PrintElementUtils.getPaperByType((int)paper.getPaperType());
        ...
        List wordLabelDefines = define.getWordLabels();
    ...
    public static PrintSchemeAttributeDefine toAttributeDefine(PrintAttributeVo vo) {
        ...
        PrintPaperDefine paper = define.getPaper();
        Paper paperByName = PrintElementUtils.getPaperByName((String)vo.getPaperName());
        ...
        ArrayList<WordLabelDefine> wordLabels = define.getWordLabels();
        if (wordLabels == null) {
    ...
    public static PrintSchemeAttributeDefine defaultAttributeDefine() {
        ...
        for (WordLabelDefine label : PrintUtil.getDefaultWordLabels()) {
            attribute.getWordLabels().add(label);
        }
        return attribute;
    }
