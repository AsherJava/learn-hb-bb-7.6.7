...
@Configuration
@ComponentScan(basePackages={"com.jiuqi.nr.print"})
public class PrintSchemeConfiguration {
    @Bean(name={"printMessageSource"})
    public MessageSource messageSource() {
        ...
        messageBundle.setBasenames("messages/messages", "messages/Print");
