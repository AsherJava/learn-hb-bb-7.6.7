...
public class ChildrenDimensionProvider
extends AllNodeDimensionProvider {
    private static final long serialVersionUID = 1L;
    private Logger log = LoggerFactory.getLogger(ChildrenDimensionProvider.class);
    public static final String PROVIDER_CHILDREN = "PROVIDER_CHILDREN";

    public ChildrenDimensionProvider() {
    }

    public ChildrenDimensionProvider(DimensionProviderData dimensionProviderData) {
    ...
    public List<String> getValues(DimensionContext context, VariableDimensionValue variableDimensionValue, DimensionCombination dimensionCombination) {
        ...
        try {
            ...
            List<String> values = entityTable.getChildRows(this.dimensionProviderData.getCurrentValue()).stream().map(IEntityItem::getEntityKeyData).collect(Collectors.toList());
    ...
    public String toString() {
        return "ChildrenDimensionProvider{dimensionProviderData=" + this.dimensionProviderData + '}';
    }
}
