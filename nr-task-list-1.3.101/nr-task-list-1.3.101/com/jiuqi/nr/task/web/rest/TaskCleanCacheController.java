...
@Api(tags={"\u6e05\u7406\u7f13\u5b58"})
public class TaskCleanCacheController {
    private static final String TASK_CACHE_CLEAN = "TASK_CACHE_CLEAN";
    ...
    public void setCacheManager(NedisCacheProvider cacheProvider) {
        this.cache = cacheProvider.getCacheManager().getCache(TASK_CACHE_CLEAN);
    }
    ...
    public void doClean() throws JQException {
        ...
        Cache.ValueWrapper valueWrapper = this.cache.get(TASK_CACHE_CLEAN);
        if (valueWrapper != null) throw new JQException((ErrorEnum)CleanCacheError.CLEAN_CACHE_ERROR_002, (String)valueWrapper.get());
        this.cache.put(TASK_CACHE_CLEAN, (Object)"\u7f13\u5b58");
        try {
            this.cache.put(TASK_CACHE_CLEAN, (Object)"\u62a5\u8868\u7f13\u5b58");
            ...
            this.cache.put(TASK_CACHE_CLEAN, (Object)"\u6743\u9650\u7f13\u5b58");
            ...
            this.cache.evict(TASK_CACHE_CLEAN);
            LogHelper.info((String)"\u7cfb\u7edf\u7ba1\u7406", (String)"\u6e05\u9664\u7f13\u5b58", (String)"\u6e05\u9664\u6240\u6709\u8282\u70b9\u4e0b\u6240\u6709\u4efb\u52a1\u3001\u62a5\u8868\u65b9\u6848\u7b49\u53c2\u6570\u7f13\u5b58");
        }
    }
