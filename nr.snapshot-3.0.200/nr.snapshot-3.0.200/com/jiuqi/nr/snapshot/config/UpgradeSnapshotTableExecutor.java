 ...
 */
package com.jiuqi.nr.snapshot.config;
...
public class UpgradeSnapshotTableExecutor
implements CustomClassExecutor {
    private static final Logger logger = LoggerFactory.getLogger(UpgradeSnapshotTableExecutor.class);
    ...
    public void execute(DataSource dataSource) throws Exception {
        try {
            ...
            for (DataScheme dataScheme : allDataScheme) {
                snapshotTableUtils.insertCol(dataScheme);
            }
        }
        catch (Exception e) {
