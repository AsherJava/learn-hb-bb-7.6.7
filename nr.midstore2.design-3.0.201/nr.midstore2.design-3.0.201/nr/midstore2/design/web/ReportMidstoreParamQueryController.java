 ...
 *  com.jiuqi.nvwa.midstore.manage.service.IMidstorePeriodService
 ...
 *  nr.midstore2.core.definition.common.NrParamQueryError
 *  nr.midstore2.core.util.IMidstoreFileServcie
...
import com.jiuqi.nvwa.midstore.manage.service.IMidstorePeriodService;
...
import nr.midstore2.core.definition.common.NrParamQueryError;
import nr.midstore2.core.util.IMidstoreFileServcie;
import nr.midstore2.design.common.MidstoreGrid2DataSeralizeToGeGe;
import nr.midstore2.design.domain.CommonParamDTO;
import nr.midstore2.design.service.IParamQueryService;
import nr.midstore2.design.vo.DataSchemeVO;
import nr.midstore2.design.vo.MidstoreFormObj;
...
@JQRestController
@RequestMapping(value={"/mistore2/report/query"})
@Api(tags={"\u4e2d\u95f4\u5e93\u62a5\u8868\u53c2\u6570\u67e5\u8be2"})
public class ReportMidstoreParamQueryController {
    private static final Logger logger = LoggerFactory.getLogger(ReportMidstoreParamQueryController.class);
    @Autowired
    ...
    @Autowired
    private IMidstorePeriodService midstorePeriodService;
    ...
    @GetMapping(value={"/scheme/init-task-tree"})
    @ApiOperation(value="\u52a0\u8f7d\u4efb\u52a1\u6811\u5f62")
    public TaskListVO initTaskTree(String taskKey, String periodType) {
        return this.paramQueryService.initTaskTree(taskKey, periodType);
    }

    @GetMapping(value={"/scheme/init-task-tree-period"})
    @ApiOperation(value="\u52a0\u8f7d\u4efb\u52a1\u6811\u5f62")
    public TaskListVO initTaskTree1(String taskKey) {
        return this.paramQueryService.initTaskTree(taskKey, new ArrayList<String>());
    }
