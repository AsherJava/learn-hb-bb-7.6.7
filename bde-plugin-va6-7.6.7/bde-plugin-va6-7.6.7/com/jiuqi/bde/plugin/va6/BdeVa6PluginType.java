 ...
 */
package com.jiuqi.bde.plugin.va6;
...
import com.jiuqi.bde.plugin.va6.util.Va6AssistProvider;
...
@Component
public class BdeVa6PluginType
extends IBdePluginType {
    private static final String SYMBOL = "VA6";
    private static final String TITLE = "\u3010\u4e45\u5176\u3011VA6";
    @Autowired
    private DataSourceService dataSourceService;
    @Autowired
    private Va6AssistProvider assistProvider;
    ...
    public FieldDTO subjectField(DataSchemeDTO dataSchemeDTO) {
        ...
        subjectSql.append("       )  \n");
        subjectSql.append("   AND T.ACCTYEAR <= ${YEAR} AND T.INVALIDTIME > ${INVALIDTIME} \n");
    ...
    public FieldDTO currencyField(DataSchemeDTO dataSchemeDTO) {
        ...
        currencyField.setAdvancedSql(Va6FetchUtil.getBaseDataSql(sqlHandler, "MD_CURRENCY"));
    ...
    public List<FieldDTO> listAssistField(DataSchemeDTO dataSchemeDTO) {
        ...
        IDbSqlHandler sqlHandler = SqlHandlerUtil.getDbSqlHandler((String)this.dataSourceService.getDbType(dataSchemeDTO.getDataSourceCode()));
        Map<String, Va6AssistPojo> assistMap = this.assistProvider.listAssist(dataSchemeDTO.getDataSourceCode()).stream().collect(Collectors.toMap(BaseAcctAssist::getCode, item -> item, (k1, k2) -> k1));
        for (Va6AssistPojo assistPojo : assistMap.values()) {
            ...
            fieldDTO.setAdvancedSql(Va6FetchUtil.getBaseDataSql(sqlHandler, assistPojo.getTableName()));
