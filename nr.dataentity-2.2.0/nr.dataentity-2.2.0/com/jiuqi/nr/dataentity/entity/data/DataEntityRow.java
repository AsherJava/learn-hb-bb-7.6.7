...
implements IDataEntityRow {
    private List<IEntityRow> rowList;

    public DataEntityRow(List<IEntityRow> rowList) {
    ...
    public void setRowList(List<IEntityRow> rowList) {
        this.rowList = rowList;
    }

    @Override
    public DataEntityType getType() {
        return DataEntityType.DataEntity;
    }
