...
public enum submit_upload_audit_confirm_hi {
    ...
    private submit_upload_audit_confirm_hi(String actionCode, String nodeCode) {
    ...
    public static List<Map<String, String>> getActionToNodeMapGroup() {
        ...
        for (submit_upload_audit_confirm_hi actionToNodeMap : submit_upload_audit_confirm_hi.values()) {
    ...
    public static Map<String, String> getActionToNodeMap() {
        ...
        for (submit_upload_audit_confirm_hi item : submit_upload_audit_confirm_hi.values()) {
