...
public enum upload_audit_confirm_hi {
    ...
    private upload_audit_confirm_hi(String actionCode, String nodeCode) {
    ...
    public static List<Map<String, String>> getActionToNodeMapGroup() {
        ...
        for (upload_audit_confirm_hi actionToNodeMap : upload_audit_confirm_hi.values()) {
    ...
    public static Map<String, String> getActionToNodeMap() {
        ...
        for (upload_audit_confirm_hi item : upload_audit_confirm_hi.values()) {
