...
public enum submit_upload_audit_confirm {
    ...
    private submit_upload_audit_confirm(String actionCode, String nodeCode) {
    ...
    public static List<Map<String, String>> getActionToNodeMapGroup() {
        ...
        for (submit_upload_audit_confirm actionToNodeMap : submit_upload_audit_confirm.values()) {
    ...
    public static Map<String, String> getActionToNodeMap() {
        ...
        for (submit_upload_audit_confirm item : submit_upload_audit_confirm.values()) {
