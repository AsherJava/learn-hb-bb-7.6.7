...
@Component
public class FinancialCubesPenetrateCacheConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "FINANCIALCUBES_PENETRACTE_MANAGE";
    public static final String CACHE_NAME = "FINANCIALCUBES_PENETRACTE";
    ...
    public CacheManagerProperties getProperties() {
        if (this.config == null) {
            ...
            tokenCachePropertie.setTtl(120L);
