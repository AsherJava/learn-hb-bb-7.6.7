...
import com.jiuqi.bi.dataset.pattern.YearShowPattern;
...
extends DataSetTimeDimFormat {
    private static final long serialVersionUID = -9060134730673537281L;
    private BIDataSetFieldInfo info;
    private TimeDimDataPattern dataPattern;
    private YearShowPattern showPattern;
    private SimpleDateFormat timekeyFormat = new SimpleDateFormat("yyyyMMdd");

    public YearFormat(BIDataSetFieldInfo fieldInfo) {
        this.info = fieldInfo;
        ...
        this.showPattern = YearShowPattern.find(showPatternString);
    }
    ...
    public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
        ...
        if (this.dataPattern == TimeDimDataPattern.TIMEKEY) {
            ...
            try {
                ...
                c.setTime(d);
                int year = c.get(1);
                toAppendTo.append(this.showPattern.getShowText(year));
            }
            ...
            if (obj instanceof Integer) {
                ...
                try {
                    year = Integer.parseInt((String)obj);
                }
