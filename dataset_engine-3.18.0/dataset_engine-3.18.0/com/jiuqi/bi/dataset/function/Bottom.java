...
public class Bottom
extends DSFunction {
    private static final long serialVersionUID = -2717145560904021062L;
    ...
    public Object evalute(IContext context, List<IASTNode> paramNodes, BIDataSet filterDs) throws SyntaxException {
        ...
        try {
            return ((BIDataSetImpl)filterDs).bottomN(n, fieldNode.getName());
        }
    ...
    private int analysisN(IContext context, IASTNode node) throws SyntaxException {
        ...
        if (value != (double)value.intValue()) {
            throw new SyntaxException("DS_BOTTOM\u51fd\u6570\u4e2d\u7684\u8bb0\u5f55\u6570\u5fc5\u987b\u4e3a\u6574\u6570");
        }
        if (value < 0.0) {
            throw new SyntaxException("DS_BOTTOM\u51fd\u6570\u4e2d\u7684\u8bb0\u5f55\u6570\u5fc5\u987b\u5927\u4e8e0");
        }
    ...
    public String title() {
        return "\u5c06\u8fc7\u6ee4\u8868\u8fbe\u5f0f\u8fc7\u6ee4\u540e\u7684\u6570\u636e\u96c6\u6309\u7167\u6392\u5e8f\u5b57\u6bb5\u8fdb\u884c\u6392\u5e8f\uff0c\u83b7\u53d6\u6392\u5e8f\u540e\u6700\u5c0f\u7684\u524dn\u6761\u8bb0\u5f55";
    }
