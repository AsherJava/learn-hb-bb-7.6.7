...
public class Min
extends DSFunction {
    private static final long serialVersionUID = -4529412215998452630L;
    ...
    public Object evalute(IContext context, List<IASTNode> paramNodes, BIDataSet filterDs) throws SyntaxException {
        ...
        if (column != null) {
            ...
            while (itor.hasNext()) {
                ...
                int compareTo = com.jiuqi.bi.syntax.DataType.compare((int)type, min, (Object)value);
                if (min != null && compareTo <= 0) continue;
                min = value;
            }
            return min;
        }
