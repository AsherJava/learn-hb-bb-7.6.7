 ...
 *  org.json.JSONObject
 */
package com.jiuqi.bi.dataset.parameter;
...
public class ParameterImportOption {
    ...
    public void fromJson(JSONObject value) throws JSONException {
        this.selectMode = ParameterSelectMode.valueOf((int)value.getInt(TAG_SELECTMODE));
        ...
        this.crossLeafEnable = value.optBoolean(TAG_CROSSLEAFENABLE);
    }
}
