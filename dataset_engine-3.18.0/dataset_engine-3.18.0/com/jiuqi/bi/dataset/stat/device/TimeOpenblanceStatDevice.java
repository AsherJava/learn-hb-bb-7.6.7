...
public class TimeOpenblanceStatDevice
extends FieldStatDevice {
    private int sys_timekeyIndex;

    public TimeOpenblanceStatDevice(int srcIndex, int destIndex, int sys_timekeyIndex) {
    ...
    public void stat(BIDataRow dataRow, RecordBuffer recordBuf) {
        ...
        String bufTimekey = recordBuf.getMin_timekey();
