...
public class FormSyncPushSchemeVO {
    ...
    public FormSyncPushSchemeVO(String desTaskKey, String desTaskTitle, String formSchemeKey, String formSchemeTitle) {
        this.desTaskKey = desTaskKey;
        this.desTaskTitle = desTaskKey;
        this.formSchemeKey = formSchemeKey;
        this.formSchemeTitle = formSchemeKey;
        this.displayTitle = desTaskTitle + "|" + formSchemeTitle;
    }
