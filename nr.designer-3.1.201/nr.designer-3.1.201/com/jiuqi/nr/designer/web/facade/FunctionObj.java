...
@ApiModel(value="\u51fd\u6570\u5bf9\u8c61", description="\u516c\u5f0f\u7f16\u8f91\u5668\uff1a\u51fd\u6570\u5bf9\u8c61")
public class FunctionObj {
    ...
    @JsonIgnore
    public FunctionObj(String name, String title, String group, String desp, int paramCount) {
        this.name = name;
        this.title = title;
        this.group = group;
    ...
    @JsonIgnore
    public FunctionObj(String name, String title, String group, List<ParameterObj> parameterList, String application, String example, String function, String parameter, String desp) {
        this.name = name;
        this.title = title;
        this.group = group;
