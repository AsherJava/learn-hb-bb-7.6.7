...
public class FormSyncVO {
    ...
    private List<FormCopyAttSchemeVO> fiFormulaSchemes;
    ...
    public List<FormCopyAttSchemeVO> getFiFormulaSchemes() {
        return this.fiFormulaSchemes;
    }

    public void setFiFormulaSchemes(List<FormCopyAttSchemeVO> fiFormulaSchemes) {
