...
public class TaskLinkDimMappingVO {
    ...
    public static List<TaskLinkDimMappingVO> toMappings(String dimRule) {
        ArrayList<TaskLinkDimMappingVO> mappings = new ArrayList<TaskLinkDimMappingVO>();
        ...
        for (int i = 0; i < dimRuleObjs.length; ++i) {
            ...
            TaskLinkDimMappingVO mapping = new TaskLinkDimMappingVO();
