...
public class DeleteColAction
extends DeleteAction {
    @JsonCreator
    public DeleteColAction(@JsonProperty(value="name") String name, @JsonProperty(value="selections") GridRegion[] selections, @JsonProperty(value="params") Object params) {
