...
public class ShowHiddenRowAction
extends HiddenAction {
    @JsonCreator
    public ShowHiddenRowAction(@JsonProperty(value="name") String name, @JsonProperty(value="selections") GridRegion[] selections, @JsonProperty(value="params") Object params) {
    ...
    public void run(Grid2Data grid) {
        for (GridRegion region : this.getSelections()) {
            this.showHiddenRow(grid, region);
        }
    }
}
