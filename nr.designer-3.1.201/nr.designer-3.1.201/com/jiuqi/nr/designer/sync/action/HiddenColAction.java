...
public class HiddenColAction
extends HiddenAction {
    @JsonCreator
    public HiddenColAction(@JsonProperty(value="name") String name, @JsonProperty(value="selections") GridRegion[] selections, @JsonProperty(value="params") Object params) {
