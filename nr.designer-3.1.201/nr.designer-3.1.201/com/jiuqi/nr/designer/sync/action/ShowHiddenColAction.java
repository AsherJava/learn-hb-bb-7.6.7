...
public class ShowHiddenColAction
extends HiddenAction {
    @JsonCreator
    public ShowHiddenColAction(@JsonProperty(value="name") String name, @JsonProperty(value="selections") GridRegion[] selections, @JsonProperty(value="params") Object params) {
        super(name, selections, params);
    }

    @Override
    public void run(Grid2Data grid) {
        this.showHiddenCol(grid, null);
    }
}
