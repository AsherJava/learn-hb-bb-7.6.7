...
public class HiddenRowAction
extends HiddenAction {
    @JsonCreator
    public HiddenRowAction(@JsonProperty(value="name") String name, @JsonProperty(value="selections") GridRegion[] selections, @JsonProperty(value="params") Object params) {
