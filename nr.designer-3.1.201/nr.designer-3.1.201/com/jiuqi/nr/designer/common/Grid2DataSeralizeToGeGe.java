...
public class Grid2DataSeralizeToGeGe
        ...
        for (int i = 0; i < value.getRowCount(); ++i) {
            ...
            for (int j = 0; j < value.getColumnCount(); ++j) {
                ...
                if (gridCellData.isSilverHead()) {
                    ...
                    gen.writeStringField("backColor", Grid2DataSeralizeToGeGe.intToHtmlColor(gridCellData.getBackGroundColor(), "#FFFFFF"));
                }
                ...
                gen.writeStringField("fontColor", Grid2DataSeralizeToGeGe.intToHtmlColor(gridCellData.getForeGroundColor(), "#000000"));
                ...
                gen.writeStartArray();
                gen.writeString(Grid2DataSeralizeToGeGe.intToHtmlColor(gridCellData.getRightBorderColor(), "#D4D4D4"));
                gen.writeString(Grid2DataSeralizeToGeGe.intToHtmlColor(gridCellData.getBottomBorderColor(), "#D4D4D4"));
                gen.writeEndArray();
