...
@Component
public class HighGoDataBaseHandler
extends AbstractQueryDataBaseHandler {
    public static final String HIGH_GO = "HighGo";

    public HighGoDataBaseHandler() {
        super(HIGH_GO, HIGH_GO, HIGH_GO, "com.highgo.jdbc.Driver");
    }
    ...
    public String getUrl(DataSourceInfoVO dataSourceInfo) {
        return String.format("jdbc:highgo://%1$s:%2$s/%3$s", dataSourceInfo.getIp(), dataSourceInfo.getPort(), dataSourceInfo.getDataBaseName());
    }
