 ...
 *  com.jiuqi.np.dataengine.reader.MemoryStatLeafColumn
...
extends MemoryRowData {
    ...
    @Override
    public void loadData(DataRow row, boolean sumDatas, int memeryStartIndex, int rowKeyStartIndex) {
        for (int i = 0; i < rowKeyStartIndex; ++i) {
            Object value = row.getValue(i);
            this.statColumns.get(memeryStartIndex + i).statistic(value);
        }
    }
