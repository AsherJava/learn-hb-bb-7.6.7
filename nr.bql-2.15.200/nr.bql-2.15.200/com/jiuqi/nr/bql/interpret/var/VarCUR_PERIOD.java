...
extends BiAdaptVariable {
    private static final long serialVersionUID = 1631474943593764008L;
    ...
    public void toFormula(IContext context, StringBuilder buffer, Object info) throws InterpretException {
        buffer.append(this.getPeriodTableName(context)).append(".").append(PeriodTableColumn.CODE.getCode());
    }
}
