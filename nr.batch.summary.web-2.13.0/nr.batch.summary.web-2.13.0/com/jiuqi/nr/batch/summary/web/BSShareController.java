...
@RestController
@RequestMapping(value={"/api/v1/batch-summary/share"})
@Api(tags={"\u6c47\u603b\u65b9\u6848-\u5206\u4eab-\u901a\u7528API"})
public class BSShareController {
    @Resource
    ...
    public IReturnObject<Set<String>> findToUsers(@Valid @RequestBody ShareSummaryParam param) {
