...
public class BatchSummaryPluginConst {
    public static final String DATA_PAGE_APP_NAME = "batch-summary-view";
    public static final String PLUGIN_NAME = "batch-summary-plugin";
    public static final String PLUGIN_TYPE = "batch-summary-plugin";
    ...
    public static final String COMPONENT_OF_MOVE_VIEW = "moveView";
    ...
    public static final String MOVE_GROUP_TITLE = "\u79fb\u52a8\u5206\u7ec4";
    ...
    public static final String SHOW_SCHEMES_TITLE = "\u6279\u91cf\u67e5\u770b";

    private BatchSummaryPluginConst() {
    }
