...
public class MoverGroupToolBarAction
extends MoveToolbarAction {
    private static final String ID = "com.jiuqi.nr.batch.summary.web.app.action.MoverGroupToolBarAction";
    private BSGroupService groupService;
    private BSSchemeService schemeService;
    private BatchSummaryContextData contextData;

    public MoverGroupToolBarAction(BatchSummaryContextData contextData, BSGroupService groupService, BSSchemeService schemeService) {
    ...
    public ActionResult run(ActionContext actionContext, String param) throws Exception {
        ...
        return BatchSummaryPluginConst.getFailActionResult("\u6ca1\u6709\u53ef\u79fb\u52a8\u7684\u5206\u7ec4\u6216\u8005\u65b9\u6848\uff01");
    }

    private String getParentGroupNodeKey(String param) {
        JSONObject jsonObject = new JSONObject(param);
        String parentGroupKey = jsonObject.optString("id", null);
        if ("summary-scheme-resource-view-id".equals(parentGroupKey)) {
