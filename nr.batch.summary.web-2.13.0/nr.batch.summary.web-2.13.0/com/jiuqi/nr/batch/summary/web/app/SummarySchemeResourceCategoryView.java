...
import com.jiuqi.nr.batch.summary.web.app.SummaryGroupTableActionProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeResourceDataProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeResourceSearcher;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeResourceTypeProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeTableColumnProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeToolbarActionProvider;
...
@Component
public class SummarySchemeResourceCategoryView
implements IResourceCategoryView {
    public static final String VIEW_ID = "summary-scheme-resource-view-id";
    @Resource
    ...
    public List<IResourceTypeProvider> getResourceTypeProviders() {
        ...
        provider.add(new SummarySchemeResourceTypeProvider(contextData, this.schemeService, this.pageHandler, this.bsShareService));
        return provider;
    }

    public IResourceDataProvider getResourceDataProvider() {
        BatchSummaryContextData contextData = this.contextHelper.getContextData();
        return new SummarySchemeResourceDataProvider(contextData.getTaskId(), this.groupService, this.schemeService);
    }
    ...
    public ITableColumnProvider getTableColumnProvider() {
        return new SummarySchemeTableColumnProvider();
    }

    public ITableActionProvider getGroupTableActionProvider() {
        BatchSummaryContextData contextData = this.contextHelper.getContextData();
        return new SummaryGroupTableActionProvider(contextData, this.groupService, this.schemeService);
    }

    public IToolbarActionProvider getToolbarActionProvider() {
        BatchSummaryContextData contextData = this.contextHelper.getContextData();
        return new SummarySchemeToolbarActionProvider(contextData, this.groupService, this.schemeService, this.pageHandler, this.bsShareService);
    }
}
