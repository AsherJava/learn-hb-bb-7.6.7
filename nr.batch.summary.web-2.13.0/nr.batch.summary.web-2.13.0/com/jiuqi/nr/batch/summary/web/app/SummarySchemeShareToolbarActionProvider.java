...
import com.jiuqi.nr.batch.summary.web.app.action.DelShareSchemeToolBarAction;
...
public class SummarySchemeShareToolbarActionProvider
implements IToolbarActionProvider {
    ...
    public SummarySchemeShareToolbarActionProvider(BatchSummaryContextData contextData, BSShareService bsShareService, BSSchemeService schemeService, BeforeViewPageDataHandler pageHandler) {
    ...
    public List<AbstractToolbarAction> getToolbarActions() {
        ...
        actions.add(new DelShareSchemeToolBarAction(this.bsShareService));
