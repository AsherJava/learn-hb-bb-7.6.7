...
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeShareResourceDataProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeShareResourceTypeProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeShareTableColumnProvider;
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeShareToolbarActionProvider;
...
@Component
public class SummarySchemeShareCategoryView
implements IResourceCategoryView {
    public static final String VIEW_ID = "share-summary-scheme-resource-view-id";
    @Resource
    ...
    public List<IResourceTypeProvider> getResourceTypeProviders() {
        ...
        provider.add(new SummarySchemeShareResourceTypeProvider(contextData, this.schemeService, this.pageHandler, this.bsShareService));
        return provider;
    }

    public IResourceDataProvider getResourceDataProvider() {
        BatchSummaryContextData contextData = this.contextHelper.getContextData();
        return new SummarySchemeShareResourceDataProvider(contextData.getTaskId(), this.bsShareService);
    }
    ...
    public ITableColumnProvider getTableColumnProvider() {
        return new SummarySchemeShareTableColumnProvider();
    }

    public IToolbarActionProvider getToolbarActionProvider() {
        BatchSummaryContextData contextData = this.contextHelper.getContextData();
        return new SummarySchemeShareToolbarActionProvider(contextData, this.bsShareService, this.schemeService, this.pageHandler);
    }
}
