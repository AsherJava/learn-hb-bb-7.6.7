...
import com.jiuqi.nr.batch.summary.web.app.func.para.OpenFuncParam;
...
implements OpenFuncParam {
    ...
    private BatchSummaryContextDataImpl contextData;
    ...
    @Override
    public BatchSummaryContextDataImpl getContextData() {
        return this.contextData;
    }

    public void setContextData(BatchSummaryContextDataImpl contextData) {
