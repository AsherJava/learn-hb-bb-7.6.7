...
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeSharedTableActionProvider;
...
public class SummarySchemeSharedResourceTypeProvider
implements IResourceTypeProvider {
    public static final String TYPE_ID = "com.jiuqi.nr.batch.summary.web.app.scheme.resource.type.shared";
    ...
    public SummarySchemeSharedResourceTypeProvider(BatchSummaryContextData contextData, BSSchemeService schemeService, BeforeViewPageDataHandler pageHandler) {
    ...
    public ITableActionProvider getTableActionProvider() {
        return new SummarySchemeSharedTableActionProvider(this.contextData, this.pageHandler);
    }
