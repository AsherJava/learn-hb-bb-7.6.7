...
import com.jiuqi.nr.batch.summary.web.app.SummarySchemeTableActionProvider;
...
public class SummarySchemeResourceTypeProvider
implements IResourceTypeProvider {
    public static final String TYPE_ID = "com.jiuqi.nr.batch.summary.web.app.scheme.resource.type";
    ...
    public SummarySchemeResourceTypeProvider(BatchSummaryContextData contextData, BSSchemeService schemeService, BeforeViewPageDataHandler pageHandler, BSShareService bsShareService) {
    ...
    public ITableActionProvider getTableActionProvider() {
        return new SummarySchemeTableActionProvider(this.contextData, this.schemeService, this.pageHandler, this.bsShareService);
    }
