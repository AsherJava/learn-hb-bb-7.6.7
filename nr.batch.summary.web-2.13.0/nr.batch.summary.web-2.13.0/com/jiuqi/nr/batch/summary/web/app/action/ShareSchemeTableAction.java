...
public class ShareSchemeTableAction
extends CopyTableAction {
    private static final String ID = "com.jiuqi.nr.batch.summary.web.app.action.share.scheme";
    private static final String ICON = "#icon16_GJ_A_NW_xinzeng";
    private BSShareService bsShareService;

    public ShareSchemeTableAction(BSShareService bsShareService) {
    ...
    public ActionResult run(ActionContext actionContext, String param) throws Exception {
        ...
        ResourceNode rn = actionContext.getCurrOperTableNode();
