...
public class SummarySchemeResourceSearcher
implements IResourceSearcher {
    ...
    public SummarySchemeResourceSearcher(BatchSummaryContextData contextData, BSGroupService groupService, BSSchemeService schemeService) {
    ...
    private SearchResult assign2SearchResult(SummaryScheme scheme) {
        ...
        result.setResTypeId("com.jiuqi.nr.batch.summary.web.app.scheme.resource.type");
        return result;
    }
