...
public class ParamsImportMappingNrdImpl
implements ParamsMapping {
    MappingImportParam mappingParam;

    public ParamsImportMappingNrdImpl() {
    }

    public ParamsImportMappingNrdImpl(MappingImportParam mappingParam) {
    ...
    public Map<String, String> getOriginPeriod(List<String> srcDataTimes) {
        HashMap<String, String> result = new HashMap<String, String>(srcDataTimes.size());
        for (String srcDataTime : srcDataTimes) {
            result.put(srcDataTime, this.mappingParam.getPeriodMapByCode(srcDataTime));
        }
        return result;
    }
    ...
    public Map<String, String> getOriginOrgCode(List<String> srcDwCodes) {
        HashMap<String, String> result = new HashMap<String, String>(srcDwCodes.size());
        for (String srcDwCode : srcDwCodes) {
            result.put(srcDwCode, this.mappingParam.getOrgToMappings(srcDwCode));
        }
        return result;
    }
    ...
    public Map<String, String> getOriginBaseData(String srcEntityId, List<String> srcBaseDatas) {
        int aiTeIndex = srcEntityId.indexOf("@");
        if (aiTeIndex > -1) {
            srcEntityId = srcEntityId.substring(0, aiTeIndex);
        }
        return this.mappingParam.getBaseToDataMappingByBaseAndDatas(srcEntityId, srcBaseDatas);
    }
    ...
    public Map<String, String> getOriginFormula(String srcFormulaScheme, List<String> srcFormulaCodes) {
        return this.mappingParam.getFormulaMappingByFormulaCodes(srcFormulaScheme, srcFormulaCodes);
    }
