 ...
 *  com.jiuqi.nr.annotation.input.ExpAnnotationFileParam
 *  com.jiuqi.nr.annotation.input.ImpAnnotationFileParam
 *  com.jiuqi.nr.annotation.service.IAnnotationIOService
...
public class ExpAnnotationData
implements ITransmissionDataGather {
    private static final String EXP_ANNOTATION_DATA = "EXPANNOTATIONDATA";
    private static final Logger logger = LoggerFactory.getLogger(ExpAnnotationData.class);
    @Autowired
    private IAnnotationIOService expAnnotationService;
    @Autowired
    ...
    public DataImportResult dataImport(InputStream inputStream, ITransmissionContext context) throws Exception {
        ...
        try {
            ...
            ImpAnnotationFileParam param = new ImpAnnotationFileParam();
            ...
            Result importResult = this.expAnnotationService.importAnnotation(file, param);
    ...
    public void dataExport(OutputStream outputStream, ITransmissionContext context) throws Exception {
        block20: {
            IExecuteParam executeParam = context.getExecuteParam();
            ExpAnnotationFileParam param = new ExpAnnotationFileParam();
            DimensionCollection collection = this.dimensionBuildUtil.getDimensionCollection(context.getContextExpendParam().getDimensionValueSetWithAllDim(), executeParam.getFormSchemeKey());
            param.setDims(collection);
            ...
            Result fileResult = this.expAnnotationService.exportAnnotation(param);
