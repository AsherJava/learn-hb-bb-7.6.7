...
Cloneable {
    ...
    private Map<String, byte[]> extDatas = new HashMap<String, byte[]>();

    public byte[] getData(String name) {
        return this.extDatas.get(name);
    }
    ...
    public void saveToStream(Stream stream) throws StreamException {
        for (Map.Entry<String, byte[]> item : this.extDatas.entrySet()) {
    ...
    protected Object clone() {
        try {
            ...
            result.extDatas = new HashMap<String, byte[]>(this.extDatas);
            return result;
        }
