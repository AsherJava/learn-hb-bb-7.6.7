 ...
 */
package com.jiuqi.nr.tag.management.exception;
...
@Configuration
@ControllerAdvice
public class TagManageRuntimeExceptionHandler {
    public static final Logger LOGGER = LoggerFactory.getLogger(TagManageRuntimeExceptionHandler.class);

    @ExceptionHandler(value={TagManageRuntimeException.class})
    @ResponseBody
    public Result<String> globalException(TagManageRuntimeException e, HttpServletRequest request, HttpServletResponse response) {
