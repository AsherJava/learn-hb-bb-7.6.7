...
@FeignClient(contextId="com.jiuqi.gcreport.reportdatasync.client.ReportDataSyncTokenFeignClient", name="gcreport-service", url="url-placeholder", primary=false)
public interface ReportDataSyncTokenClient {
