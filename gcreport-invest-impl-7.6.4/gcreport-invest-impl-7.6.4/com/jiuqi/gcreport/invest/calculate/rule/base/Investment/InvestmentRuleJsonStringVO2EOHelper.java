...
public class InvestmentRuleJsonStringVO2EOHelper {
    private UnionRuleVO unionRuleVO;

    private InvestmentRuleJsonStringVO2EOHelper() {
    }

    public static InvestmentRuleJsonStringVO2EOHelper newInstance(UnionRuleVO unionRuleVO) {
        InvestmentRuleJsonStringVO2EOHelper helper = new InvestmentRuleJsonStringVO2EOHelper();
