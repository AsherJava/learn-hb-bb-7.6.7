...
public class PublicValueAdjustmentRuleJsonStringEO2VOHelper {
    private String jsonStr;
    private String reportSystemId;

    private PublicValueAdjustmentRuleJsonStringEO2VOHelper() {
    }

    public static PublicValueAdjustmentRuleJsonStringEO2VOHelper newInstance(String jsonStr, String reportSystemId) {
        PublicValueAdjustmentRuleJsonStringEO2VOHelper helper = new PublicValueAdjustmentRuleJsonStringEO2VOHelper();
