...
@Component
public class DirectInvestmentRuleHandler
extends RuleHandler {
    ...
    public AbstractUnionRule convertEO2DTO(UnionRuleEO unionRule) {
        AbstractUnionRule rule = (AbstractUnionRule)JsonUtils.readValue((String)unionRule.getJsonString(), DirectInvestmentDTO.class);
    ...
    public UnionRuleEO convertDTO2EO(AbstractUnionRule rule) {
        ...
        BeanUtils.copyProperties(rule, directInvestmentDTO);
        map.put("initialMerge", directInvestmentDTO.getInitialMerge());
        map.put("goingConcern", directInvestmentDTO.getGoingConcern());
        map.put("dealWith", directInvestmentDTO.getDealWith());
        map.put("equityLawAdjustFlag", directInvestmentDTO.getEquityLawAdjustFlag());
    ...
    public AbstractUnionRule convertMapToDTO(Map<String, Object> importJsonListMap) {
        return (AbstractUnionRule)JsonUtils.readValue((String)JsonUtils.writeValueAsString(importJsonListMap), DirectInvestmentDTO.class);
    }
