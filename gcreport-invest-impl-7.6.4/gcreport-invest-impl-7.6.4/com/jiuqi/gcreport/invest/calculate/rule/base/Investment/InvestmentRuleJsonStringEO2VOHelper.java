...
public class InvestmentRuleJsonStringEO2VOHelper {
    private String jsonStr;
    private String reportSystemId;

    private InvestmentRuleJsonStringEO2VOHelper() {
    }

    public static InvestmentRuleJsonStringEO2VOHelper newInstance(String jsonStr, String reportSystemId) {
        InvestmentRuleJsonStringEO2VOHelper helper = new InvestmentRuleJsonStringEO2VOHelper();
