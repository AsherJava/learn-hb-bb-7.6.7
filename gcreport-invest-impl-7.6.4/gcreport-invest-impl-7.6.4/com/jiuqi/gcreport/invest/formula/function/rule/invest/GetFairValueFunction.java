...
@Component
public class GetFairValueFunction
extends Function
implements IFunctionCache,
IGcFunction {
    private static final long serialVersionUID = 1L;
    public final String FUNCTION_NAME = "GetFairValue";
    private static transient ThreadLocal<DoubleKeyMap> unitCode2SubjectCode2OffsetValueAllLocal = new ThreadLocal();
    private static transient ThreadLocal<DoubleKeyMap> unitCode2SubjectCode2OffsetValueNoInitLocal = new ThreadLocal();
    private static transient ThreadLocal<DoubleKeyMap> unitCode2SubjectCode2OffsetValueNoInitAndPriorLocal = new ThreadLocal();
    private final String ALL_YEAR = "allYear";
    private final String CURR_YEAR = "currYear";
    private final String CURR_MONTH = "currMonth";

    public GetFairValueFunction() {
        this.parameters().add(new Parameter("subjectCode", 6, "\u79d1\u76ee\u4ee3\u7801"));
        this.parameters().add(new Parameter("timeRangeType", 6, "\u65f6\u95f4\u8303\u56f4\u7c7b\u578b"));
    }
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        String timeRangeType = (String)parameters.get(1).evaluate(null);
        double result = 0.0;
        if (masterData != null) {
            ...
            Set<Integer> notAllowOffsetSrcType = this.notAllowOffsetSrcType(timeRangeType);
            List<GcOffSetVchrItemAdjustEO> adjustEOs = this.queryData(executorContext.getTaskId(), dimensionValueSet, masterData, allSubjectCodes, timeRangeType);
            for (GcOffSetVchrItemAdjustEO record : adjustEOs) {
                ...
                if (notAllowOffsetSrcType.contains(record.getOffSetSrcType())) continue;
    ...
    private Set<Integer> notAllowOffsetSrcType(String timeRangeType) {
        HashSet<Integer> notAllowOffsetSrcType = new HashSet<Integer>();
        notAllowOffsetSrcType.add(OffSetSrcTypeEnum.MODIFIED_INPUT.getSrcTypeValue());
        if ("allYear".equals(timeRangeType)) {
            return notAllowOffsetSrcType;
        }
        notAllowOffsetSrcType.addAll(OffSetSrcTypeEnum.getAllInitOffSetSrcTypeValue());
        if ("currMonth".equals(timeRangeType)) {
            notAllowOffsetSrcType.add(OffSetSrcTypeEnum.COPY_OFFSET.getSrcTypeValue());
            return notAllowOffsetSrcType;
        }
        return notAllowOffsetSrcType;
    }
    ...
    private List<GcOffSetVchrItemAdjustEO> queryData(String taskId, DimensionValueSet dimensionValueSet, DefaultTableEntity data, Set<String> allSubjectCodes, String timeRangeType) {
        ...
        DoubleKeyMap unitCode2SubjectCode2OffsetValue = this.getCacheMap(timeRangeType);
        ...
        return this.loadFromDbNoCache(taskId, systemId, unitId, oppUnitId, periodString, currencyCode, allSubjectCodes, ruleIds, timeRangeType, orgType, (String)dimensionValueSet.getValue("ADJUST"));
    }

    private DoubleKeyMap getCacheMap(String timeRangeType) {
        if ("allYear".equals(timeRangeType)) {
            return unitCode2SubjectCode2OffsetValueAllLocal.get();
        }
        if ("currYear".equals(timeRangeType)) {
            return unitCode2SubjectCode2OffsetValueNoInitLocal.get();
        }
        return unitCode2SubjectCode2OffsetValueNoInitAndPriorLocal.get();
    }

    private List<GcOffSetVchrItemAdjustEO> loadFromDbNoCache(String taskId, String systemId, String unitId, String oppUnitId, String periodString, String currencyCode, Set<String> allSubjectCodes, Set<String> ruleIds, String timeRangeType, String orgType, String adjust) {
        Set<Integer> initOffSetSrcType = this.notAllowOffsetSrcType(timeRangeType);
        ...
        if ("allYear".equals(timeRangeType) || "currYear".equals(timeRangeType)) {
            this.filterAndAddValue(result, unitResult, initOffSetSrcType);
            this.filterAndAddValue(result, oppUnitResult, initOffSetSrcType);
        } else {
            initOffSetSrcType.add(OffSetSrcTypeEnum.COPY_OFFSET.getSrcTypeValue());
            this.filterAndAddValue(result, unitResult, initOffSetSrcType);
            this.filterAndAddValue(result, oppUnitResult, initOffSetSrcType);
        }
        return result;
    ...
    private void addValue(List<GcOffSetVchrItemAdjustEO> adjustEOS) {
        Set<Integer> notAllowOffsetSrcType_noInput = this.notAllowOffsetSrcType("allYear");
        Set<Integer> notAllowOffsetSrcType_noInit = this.notAllowOffsetSrcType("currYear");
        Set<Integer> notAllowOffsetSrcType_noInitAndPrior = this.notAllowOffsetSrcType("currMonth");
        DoubleKeyMap unitCode2SubjectCode2OffsetValueAll = unitCode2SubjectCode2OffsetValueAllLocal.get();
        DoubleKeyMap unitCode2SubjectCode2OffsetValueNoInit = unitCode2SubjectCode2OffsetValueNoInitLocal.get();
        DoubleKeyMap unitCode2SubjectCode2OffsetValueNoInitAndPrior = unitCode2SubjectCode2OffsetValueNoInitAndPriorLocal.get();
        for (GcOffSetVchrItemAdjustEO adjustEO : adjustEOS) {
            ...
            if (!notAllowOffsetSrcType_noInit.contains(adjustEO.getOffSetSrcType())) {
            ...
            if (!notAllowOffsetSrcType_noInitAndPrior.contains(adjustEO.getOffSetSrcType())) {
                this.addValue((DoubleKeyMap<String, String, Double>)unitCode2SubjectCode2OffsetValueNoInitAndPrior, cacheUnitKey, adjustEO.getSubjectCode(), offSetValue);
            }
            if (notAllowOffsetSrcType_noInput.contains(adjustEO.getOffSetSrcType())) continue;
            this.addValue((DoubleKeyMap<String, String, Double>)unitCode2SubjectCode2OffsetValueAll, cacheUnitKey, adjustEO.getSubjectCode(), offSetValue);
        }
        this.fillValueIfEmpty((DoubleKeyMap<String, String, Double>)unitCode2SubjectCode2OffsetValueAll, (DoubleKeyMap<String, String, Double>)unitCode2SubjectCode2OffsetValueNoInit, (DoubleKeyMap<String, String, Double>)unitCode2SubjectCode2OffsetValueNoInitAndPrior);
    }
    ...
    private void fillValueIfEmpty(DoubleKeyMap<String, String, Double> unitCode2SubjectCode2OffsetValueAll, DoubleKeyMap<String, String, Double> unitCode2SubjectCode2OffsetValueNoInit, DoubleKeyMap<String, String, Double> unitCode2SubjectCode2OffsetValueNoInitAndPrior) {
        if (unitCode2SubjectCode2OffsetValueAll.isEmpty()) {
            unitCode2SubjectCode2OffsetValueAll.put((Object)UUIDUtils.emptyUUIDStr(), (Object)"", (Object)0.0);
        }
        ...
        if (unitCode2SubjectCode2OffsetValueNoInitAndPrior.isEmpty()) {
            unitCode2SubjectCode2OffsetValueNoInitAndPrior.put((Object)UUIDUtils.emptyUUIDStr(), (Object)"", (Object)0.0);
        }
    }
    ...
    public void enableCache() {
        unitCode2SubjectCode2OffsetValueAllLocal.set(new DoubleKeyMap());
        unitCode2SubjectCode2OffsetValueNoInitLocal.set(new DoubleKeyMap());
        unitCode2SubjectCode2OffsetValueNoInitAndPriorLocal.set(new DoubleKeyMap());
    }

    public void releaseCache() {
        unitCode2SubjectCode2OffsetValueAllLocal.remove();
        unitCode2SubjectCode2OffsetValueNoInitLocal.remove();
        unitCode2SubjectCode2OffsetValueNoInitAndPriorLocal.remove();
    }
    ...
    public String toDescription() {
        ...
        buffer.append("    ").append("subjectCode").append("\uff1a").append(DataType.toString((int)6)).append("\uff1b\u79d1\u76ee\u4ee3\u7801").append(FunctionUtils.LINE_SEPARATOR);
        buffer.append("    ").append("timeRangeType").append("\uff1a").append(DataType.toString((int)6)).append("\uff1ballYear\uff08\u53d6\u6240\u6709\u671f[acctPeriod=\u5f53\u524d\u6708,\u6240\u6709]\uff09,currYear\uff08\u53d6\u5f53\u5e74\u6240\u6709\u671f[acctPeriod=\u5f53\u524d\u6708\uff0c\u5254\u9664\u6389\u6765\u81ea0\u671f]\uff09,currMonth\uff08\u53d6\u5f53\u671f[acctPeriod=\u5f53\u524d\u6708\uff0c\u5254\u9664\u6389\u6765\u81ea0\u671f\u548c\u4e0a\u4e2a\u6708]\uff09").append(FunctionUtils.LINE_SEPARATOR);
        ...
        buffer.append("    ").append("    ").append("\u53d6\u67d0\u79d1\u76ee\u6240\u6709\u671f\u516c\u5141\u4ef7\u503c\u8c03\u6574\u6570(acctPeriod=\u5f53\u524d\u6708\uff0c\u6240\u6709)\u3002 ").append(com.jiuqi.bi.util.StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("\u516c\u5f0f\uff1a").append(com.jiuqi.bi.util.StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("    ").append("GetFairValue('1231','allYear')").append(com.jiuqi.bi.util.StringUtils.LINE_SEPARATOR);
