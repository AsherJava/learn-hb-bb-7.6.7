...
@Component
public class FairGetZcCurrTimeFunction
extends FairGetTimeFunction
implements IGcFunction {
    private static final long serialVersionUID = 1L;
    public final String FUNCTION_NAME = "GETZCCURTIME";
    ...
    public Object evalute(IContext context, List<IASTNode> parameters) throws SyntaxException {
        ...
        if (periodWrapper.getYear() == inputCalendar.get(1)) {
            if (currCalendar.after(disposeCalendar)) {
                return disposeCalendar.get(2) - inputCalendar.get(2);
            }
            return currCalendar.get(2) - inputCalendar.get(2);
        }
        if (periodWrapper.getYear() > inputCalendar.get(1)) {
            if (currCalendar.after(disposeCalendar)) {
                System.out.println("\u4ee5\u524d\u5e74\u7684\u516c\u5141\u4ef7\u503c\u8c03\u6574\uff1a\u5df2\u7ecf\u5904\u7f6e\uff1a" + (disposeCalendar.get(2) + 1));
                return disposeCalendar.get(2) + 1;
            }
    ...
    public String toDescription() {
        ...
        buffer.append("    ").append(DataType.toExpression((int)3)).append("\uff1a").append(DataType.toString((int)3)).append("\uff1b").append("\u56fa\u5b9a\u8d44\u4ea7\u5f53\u524d\u5e74\u6298\u65e7\u6708\u6570").append(StringUtils.LINE_SEPARATOR);
        buffer.append("\u793a\u4f8b\uff1a").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("\u573a\u666f\uff1a").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("    ").append("\u53d6\u516c\u5141\u4ef7\u503c\u8c03\u6574\u56fa\u5b9a\u8d44\u4ea7\u5f53\u524d\u5e74\u6298\u65e7\u6708\u6570\u3002 ").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("\u516c\u5f0f\uff1a").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("    ").append("GETZCCURTIME()").append(StringUtils.LINE_SEPARATOR);
