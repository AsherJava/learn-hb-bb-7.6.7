...
@Component
public class FairGetZcAllTimeFunction
extends FairGetTimeFunction
implements IGcFunction {
    private static final long serialVersionUID = 1L;
    public final String FUNCTION_NAME = "GETZCALLTIME";
    ...
    public String toDescription() {
        ...
        buffer.append("    ").append(DataType.toExpression((int)3)).append("\uff1a").append(DataType.toString((int)3)).append("\uff1b").append("\u56fa\u5b9a\u8d44\u4ea7\u7d2f\u8ba1\u6298\u65e7\u6708\u6570").append(StringUtils.LINE_SEPARATOR);
        buffer.append("\u793a\u4f8b\uff1a").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("\u573a\u666f\uff1a").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("    ").append("\u53d6\u516c\u5141\u4ef7\u503c\u8c03\u6574\u56fa\u5b9a\u8d44\u4ea7\u7d2f\u8ba1\u6298\u65e7\u6708\u6570\u3002 ").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("\u516c\u5f0f\uff1a").append(StringUtils.LINE_SEPARATOR);
        buffer.append("    ").append("    ").append("GETZCALLTIME()").append(StringUtils.LINE_SEPARATOR);
