...
extends ExportExcelSheet {
    ...
    private void writeRegion(ExportContext context, Workbook workbook, Sheet sheet, String regionLabel, List<Object[]> rowDatas) {
        ...
        if (!StringUtils.isEmpty((String)regionLabel)) {
            ...
            Cell cell = CellUtil.getCell((Row)row, (int)0);
            ...
            sheet.addMergedRegion(new CellRangeAddress(rowIndex.get(), rowIndex.get(), 0, this.getColumnMaxIndex().intValue()));
            ++this.headerOffset;
        ...
        for (Object[] rowData : rowDatas) {
            ...
            for (int columnIndex = 0; columnIndex < rowData.length; ++columnIndex) {
                ...
                if (rowNum < this.getSheetHeadSize() + this.headerOffset) {
                    ...
                    cellType = (CellType)this.getContentCellTypeCache().get(columnIndex);
                }
        ...
        switch (cellType) {
            case NUMERIC: {
                ...
                if (formatCellValue instanceof String) {
                    cell.setCellValue(Double.valueOf(formatCellValue.toString().replace(",", "")).doubleValue());
                    break;
                }
