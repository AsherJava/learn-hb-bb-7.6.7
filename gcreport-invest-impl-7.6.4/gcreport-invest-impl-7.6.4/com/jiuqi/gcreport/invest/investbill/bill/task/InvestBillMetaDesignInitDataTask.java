        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(fvchIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    String fvchBillValue = IOUtils.toString((InputStream)inputStream, (String)"utf-8");
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(investIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    InputStream inputStream = resource.getInputStream();
                    String investBillValue = IOUtils.toString((InputStream)inputStream, (String)"utf-8");
                    String sql = "insert into meta_design(id,designdata) values (?,?)";
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(investIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    InputStream inputStream = resource.getInputStream();
                    String investBillListValue = IOUtils.toString((InputStream)inputStream, (String)"utf-8");
                    String sql = "insert into meta_design(id,designdata) values (?,?)";
