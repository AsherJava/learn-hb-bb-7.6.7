...
public class GcFairValueOtherItemBillStorage {
    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = GcFairValueOtherItemBillStorage.getCreateDataMode(tenantName);
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_FVCH_OTHERITEM");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u516c\u5141\u4ef7\u503c\u5176\u5b83\u8d44\u4ea7\u7c7b\u8868");
        ...
        dataModelDO.addColumn("INITDISPOSEVALUE").columnTitle("\u5e74\u521d\u5904\u7f6e\u91d1\u989d").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
        dataModelDO.addColumn("CURRDISPOSEVALUE").columnTitle("\u672c\u5e74\u5904\u7f6e").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
