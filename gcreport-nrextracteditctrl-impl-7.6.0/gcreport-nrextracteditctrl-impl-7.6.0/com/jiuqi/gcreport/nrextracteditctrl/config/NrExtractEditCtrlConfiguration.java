 ...
 */
package com.jiuqi.gcreport.nrextracteditctrl.config;
...
@Component
public class NrExtractEditCtrlConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "GC_NREXTRACTEDITCTRL_MANAGE";
    public static final String CACHE_NAME = "GC_NREXTRACTEDITCTRL";
    public static final String NR_EXTRACT_EDIT_CTRL_TASK_SCHEME_CACHE_KEY_STR = "{TASKID}_{SCHEMEID}";
    public static final String ALL_NR_EXTRACT_EDIT_CTRL_CACHE_KEY = "ALL_NR_EXTRACT_EDIT_CTRL";
