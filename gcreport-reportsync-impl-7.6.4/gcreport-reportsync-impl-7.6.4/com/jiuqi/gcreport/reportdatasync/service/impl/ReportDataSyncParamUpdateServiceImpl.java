...
implements ReportDataSyncParamUpdateService {
    ...
    public Boolean importReportParamFile(MultipartFile importFile, MultipartFile desAttachFile, ImportContext context) {
        ZipEntry entry2;
        Throwable throwable;
        String rootPath = System.getProperty(FilenameUtils.normalize((String)"java.io.tmpdir")) + File.separator + "reportparamsync" + File.separator + "importparampackage" + File.separator + LocalDate.now();
                ...
                try (ZipFile zipFile = new ZipFile(file, Charset.forName("GBK"));){
                    ...
                    try (FileInputStream inputStream1 = new FileInputStream(file);
                        ...
                        while ((entry2 = zipInputStream.getNextEntry()) != null) {
                            ...
                            byte[] instructionBuffer = IOUtils.toByteArray((InputStream)instructionInputStream);
    ...
    public List<Object> listComparisonResults(String logId) {
        ...
        String rootPath = System.getProperty(FilenameUtils.normalize((String)"java.io.tmpdir")) + File.separator + "reportparamsync" + File.separator + "importparam" + File.separator + LocalDate.now() + File.separator + syncParamAttachId;
