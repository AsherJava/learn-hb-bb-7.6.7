...
public class GatherTableUtil {
    ...
    public static List<GatherTableDefine> getGatherTables(String formKey, Map<String, Map<String, NodeCheckFieldMessage>> nodeCheckfieldMap, Map<String, Set<String>> tableCache, Set<String> warnTables) {
        return GatherTableUtil.getGatherTables(formKey, nodeCheckfieldMap, tableCache, warnTables, false);
    }

    public static List<GatherTableDefine> getGatherTables(String formKey, Map<String, Map<String, NodeCheckFieldMessage>> nodeCheckfieldMap, Map<String, Set<String>> tableCache, Set<String> warnTables, boolean isSingleFloatGather) {
        ...
        if (!formDefine.getIsGather() && !isSingleFloatGather) {
            logger.info("\u8868\u5355{}\u3010{}\u3011\u6c47\u603b\u7c7b\u578b\u4e3a\u4e0d\u6c47\u603b\uff0c\u65e0\u6cd5\u6c47\u603b\u3002", (Object)formDefine.getTitle(), (Object)formDefine.getFormCode());
        ...
        try {
            ...
            for (DataRegionDefine region : allRegionsInForm) {
                ...
                boolean bl = isFixed = region.getRegionKind() == DataRegionKind.DATA_REGION_SIMPLE;
                if (isFixed && isSingleFloatGather) continue;
                ...
                for (DataLinkDefine linkDefine : allLinks) {
                    ...
                    if (nodeCheckfieldMap != null) {
                        ...
                        nodeCheckFieldMessage.setFieldOrder(fieldDefine.getOrder());
                        Map regionCache = nodeCheckfieldMap.computeIfAbsent(region.getKey(), k -> new HashMap());
                ...
                for (String tableKey : tableFieldMap.keySet()) {
                    if (isFixed || nodeCheckfieldMap != null) {
                        ...
                        List fieldList = dataDefinitionRuntimeController.queryFieldDefines((Collection)fieldKeySet);
                    ...
                    GatherTableDefine gatherTableDefine = new GatherTableDefine(dataTable, false);
