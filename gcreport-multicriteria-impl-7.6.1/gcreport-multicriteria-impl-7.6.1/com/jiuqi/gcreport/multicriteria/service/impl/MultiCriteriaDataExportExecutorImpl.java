 ...
 *  com.jiuqi.common.base.util.ExcelUtils$ExportColumnTypeEnum
...
import com.jiuqi.common.base.util.ExcelUtils;
...
@Component
public class MultiCriteriaDataExportExecutorImpl
extends AbstractExportExcelMultiSheetExecutor {
    private ThreadLocal<Map<String, CellStyle>> threadLocal = new ThreadLocal();
    @Autowired
    GcMultiCriteriaService multiCriteriaService;

    public String getName() {
        return "MultiCriteriaDataExportExecutor";
    }

    protected List<ExportExcelSheet> exportExcelSheets(ExportContext context, Workbook workbook) {
        GcMultiCriteriaConditionVO condition = (GcMultiCriteriaConditionVO)JsonUtils.readValue((String)context.getParam(), GcMultiCriteriaConditionVO.class);
        ExportExcelSheet exportExcelSheet = this.multiCriteriaService.exportMultiCriteriaData(condition);
    ...
    public Map<String, CellStyle> getCellStyleMap(Workbook workbook) {
        ...
        if (cellStyleMap == null) {
            ...
            cellStyleMap.put("intervalColorAmount", intervalColorAmt);
    ...
    protected void callBackCell(ExportContext context, ExportExcelSheet excelSheet, Workbook workbook, Sheet sheet, Row row, Cell cell, Object cellValue) {
        ...
        if (cell.getColumnIndex() == 0 || cell.getColumnIndex() == 1 || cell.getColumnIndex() == 2 || cell.getColumnIndex() == 5) {
            ...
            if (rowNum != 0 && cellValue != null) {
                ...
                cell.setCellValue(Double.valueOf(String.valueOf(cellValue).replace(",", "")));
            }
