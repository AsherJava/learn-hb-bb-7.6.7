...
@Component
public class MultiCriteriaSettingExportExecutorImpl
extends AbstractExportExcelMultiSheetExecutor {
    ...
    public String getName() {
        return "MultiCriteriaSettingExportExecutor";
    }
    ...
    protected List<ExportExcelSheet> exportExcelSheets(ExportContext context, Workbook workbook) {
        ...
        ExportExcelSheet exportExcelSheet = this.multiCriteriaService.exportMultiCriteriaSettingData(condition, context.isTemplateExportFlag());
    ...
    protected void callBackCell(ExportContext context, ExportExcelSheet excelSheet, Workbook workbook, Sheet sheet, Row row, Cell cell, Object cellValue) {
        ...
        String cellStyleKey = rowNum == 0 ? "headText" : (rowIndex % 2 != 0 ? "contentText" : "intervalColorText");
        cell.setCellStyle(this.getCellStyleMap(workbook).get(cellStyleKey));
        sheet.setColumnWidth(0, 2560);
        sheet.setColumnWidth(1, 30720);
        sheet.setColumnWidth(2, 30720);
    }
}
