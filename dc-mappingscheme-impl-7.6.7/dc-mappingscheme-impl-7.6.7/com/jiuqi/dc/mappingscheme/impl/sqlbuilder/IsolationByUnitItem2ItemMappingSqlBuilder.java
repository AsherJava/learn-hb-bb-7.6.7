...
@Component
public class IsolationByUnitItem2ItemMappingSqlBuilder
extends AbstractFieldMappingSqlBuilder {
    ...
    public RuleType getRuleType() {
        return RuleType.ISOLATION_BY_UNIT_ITEM_BY_ITEM;
    }
    ...
    public String buildJoinSql(FieldMappingDefineDTO item) {
        ...
        sql.append("LEFT JOIN (#advancedSql#) #odsTableAlias# ON #odsTableAlias#.ID = #bizTableField# \n");
        ...
        sqlTemplate = sqlTemplate.replace("#bizTableField#", this.sqlHandler.concat(new String[]{this.getOdsFieldSql(item.getOdsFieldName()), "'|'", "T." + dataSchemeDTO.getOrgMappingType()}));
