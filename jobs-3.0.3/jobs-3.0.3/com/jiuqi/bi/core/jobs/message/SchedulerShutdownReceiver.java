...
public class SchedulerShutdownReceiver
implements IMessageReceiver {
    public static final String ID = "com.jiuqi.bi.jobs.schedulerShutdown";
    ...
    public void receive(Message msg) {
        if (msg.getItems().isEmpty()) {
            this.logger.warn("\u3010com.jiuqi.bi.jobs.schedulerShutdown\u3011\u6d88\u606f\u5185\u5bb9\u5f02\u5e38\uff0c\u672a\u627e\u5230\u8282\u70b9\u540d");
            return;
        }
        try {
            ...
            this.logger.error("\u83b7\u53d6\u5f53\u524d\u8282\u70b9\u5931\u8d25,\u62d2\u7edd\u3010com.jiuqi.bi.jobs.schedulerShutdown\u3011\u6d88\u606f" + e.getMessage(), e);
            return;
        }
        this.logger.info("\u5173\u95ed\u4efb\u52a1\u7ba1\u7406\u6240\u6709scheduler:\u5f00\u59cb...");
        ConfigManager.getInstance().clearConfigCache();
        this.logger.info("\u5173\u95ed\u4efb\u52a1\u7ba1\u7406\u6240\u6709scheduler:\u5237\u65b0\u7f13\u5b58\u5b8c\u6210...");
        try {
            JobBridgeFactory.getInstance().getDefaultBridge().shutdownAll();
        }
        catch (JobsException e) {
            this.logger.error("\u5173\u95ed\u4efb\u52a1\u7ba1\u7406\u6240\u6709scheduler\u5931\u8d25", e);
        }
        this.logger.info("\u5173\u95ed\u4efb\u52a1\u7ba1\u7406\u6240\u6709scheduler:\u5b8c\u6210");
    }
}
