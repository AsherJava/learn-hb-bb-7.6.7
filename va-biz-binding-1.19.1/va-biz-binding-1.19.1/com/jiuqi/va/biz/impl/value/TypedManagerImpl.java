...
import com.jiuqi.va.biz.intf.value.TypedManager;
...
public abstract class TypedManagerImpl<T extends TypedElement>
implements TypedManager<T>,
InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        for (TypedElement t : this.list) {
            if (this.map.putIfAbsent(t.getType(), t) == null) continue;
            this.logger.warn("\u91cd\u590d\u6ce8\u518c\uff1a" + t.getType());
        }
    }
