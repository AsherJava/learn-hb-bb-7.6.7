...
public class ModelDefineBuilder
extends StdTypeResolverBuilder {
    private static List<NamedType> subtypes;

    public static void setSubtypes(List<NamedType> subtypes) {
        ModelDefineBuilder.subtypes = subtypes;
    }

    public TypeDeserializer buildTypeDeserializer(DeserializationConfig config, JavaType baseType, Collection<NamedType> subtypes) {
        return super.buildTypeDeserializer(config, baseType, ModelDefineBuilder.subtypes);
    }

    public TypeSerializer buildTypeSerializer(SerializationConfig config, JavaType baseType, Collection<NamedType> subtypes) {
        return super.buildTypeSerializer(config, baseType, ModelDefineBuilder.subtypes);
    }
}
