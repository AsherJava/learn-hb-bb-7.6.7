...
@Component
public class DeleteDirectChildrenWithShift
implements IRowChecker {
    @Resource(name="#check-direct-children-with-shift-v2")
    ...
    public String getKeyword() {
        return "#delete-direct-children-with-shift";
    }

    @Override
    public String getShowText() {
        return this.i18nHelper.getMessage(UnitSelectorI18nKeys.DELETE_DIRECT_CHILDREN_WITH_SHIFT.i18nKey, "Shift\u53d6\u6d88\u52fe\u9009\u76f4\u63a5\u4e0b\u7ea7");
    }
