...
@Component
public class CheckLowerLeaves
implements IRowChecker {
    public static final String KEYWORD = "#check-lower-leaves";
    @Resource
    ...
    public String getShowText() {
        return this.i18nHelper.getMessage(UnitSelectorI18nKeys.CHECK_LOWER_LEAVES.i18nKey, "\u9009\u62e9\u6240\u6709\u4e0b\u7ea7\u53f6\u5b50\u8282\u70b9");
    }
    ...
    public IRowCheckExecutor getExecutor(IUnitTreeContext ctx) {
        return (values, entityRowsProvider) -> {
            ...
            if (null != values && null != (valueMaps = values.getValues()) && null != (allLeavesRows = entityRowsProvider.getAllChildLeaveRows(checkValues = valueMaps.stream().map(map -> (String)map.get("value")).collect(Collectors.toList()))) && !allLeavesRows.isEmpty()) {
