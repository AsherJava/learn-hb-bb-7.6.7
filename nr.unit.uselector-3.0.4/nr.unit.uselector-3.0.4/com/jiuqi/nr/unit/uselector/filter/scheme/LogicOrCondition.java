...
public class LogicOrCondition
extends AbstractConditionChain {
    public static final String KEYWORD = "logic_or_condition";

    public LogicOrCondition(IUnitTreeContext context, IUSelectorEntityRowProvider entityRowsProvider) {
    ...
    public void handle(AbstractConditionChain.LogicCondition logical, IFilterStringList operateSet) {
        if (null != this.nextCondition) {
            this.nextCondition.handle(AbstractConditionChain.LogicCondition.OR, operateSet);
        }
    }
}
