...
public class OrgToJsonVO {
    ...
    public boolean isStopFlag() {
        ...
        Object stopFlag = this.getFieldValue("STOPFLAG");
        if (stopFlag instanceof String) {
            String sv = (String)this.getFieldValue("STOPFLAG");
            return StringUtils.isEmpty((String)sv) ? this.stopFlag : !sv.equals("0");
        }
