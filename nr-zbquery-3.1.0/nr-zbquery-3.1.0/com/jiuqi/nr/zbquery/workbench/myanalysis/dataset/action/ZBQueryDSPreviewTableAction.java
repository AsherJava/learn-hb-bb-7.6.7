...
public class ZBQueryDSPreviewTableAction
extends MyAnalysisPreviewTableAction {
    public static final String ID = "myanalysis_table_dspreview_zbquery";

    public ZBQueryDSPreviewTableAction() {
    ...
    public ActionInteractSetting getPreviewInteractSetting() {
        ...
        interactSetting.setExpose("ZBQueryDSMyAnalysisEditor");
        interactSetting.setModalTitle("\u67e5\u8be2\u6570\u636e\u96c6" + this.getTitle());
