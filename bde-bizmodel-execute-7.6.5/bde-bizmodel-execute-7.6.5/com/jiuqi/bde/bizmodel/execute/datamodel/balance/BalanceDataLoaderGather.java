...
@Component
public class BalanceDataLoaderGather
implements IBalanceDataLoaderGather {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private IBizModelGather bizModelGather;
    private List<AbstractBalanceDataLoader> loaderList;
    private final Table<String, String, AbstractBalanceDataLoader> dataModelLoaderTable = TreeBasedTable.create();
    private final Table<String, String, AbstractBalanceDataLoader> bizModelLoaderTable = TreeBasedTable.create();

    public BalanceDataLoaderGather(@Autowired IBizModelGather bizModelGather, @Autowired(required=false) List<AbstractBalanceDataLoader> loaderList) {
    ...
    private void init() {
        if (this.loaderList == null) {
            this.loaderList = new ArrayList<AbstractBalanceDataLoader>();
        }
    ...
    @Override
    public AbstractBalanceDataLoader getLoader(String pluginType, String computationModelCode) {
        ...
        AbstractBalanceDataLoader loaderByDataModel = (AbstractBalanceDataLoader)this.dataModelLoaderTable.get((Object)pluginType, (Object)modelDefineByCode.getBizDataCode());
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
        loaderByDataModel = (AbstractBalanceDataLoader)this.bizModelLoaderTable.get((Object)pluginType, (Object)computationModelCode);
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
    ...
    public void afterPropertiesSet() {
        try {
            ...
            this.logger.error("\u670d\u52a1\u542f\u52a8\u8fc7\u7a0b\u4e2d\u4f59\u989d\u6a21\u578b\u52a0\u8f7d\u5668\u6536\u96c6\u51fa\u73b0\u9519\u8bef", e);
        }
    }
}
