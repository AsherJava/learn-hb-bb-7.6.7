...
@Component
public class AgingDataLoaderGather
implements IAgingDataLoaderGather {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private IBizModelGather bizModelGather;
    private List<AbstractAgingDataLoader> loaderList;
    private final Table<String, String, AbstractAgingDataLoader> dataModelLoaderTable = TreeBasedTable.create();
    private final Table<String, String, AbstractAgingDataLoader> bizModelLoaderTable = TreeBasedTable.create();

    public AgingDataLoaderGather(@Autowired(required=false) IBizModelGather bizModelGather, @Autowired(required=false) List<AbstractAgingDataLoader> loaderList) {
    ...
    private void init() {
        if (this.loaderList == null) {
            this.loaderList = new ArrayList<AbstractAgingDataLoader>();
        }
    ...
    @Override
    public AbstractAgingDataLoader getLoader(String pluginType, String computationModelCode) {
        ...
        AbstractAgingDataLoader loaderByDataModel = (AbstractAgingDataLoader)this.dataModelLoaderTable.get((Object)pluginType, (Object)modelDefineByCode.getBizDataCode());
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
        loaderByDataModel = (AbstractAgingDataLoader)this.bizModelLoaderTable.get((Object)pluginType, (Object)computationModelCode);
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
    ...
    public void afterPropertiesSet() {
        try {
            ...
            this.logger.error("\u670d\u52a1\u542f\u52a8\u8fc7\u7a0b\u4e2d\u8d26\u9f84\u6a21\u578b\u52a0\u8f7d\u5668\u6536\u96c6\u51fa\u73b0\u9519\u8bef", e);
        }
    }
}
