...
@Component
public class XjllDataLoaderGather
implements IXjllDataLoaderGather {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private IBizModelGather bizModelGather;
    private List<AbstractXjllDataLoader> loaderList;
    private final Table<String, String, AbstractXjllDataLoader> dataModelLoaderTable = TreeBasedTable.create();
    private final Table<String, String, AbstractXjllDataLoader> bizModelLoaderTable = TreeBasedTable.create();

    public XjllDataLoaderGather(@Autowired(required=false) IBizModelGather bizModelGather, @Autowired(required=false) List<AbstractXjllDataLoader> loaderList) {
    ...
    private void init() {
        if (this.loaderList == null) {
            this.loaderList = new ArrayList<AbstractXjllDataLoader>();
        }
    ...
    @Override
    public AbstractXjllDataLoader getLoader(String pluginType, String computationModelCode) {
        ...
        AbstractXjllDataLoader loaderByDataModel = (AbstractXjllDataLoader)this.dataModelLoaderTable.get((Object)pluginType, (Object)modelDefineByCode.getBizDataCode());
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
        loaderByDataModel = (AbstractXjllDataLoader)this.bizModelLoaderTable.get((Object)pluginType, (Object)computationModelCode);
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
    ...
    public void afterPropertiesSet() {
        try {
            ...
            this.logger.error("\u670d\u52a1\u542f\u52a8\u8fc7\u7a0b\u4e2d\u73b0\u6d41\u6a21\u578b\u52a0\u8f7d\u5668\u6536\u96c6\u51fa\u73b0\u9519\u8bef", e);
        }
    }
}
