...
import com.jiuqi.bde.bizmodel.execute.datamodel.gather.IVoucherDataLoaderGather;
...
@Component
public class VoucherDataLoaderGather
implements IVoucherDataLoaderGather {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private IBizModelGather bizModelGather;
    private List<AbstractVoucherDataLoader> loaderList;
    private final Table<String, String, AbstractVoucherDataLoader> dataModelLoaderTable = TreeBasedTable.create();
    private final Table<String, String, AbstractVoucherDataLoader> bizModelLoaderTable = TreeBasedTable.create();

    public VoucherDataLoaderGather(@Autowired(required=false) IBizModelGather bizModelGather, @Autowired(required=false) List<AbstractVoucherDataLoader> loaderList) {
    ...
    private void init() {
        if (this.loaderList == null) {
            this.loaderList = new ArrayList<AbstractVoucherDataLoader>();
        }
    ...
    @Override
    public AbstractVoucherDataLoader getLoader(String pluginType, String computationModelCode) {
        ...
        AbstractVoucherDataLoader loaderByDataModel = (AbstractVoucherDataLoader)this.dataModelLoaderTable.get((Object)pluginType, (Object)modelDefineByCode.getBizDataCode());
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
        loaderByDataModel = (AbstractVoucherDataLoader)this.bizModelLoaderTable.get((Object)pluginType, (Object)computationModelCode);
        if (loaderByDataModel != null) {
            return loaderByDataModel;
        }
    ...
    public void afterPropertiesSet() {
        try {
            ...
            this.logger.error("\u670d\u52a1\u542f\u52a8\u8fc7\u7a0b\u4e2d\u51ed\u8bc1\u6a21\u578b\u52a0\u8f7d\u5668\u6536\u96c6\u51fa\u73b0\u9519\u8bef", e);
        }
    }
}
