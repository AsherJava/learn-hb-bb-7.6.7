...
public class InvestBillResultSetExtractor
implements ResultSetExtractor<Map<String, Map<String, List<InvestBillData>>>> {
    private BalanceCondition condi;
    private static final String BALANCEORGNENABLE = "DC_BALANCE_ORGN_ENABLE";

    public InvestBillResultSetExtractor(BalanceCondition condi) {
        this.condi = condi;
    }

    public Map<String, Map<String, List<InvestBillData>>> extractData(ResultSet rs) throws SQLException, DataAccessException {
        ...
        while (rs.next()) {
            ...
            balanceData.setVchrDate(rs.getString("VCHRDATE"));
            balanceData.setChangeScenario(rs.getString("CHANGESCENARIO"));
            balanceData.setVchrUniqueCode(rs.getString("VCHRUNIQUECODE"));
            balanceData.setInvestedUnit(rs.getString("INVESTEDUNIT"));
            balanceData.setVchrTypeCode(rs.getString("VCHRTYPECODE"));
            balanceData.setVchrNum(rs.getString("VCHRNUM"));
            ...
            balanceData.setZsc(rs.getBigDecimal(FetchTypeEnum.ZSC.name()));
