...
@Component
public class BdeFetchSchemeConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_FETCHSCHEME_MANAGE";
    public static final String CACHE_NAME = "BDE_FETCHSCHEME";
