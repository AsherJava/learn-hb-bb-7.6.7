...
@Component
public class BdeFetchFloatSettingConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_FETCH_FLOAT_SETTING_MANAGE";
    public static final String CACHE_NAME = "BDE_FETCH_FLOAT_SETTING";
