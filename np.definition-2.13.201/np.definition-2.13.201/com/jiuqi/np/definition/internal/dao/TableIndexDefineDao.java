...
@Repository
public class TableIndexDefineDao
extends BaseDao {
    private final String ATTR_NAME = "title";
    private Class<TableIndexDefineImpl> implClz = TableIndexDefineImpl.class;
    ...
    public TableIndexDefine getByName(String indexName) throws Exception {
        List<TableIndexDefineImpl> list = this.list(new String[]{"title"}, new Object[]{indexName}, this.implClz);
