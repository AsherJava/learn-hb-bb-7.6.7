 ...
 */
package com.jiuqi.np.definition.internal.db;
...
public abstract class BaseDao {
    ...
    private StringBuilder insertSQL = new StringBuilder("insert into ");
    private StringBuilder selectSQL = new StringBuilder("select ");
    private StringBuilder updateSQL = new StringBuilder("update ");
    ...
    private Object transValue(String methodName, Class<?> type, Object v) throws Exception {
        ...
        if (methodMap != null) {
            ...
            if (transMethod == null) {
                transMethod = this.getTransMethod(v.getClass(), methodMap);
            }
            if (null != transMethod) {
    ...
    private Method getTransMethod(Class c, HashMap<Class<?>, Method> methodMap) {
        Method transMethod = methodMap.get(c.getSuperclass());
        if (transMethod == null) {
            transMethod = this.getTransMethod(c.getSuperclass(), methodMap);
        }
        return transMethod;
    }
    ...
    public int[] delete(final Object[] objs) throws BeanParaException, DBParaException {
        ...
        try {
            ...
            StringBuilder sql = new StringBuilder("delete from ").append(this.tablename).append(" where ").append(dbField.dbField().toUpperCase()).append("=?");
    ...
    public int update(Object obj) throws BeanParaException, DBParaException {
        ...
        try {
            ...
            StringBuilder sql = new StringBuilder(this.updateSQL.toString()).append(" where ").append(pkDbField.dbField().toUpperCase()).append("=?");
            Object[] ov = new Object[]{};
            for (String dbFieldName : this.dbFieldList) {
                Object v = null;
                Field field = this.fieldMap.get(this.dbFieldMap.get(dbFieldName));
    ...
    public <T> List<T> list(String sqlWhere, Object[] args, Class<? extends T> t) throws BeanParaException {
        ...
        try {
            ...
            if (sqlWhere == null || sqlWhere.equals("")) {
                ...
                sql = this.selectSQL.toString() + " where " + sqlWhere + " " + order;
    ...
    public <T> List<T> list(String[] fieldNames, Object[] args, Class<? extends T> t) throws BeanParaException {
        ...
        try {
            ...
            if (fieldNames == null || fieldNames.length == 0) {
                ...
                String sql = this.selectSQL.toString() + " where " + sqlWhere + order;
                Object[] objs1 = objs;
    ...
    public <T> T getByKey(Object obj, Class<T> t) throws BeanParaException {
        ...
        try {
            ...
            String sql = this.selectSQL.toString() + " where " + sqlWhere;
    ...
    public <T> List<T> listByForeign(Object obj, String[] filterAttrs1, String[] filterAttrs2, Object[] values, Class<? extends T> t) throws BeanParaException {
        ...
        try {
            ...
            sql.append((CharSequence)sqlWhere).append(")");
    ...
    public int update(Object obj, String[] fieldNames, Object[] args) throws BeanParaException, DBParaException {
        ...
        try {
            ...
            String sql = this.updateSQL.toString() + " where " + sqlWhere;
            ArrayList<Object> lst = new ArrayList<Object>();
            Object[] ov = new Object[]{};
            for (String dbFieldName : this.dbFieldList) {
                Object v = null;
    ...
    public int count(String whereSQL) {
        this.buildMethod();
        String sql = "";
        StringBuilder sqlSb = new StringBuilder("SELECT COUNT(1) FROM ");
