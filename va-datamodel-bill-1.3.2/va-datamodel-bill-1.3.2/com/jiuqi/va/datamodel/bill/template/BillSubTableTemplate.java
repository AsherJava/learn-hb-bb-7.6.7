...
@Component
public class BillSubTableTemplate
implements DataModelBillExtendTemplate {
    ...
    public String getTitle() {
        return BillMessageSourceUtil.getMessage("datamodel.attribute.biztype.billSub", new Object[0]);
    }

    @Override
    public int getSubBizType() {
        return BillSubBizType.BILLSUB.getIndex();
    }
    ...
    public List<DataModelIndex> getTemplateIndexs(String tableName) {
        ...
        DataModelIndex index1 = new DataModelIndex().columnList(new String[]{"MASTERID"});
        if (tableName != null) {
            index1.setIndexName(tableName + "_MASTERID");
        } else {
