...
@Component
public class SameCtrLastYearAdjustOffsetFunction
extends Function
implements INrFunction {
    ...
    public SameCtrLastYearAdjustOffsetFunction() {
    ...
    private Map<String, Double> getCache(QueryContext queryContext, String orgTypeCode, String dataTime, GcOrgCacheVO org) {
        String cacheName = "snTzDxFunctionCache";
        ...
        Map<String, Double> subjectCode2OffsetMap = this.sameCtrlBeginOffSetItemService.calcBeginSubjectCode2Offset(dataTime, orgTypeCode, currMergeOrgCacheVO);
    ...
    public String toDescription() {
        ...
        buffer.append("    ").append(DataType.toExpression((int)3)).append("\uff1a").append(DataType.toString((int)3)).append("\uff1b").append("\u4e0a\u5e74\u540c\u671f\u6570\u8c03\u6574\u8868\u4e2d\u5408\u5e76\u62b5\u9500\u8c03\u6574\u6570").append(com.jiuqi.bi.util.StringUtils.LINE_SEPARATOR);
        ...
        buffer.append("    ").append("    ").append("SNTZDX('1231')").append(com.jiuqi.bi.util.StringUtils.LINE_SEPARATOR);
