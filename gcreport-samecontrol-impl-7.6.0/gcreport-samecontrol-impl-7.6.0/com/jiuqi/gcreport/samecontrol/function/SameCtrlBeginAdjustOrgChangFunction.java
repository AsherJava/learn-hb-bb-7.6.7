...
@Component
public class SameCtrlBeginAdjustOrgChangFunction
extends Function
implements INrFunction {
    public SameCtrlBeginAdjustOrgChangFunction() {
    ...
    public Object evalute(IContext iContext, List<IASTNode> list) throws SyntaxException {
        ...
        String lastYearEndZbCode = (String)list.get(0).evaluate(iContext);
        return SameCtrlZbValueExecutionProcessor.calResult(queryContext, lastYearEndZbCode);
    }

    double calResult(QueryContext queryContext, String lastYearEndZbCode) {
        return SameCtrlZbValueExecutionProcessor.calResult(queryContext, lastYearEndZbCode);
    }
    ...
    public String toDescription() {
        ...
        stringBuilder.append("    ").append(DataType.toExpression((int)3)).append("\uff1a").append(DataType.toString((int)3)).append("\uff1b").append("\u975e\u5dee\u989d\u5355\u4f4d\uff0c\u8fd4\u56de0; \u5dee\u989d\u5355\u4f4d\uff0c\u8fd4\u56de\u5bf9\u5e94\u5408\u5e76\u5355\u4f4d\u5f53\u5e74\u540c\u63a7\u6536\u8d2d\u53d8\u52a8\u5355\u4f4d\u7684\u5f53\u671f\u53c2\u65701\uff08\u4e0a\u5e74\u5e74\u672b\u6570\u6307\u6807\uff09\u6307\u6807\u6570\u636e-\u5bf9\u5e94\u5408\u5e76\u5355\u4f4d\u662f\u5171\u540c\u4e0a\u7ea7\u7684\u5f53\u5e74\u540c\u63a7\u53d8\u52a8\u5355\u4f4d\u7684\u5f53\u671f\u53c2\u65701\uff08\u4e0a\u5e74\u5e74\u672b\u6570\u6307\u6807\uff09\u6307\u6807\u6570\u636e.").append(StringUtils.LINE_SEPARATOR);
        ...
        stringBuilder.append("    ").append("    ").append("QCTZDWBD('ZCOX_YB01[A01]')").append(StringUtils.LINE_SEPARATOR);
        stringBuilder.append("    ").append("    ").append("QCTZDWBD('\u62a5\u8868\u6807\u8bc6[2,1]')").append(StringUtils.LINE_SEPARATOR);
