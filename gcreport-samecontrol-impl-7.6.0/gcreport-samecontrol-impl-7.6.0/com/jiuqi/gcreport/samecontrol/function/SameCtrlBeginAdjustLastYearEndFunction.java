...
@Component
public class SameCtrlBeginAdjustLastYearEndFunction
extends Function
implements INrFunction {
    private static final transient Logger logger = LoggerFactory.getLogger(SameCtrlBeginAdjustLastYearEndFunction.class);
    @Autowired
    private SameCtrlChgOrgService sameCtrlChgOrgService;

    public SameCtrlBeginAdjustLastYearEndFunction() {
    ...
    public Object evalute(IContext iContext, List<IASTNode> list) throws SyntaxException {
        ...
        String lastYearEndZbCode = (String)list.get(1).evaluate((IContext)queryContext);
        return this.calResult(queryContext, originalFormula, lastYearEndZbCode);
    }
    ...
    public String toDescription() {
        ...
        stringBuilder.append("    ").append(DataType.toExpression((int)3)).append("\uff1a").append(DataType.toString((int)3)).append("\uff1b").append("\u5982\u679c\u4e0d\u662f\u5dee\u989d\u5355\u4f4d\uff0c\u76f4\u63a5\u8fd4\u56de\u53c2\u65701\uff08\u539f12\u6708\u6570\u516c\u5f0f\uff09\u7684\u8fd0\u7b97\u7ed3\u679c;\u5dee\u989d\u5355\u4f4d\u4e0a\u8fd4\u56de\u4e0a\u5e74\u5e74\u672b\u6570\u6307\u6807\u7684\u6570\u636e\u7ed3\u679c").append(StringUtils.LINE_SEPARATOR);
        ...
        stringBuilder.append("    ").append("    ").append("\u539f12\u6708\u6570\u516c\u5f0f,\u4e0a\u5e74\u5e74\u672b\u6570\u6307\u6807\u7684\u6570\u636e\u7ed3\u679c\u3002").append(StringUtils.LINE_SEPARATOR);
    ...
    double calResult(QueryContext queryContext, String originalFormula, String lastYearEndZbCode) {
        double result = 0.0;
        try {
            ...
            result += this.evaluateSameCtrlChgOrg(queryContext, lastYearEndZbCode, org);
        }
        catch (Exception e) {
    ...
    private double evaluateSameCtrlChgOrg(QueryContext queryContext, String lastYearEndZbCode, GcOrgCacheVO org) {
        ...
        try {
            ...
            List<SameCtrlChgOrgEO> sameCtrlVirtualCodeList = this.sameCtrlChgOrgService.listCurrYearChgOrgsByDisposOrg(org.getParentId(), dataTime);
            ...
            if (!CollectionUtils.isEmpty(sameCtrlChangeCodeList = this.sameCtrlChgOrgService.listCurrYearChgOrgsByAcquisitionOrg(org.getParentId(), dataTime))) {
