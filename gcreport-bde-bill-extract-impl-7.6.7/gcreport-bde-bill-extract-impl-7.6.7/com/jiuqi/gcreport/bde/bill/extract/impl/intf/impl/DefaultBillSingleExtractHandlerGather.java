...
@Component
public class DefaultBillSingleExtractHandlerGather
implements IBillSingleExtractHandlerGather,
InitializingBean {
    @Autowired(required=false)
    private List<IBillSingleExtractHandler> orgnModelHandlerList;
    private Map<String, IBillSingleExtractHandler> modelHandlerMap;
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private void init() {
        this.modelHandlerMap = CollectionUtils.newHashMap();
        for (IBillSingleExtractHandler handler : this.orgnModelHandlerList) {
    ...
    public IBillSingleExtractHandler getHandlerByModel(String modelCode) {
