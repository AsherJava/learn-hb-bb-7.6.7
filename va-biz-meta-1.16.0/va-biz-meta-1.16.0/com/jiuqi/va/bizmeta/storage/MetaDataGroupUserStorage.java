...
@Component
public class MetaDataGroupUserStorage
extends AMetaStorage {
    @Override
    protected JTableModel getCreateJTM(String tenantName) {
        JTableModel jtm = new JTableModel(tenantName, "META_GROUP_USER");
        ...
        jtm.index("MAGPUR_MO_NAME_METATYPE_UM").columns(new String[]{"MODULENAME", "NAME", "METATYPE", "USERNAME"}).unique();
        return jtm;
    }
}
