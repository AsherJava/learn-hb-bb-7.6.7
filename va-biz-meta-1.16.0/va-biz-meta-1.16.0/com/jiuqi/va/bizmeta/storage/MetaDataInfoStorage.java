...
@Component
public class MetaDataInfoStorage
extends AMetaStorage {
    @Override
    protected JTableModel getCreateJTM(String tenantName) {
        JTableModel jtm = new JTableModel(tenantName, "META_INFO");
        ...
        jtm.index("MAIO_NE_ME_MO").columns(new String[]{"NAME", "METATYPE", "MODULENAME"}).unique();
        return jtm;
    }
}
