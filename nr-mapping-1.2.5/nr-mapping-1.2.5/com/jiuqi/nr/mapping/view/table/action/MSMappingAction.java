...
public class MSMappingAction
extends AbstractTableAction {
    protected final Logger logger = LoggerFactory.getLogger(MSMappingAction.class);
    public static final String ID = "mapping_table_mapping";
    public static final String TITLE = "\u6620\u5c04";

    public MSMappingAction() {
    ...
    public ActionInteractSetting getDefaultInteractSetting(String modalTitle) {
        ...
        interactSetting.setExpose("MappingMain");
