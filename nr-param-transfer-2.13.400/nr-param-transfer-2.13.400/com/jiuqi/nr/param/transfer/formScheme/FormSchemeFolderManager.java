...
@Component
public class FormSchemeFolderManager
extends AbstractFolderManager {
    @Autowired
    private IDesignTimeViewController designTimeViewController;
    private static final Logger logger = LoggerFactory.getLogger(FormSchemeFolderManager.class);
    ...
    private List<FolderNode> get(String taskGroupKey, String parent) {
        List childTaskGroups = this.designTimeViewController.getChildTaskGroups(taskGroupKey, false);
        List<FolderNode> list = NodeUtil.metaToFolderNodes(childTaskGroups, parent, TransferNodeType.TASK_GROUP);
        List allTasksInGroup = this.designTimeViewController.getAllTasksInGroup(taskGroupKey, false);
        list.addAll(NodeUtil.taskToFolderNodes(allTasksInGroup, parent));
        return list;
    }
    ...
    public List<FolderNode> getPathFolders(String s) throws TransferException {
        ...
        try {
            block8: while (StringUtils.hasLength(key)) {
