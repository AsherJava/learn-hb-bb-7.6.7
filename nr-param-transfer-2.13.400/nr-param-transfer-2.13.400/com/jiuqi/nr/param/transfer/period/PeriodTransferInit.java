...
import com.jiuqi.nr.param.transfer.period.PeriodTransferFactory;
...
@Component
public class PeriodTransferInit
implements ApplicationInitialization {
    private static final Logger LOGGER = LoggerFactory.getLogger(PeriodTransferInit.class);
    @Autowired
    private PeriodTransferFactory periodTransferFactory;
    ...
    public void init(boolean isSysTenant) {
        try {
            ...
            TransferFactoryManager.getInstance().register((TransferFactory)this.periodTransferFactory);
