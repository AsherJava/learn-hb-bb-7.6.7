 ...
 */
package com.jiuqi.nr.param.transfer.definition.dto.taskgroup;
...
public class TaskLinkDTO {
    ...
    public static TaskLinkDTO valueOf(TaskLinkDefine designTaskLinkDefine) {
        if (designTaskLinkDefine == null) {
            return null;
        }
        TaskLinkDTO taskInfo = new TaskLinkDTO();
        taskInfo.setBeginTime(designTaskLinkDefine.getBeginTime());
        taskInfo.setConfiguration(designTaskLinkDefine.getConfiguration());
        taskInfo.setCurrentFormSchemeKey(designTaskLinkDefine.getCurrentFormSchemeKey());
        taskInfo.setDescription(designTaskLinkDefine.getDescription());
        taskInfo.setEndTime(designTaskLinkDefine.getEndTime());
        taskInfo.setIsHidden(designTaskLinkDefine.getIsHidden());
        taskInfo.setKey(designTaskLinkDefine.getKey());
        taskInfo.setLinkAlias(designTaskLinkDefine.getLinkAlias());
        taskInfo.setMatching(designTaskLinkDefine.getMatching());
        taskInfo.setMatchingType(designTaskLinkDefine.getMatchingType());
        taskInfo.setOrder(designTaskLinkDefine.getOrder());
        taskInfo.setOwnerLevelAndId(designTaskLinkDefine.getOwnerLevelAndId());
        taskInfo.setPeriodOffset(designTaskLinkDefine.getPeriodOffset());
        taskInfo.setCurrentTaskFormula(designTaskLinkDefine.getCurrentFormula());
        taskInfo.setRelatedTaskFormula(designTaskLinkDefine.getRelatedFormula());
        taskInfo.setRelatedFormSchemeKey(designTaskLinkDefine.getRelatedFormSchemeKey());
        taskInfo.setRelatedTaskCode(designTaskLinkDefine.getRelatedTaskCode());
        taskInfo.setRelatedTaskKey(designTaskLinkDefine.getRelatedTaskKey());
        taskInfo.setSpecified(designTaskLinkDefine.getSpecified());
        taskInfo.setTheoffset(designTaskLinkDefine.getTheoffset());
        taskInfo.setTitle(designTaskLinkDefine.getTitle());
        taskInfo.setUpdateTime(designTaskLinkDefine.getUpdateTime());
        taskInfo.setVersion(designTaskLinkDefine.getVersion());
        taskInfo.setExpressionType(designTaskLinkDefine.getExpressionType());
        taskInfo.setRelatedDims(designTaskLinkDefine.getRelatedDims());
        taskInfo.setOrgMappingRule(designTaskLinkDefine.getOrgMappingRules());
        return taskInfo;
    }
