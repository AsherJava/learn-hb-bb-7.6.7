...
public class ReginInfoDTO {
    ...
    public static ReginInfoDTO valueOf(DataRegionDefine dataRegionDefine, RegionSettingDefine regionSettingDefine) {
        ReginInfoDTO regionParam = new ReginInfoDTO();
        regionParam.setRegionSettingKey(dataRegionDefine.getRegionSettingKey());
        regionParam.setCode(dataRegionDefine.getCode());
        regionParam.setFormKey(dataRegionDefine.getFormKey());
        regionParam.setRegionLeft(dataRegionDefine.getRegionLeft());
        regionParam.setRegionRight(dataRegionDefine.getRegionRight());
        regionParam.setRegionTop(dataRegionDefine.getRegionTop());
        regionParam.setRegionBottom(dataRegionDefine.getRegionBottom());
        regionParam.setRegionKind(dataRegionDefine.getRegionKind());
        regionParam.setInputOrderFieldKey(dataRegionDefine.getInputOrderFieldKey());
        regionParam.setSortFieldsList(dataRegionDefine.getSortFieldsList());
        regionParam.setRowsInFloatRegion(dataRegionDefine.getRowsInFloatRegion());
        regionParam.setGatherFields(dataRegionDefine.getGatherFields());
        regionParam.setLevelSetting(dataRegionDefine.getLevelSetting());
        regionParam.setFilterCondition(dataRegionDefine.getFilterCondition());
        regionParam.setKey(dataRegionDefine.getKey());
        regionParam.setTitle(dataRegionDefine.getTitle());
        regionParam.setOrder(dataRegionDefine.getOrder());
        regionParam.setVersion(dataRegionDefine.getVersion());
        regionParam.setUpdateTime(dataRegionDefine.getUpdateTime());
        regionParam.setMaxRowCount(dataRegionDefine.getMaxRowCount());
        regionParam.setCanDeleteRow(dataRegionDefine.getCanDeleteRow());
        regionParam.setCanInsertRow(dataRegionDefine.getCanInsertRow());
        regionParam.setPageSize(dataRegionDefine.getPageSize());
        regionParam.setReadOnlyCondition(dataRegionDefine.getReadOnlyCondition());
        regionParam.setShowGatherDetailRows(dataRegionDefine.getShowGatherDetailRows());
        regionParam.setShowGatherDetailRowByOne(dataRegionDefine.getShowGatherDetailRowByOne());
        regionParam.setShowGatherSummaryRow(dataRegionDefine.getShowGatherSummaryRow());
        regionParam.setHideZeroGatherFields(dataRegionDefine.getHideZeroGatherFields());
        regionParam.setAllowDuplicateKey(dataRegionDefine.getAllowDuplicateKey());
        regionParam.setShowAddress(dataRegionDefine.getShowAddress());
        regionParam.setCanFold(dataRegionDefine.getIsCanFold());
        regionParam.setOwnerLevelAndId(dataRegionDefine.getOwnerLevelAndId());
        regionParam.setRegionEnterNext(dataRegionDefine.getRegionEnterNext());
        regionParam.setRegionSetting(RegionSettingDTO.valueOf(regionSettingDefine));
        return regionParam;
    }
}
