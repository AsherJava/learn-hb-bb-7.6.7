...
public class FormGroupInfoDTO {
    ...
    public static FormGroupInfoDTO valueOf(FormGroupDefine groupDefine) {
        if (groupDefine == null) {
            return null;
        }
        FormGroupInfoDTO formGroupInfo = new FormGroupInfoDTO();
        formGroupInfo.setFormSchemeKey(groupDefine.getFormSchemeKey());
        formGroupInfo.setParentKey(groupDefine.getParentKey());
        formGroupInfo.setKey(groupDefine.getKey());
        formGroupInfo.setTitle(groupDefine.getTitle());
        formGroupInfo.setOrder(groupDefine.getOrder());
        formGroupInfo.setVersion(groupDefine.getVersion());
        formGroupInfo.setOwnerLevelAndId(groupDefine.getOwnerLevelAndId());
        formGroupInfo.setUpdateTime(groupDefine.getUpdateTime());
        formGroupInfo.setCode(groupDefine.getCode());
        formGroupInfo.setCondition(groupDefine.getCondition());
        formGroupInfo.setMeasureUnit(groupDefine.getMeasureUnit());
