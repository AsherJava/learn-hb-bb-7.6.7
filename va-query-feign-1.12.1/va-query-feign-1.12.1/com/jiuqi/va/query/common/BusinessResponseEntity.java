...
import com.jiuqi.va.query.utils.DefineQuerySqlUtils;
...
public final class BusinessResponseEntity<T> {
    ...
    public static <T> BusinessResponseEntity<T> error(Throwable e) {
        ...
        String errorMessage = !StringUtils.hasText(e.getMessage()) ? "\u7cfb\u7edf\u5904\u7406\u8fc7\u7a0b\u4e2d\u53d1\u751f\u5f02\u5e38\u9519\u8bef\u3002" : e.getMessage();
        return BusinessResponseEntity.error(null, errorMessage, errorDetail);
    }

    public static BusinessResponseEntity<DefineQuerySqlParseInfoVO> handleSqlException(DefinedQuerySqlException definedQuerySqlException) {
        DefineQuerySqlParseInfoVO sqlParseInfoVO = DefineQuerySqlUtils.getSqlParseInfoVO(definedQuerySqlException);
        BusinessResponseEntity<DefineQuerySqlParseInfoVO> sqlerror = BusinessResponseEntity.error("SQLERROR", sqlParseInfoVO.getMessage(), null);
        sqlerror.data(sqlParseInfoVO);
        return sqlerror;
    }
