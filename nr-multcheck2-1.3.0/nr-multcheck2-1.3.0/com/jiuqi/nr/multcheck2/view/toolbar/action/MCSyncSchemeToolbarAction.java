...
public class MCSyncSchemeToolbarAction
extends NewResourceToolbarAction {
    protected final Logger logger = LoggerFactory.getLogger(MCSyncSchemeToolbarAction.class);
    private static final String ID = "multcheck2_toolbar_sync-scheme";
    private static final String TITLE = "\u590d\u5236\u65b9\u6848";
    private static final String ICON = "#icon16_GJ_A_NW_shuaxin";

    public MCSyncSchemeToolbarAction() {
