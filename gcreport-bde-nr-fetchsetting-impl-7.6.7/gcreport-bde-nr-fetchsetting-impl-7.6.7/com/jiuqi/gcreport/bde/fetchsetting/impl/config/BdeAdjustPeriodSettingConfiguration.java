...
@Component
public class BdeAdjustPeriodSettingConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_ADJUST_FETCH_SETTING_MANAGE";
    public static final String CACHE_NAME = "BDE_ADJUST_FETCH_SETTING";
