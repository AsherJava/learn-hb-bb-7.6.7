...
@Component
public class FinancialAgingBizModelHandler
extends AbstractBizModelHandler {
    @Override
    public String getBizModelCode() {
        return ComputationModelEnum.FINANCIALASSAGINGBALANCE.getCode();
    }
    ...
    public boolean basicCheck(ExcelRowFetchSettingVO excelRowFetchSettingVO, BizModelDTO bizModelDTO) {
        ...
        if (StringUtils.isEmpty((String)excelRowFetchSettingVO.getAgingGroupName())) {
            excelRowFetchSettingVO.setErrorLog("\u8d26\u9f84\u6bb5\u4e0d\u80fd\u4e3a\u7a7a");
            return false;
        }
    ...
    public ExcelRowFetchSettingVO importDataHandle(ExcelRowFetchSettingVO excelRowFetchSettingVO, BizModelDTO bizModelDTO) {
        ...
        if (!StringUtils.isEmpty((String)excelRowFetchSettingVO.getAgeGroup())) {
            rowImpSettingVO.setAgeGroup(AgingPeriodTypeEnum.getAgingPeriodTypeEnumByName((String)excelRowFetchSettingVO.getAgingGroupName()).getCode());
        }
