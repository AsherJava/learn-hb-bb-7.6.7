...
@Component
public class BdeFloatDimensionSettingConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_FLOAT_DIMENSION_SETTING_MANAGE";
    public static final String CACHE_NAME = "BDE_FLOAT_DIMENSION_SETTING";
