...
public enum CompareType implements Serializable
{
    ...
    CONTAINS("\u5305\u542b", "position(", ")>=1", 9),
    NOT_CONTAINS("\u4e0d\u5305\u542b", "position(", ")<1", 10),
    IN("\u5c5e\u4e8e", "in{", "}", 11),
    MOBILEPHONE("\u624b\u673a\u53f7", "IsMobilePhone(", ")", 12),
    NOTNULL("\u4e0d\u80fd\u4e3a\u7a7a", "NOT ISNULL(", ")", 13),
    MAXLEN("\u6700\u5927\u957f\u5ea6", "LENGTH(", ")<=", 14);

    private static final long serialVersionUID = -8107789739176241121L;
