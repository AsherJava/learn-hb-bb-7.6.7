...
import com.jiuqi.nr.data.excel.param.FormulaDataLinkNodeInfo;
...
implements Comparable {
    ...
    public FormulaData(IParsedExpression farsedExpression, IRunTimeViewController controller, boolean isAnalysis, int showType, String formSchemeKey, List<IASTAdjustor> list, IDataDefinitionRuntimeController dataDefinitionRuntimeController, ReportFmlExecEnvironment environment) {
        ...
        if (isAnalysis) {
            try {
                ...
                this.formula = farsedExpression.getRealExpression().interpret((IContext)queryContext, Language.EXCEL, (Object)formulaShowInfo);
                ...
                this.formulaNodes = ExportUtil.getFormulaNodes(farsedExpression);
            }
    ...
    public void setFormulaNodes(List<FormulaNode> formulaNodes) {
