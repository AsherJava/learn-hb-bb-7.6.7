...
import com.jiuqi.nr.data.excel.wb.format.PercentFormat;
import com.jiuqi.nr.data.excel.wb.format.zero_show.ZeroShow;

public class ZeroPercentFormat
extends PercentFormat
implements ZeroShow {
    private final String zeroShowStr;
    private final boolean open;

    public ZeroPercentFormat(int decimal, String zeroShowStr, boolean open) {
        super(decimal);
