...
import com.jiuqi.nr.bpm.i18n.I18NProcessBtn;
...
@Component
public class I18nProcessBtnRegister
implements I18NResource {
    ...
    static final String NAME = "\u65b0\u62a5\u8868/\u4efb\u52a1\u8bbe\u8ba1/\u6d41\u7a0b\u6309\u94ae";
    ...
    public List<I18NResourceItem> getResource(String parentId) {
        ...
        I18NProcessBtn[] values = I18NProcessBtn.values();
        if (null == parentId || StringUtils.isEmpty((String)parentId)) {
            for (I18NProcessBtn value : values) {
