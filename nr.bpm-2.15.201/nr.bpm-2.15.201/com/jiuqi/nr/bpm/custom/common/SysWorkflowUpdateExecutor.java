...
public class SysWorkflowUpdateExecutor
implements CustomClassExecutor {
    private static final String SYS_WORKFLOW_DEFINE = "SYS_WORKFLOW_DEFINE";
    private static final String SYS_WORKFLOW_LINE = "SYS_WORKFLOW_LINE";
    private static final String SYS_WORKFLOW_ACTION = "SYS_WORKFLOW_ACTION";
    private static final String SYS_WORKFLOW_NODESET = "SYS_WORKFLOW_NODESET";
    private static final String SYS_WORKFLOW_PARTI = "SYS_WORKFLOW_PARTI";
    private static final String SYS_WORKFLOW_SETTING = "SYS_WORKFLOW_SETTING";
    ...
    private static final String S_WORKFLOWENTITIES = "S_WORKFLOWENTITIES";
    ...
    private List<String> getDesWorkflowSettingPrimaryKeys() {
        ArrayList<String> primaryKeyNames = new ArrayList<String>();
        primaryKeyNames.add(S_ID);
        return primaryKeyNames;
    }
    ...
    public void execute(DataSource dataSource) throws Exception {
        ...
        updateExecutorTool.update(dataSource, F_XML, this.getDesWorkflowDefinePrimaryKeys(), SYS_WORKFLOW_DEFINE);
        updateExecutorTool.batchUpdate(dataSource, this.getUpdateLineFileds(), this.getDesWorkflowLinePrimaryKeys(), SYS_WORKFLOW_LINE);
        updateExecutorTool.update(dataSource, A_EXSET, this.getDesWorkflowActionPrimaryKeys(), SYS_WORKFLOW_ACTION);
        updateExecutorTool.batchUpdate(dataSource, this.getNodeSetFileds(), this.getDesWorkflowNodeSetPrimaryKeys(), SYS_WORKFLOW_NODESET);
        updateExecutorTool.batchUpdate(dataSource, this.getUpdatePartiFileds(), this.getDesWorkflowPartiPrimaryKeys(), SYS_WORKFLOW_PARTI);
        updateExecutorTool.update(dataSource, S_WORKFLOWENTITIES, this.getDesWorkflowSettingPrimaryKeys(), SYS_WORKFLOW_SETTING);
    }
}
