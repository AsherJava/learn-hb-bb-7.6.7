...
@RealTimeJob(group="ASYNCTASK_STARTPROCESS", groupTitle="\u5f00\u542f\u6d41\u7a0b", subject="\u62a5\u8868")
public class StartProcessAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    ...
    public void executeWithNpContext(JobContext jobContext) throws JobExecutionException {
        ...
        RealTimeTaskMonitor asyncTaskMonitor = new RealTimeTaskMonitor(taskId, AsynctaskPoolType.ASYNCTASK_STARTPROCESS.getName(), jobContext);
        try {
            ...
            if (Objects.nonNull(params) && Objects.nonNull(args)) {
                ...
                workflowSettingService.startDataObjs(stateChangeObj, (AsyncTaskMonitor)asyncTaskMonitor);
    ...
    public String getTaskPoolType() {
        return AsynctaskPoolType.ASYNCTASK_STARTPROCESS.getName();
    }
}
