...
@RealTimeJob(group="ASYNCTASK_STOPPROCESS", groupTitle="\u6e05\u9664\u6d41\u7a0b", subject="\u62a5\u8868")
public class ClearProcessAsyncTaskExecutor
extends NpRealTimeTaskExecutor {
    ...
    public void executeWithNpContext(JobContext jobContext) throws JobExecutionException {
        ...
        RealTimeTaskMonitor asyncTaskMonitor = new RealTimeTaskMonitor(taskId, AsynctaskPoolType.ASYNCTASK_STOPPROCESS.getName(), jobContext);
        try {
            ...
            if (Objects.nonNull(params) && Objects.nonNull(args)) {
                ...
                workflowSettingService.clearDataObjs(stateChangeObj, (AsyncTaskMonitor)asyncTaskMonitor);
    ...
    public String getTaskPoolType() {
        return AsynctaskPoolType.ASYNCTASK_STOPPROCESS.getName();
    }
}
