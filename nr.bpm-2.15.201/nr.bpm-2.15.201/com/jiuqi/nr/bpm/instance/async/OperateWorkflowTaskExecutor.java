...
@RealTimeJob(group="ASYNCTASK_OPERATE_WORKFLOW_INSTANCE", groupTitle="\u6d41\u7a0b\u5b9e\u4f8b\u6267\u884c", subject="\u62a5\u8868")
public class OperateWorkflowTaskExecutor
extends NpRealTimeTaskExecutor {
    private static final long serialVersionUID = 1L;
    public static final String ASYNCTASK_OPERATE_WORKFLOW_INSTANCE = "ASYNCTASK_OPERATE_WORKFLOW_INSTANCE";
    ...
    public void executeWithNpContext(JobContext jobContext) throws JobExecutionException {
        ...
        RealTimeTaskMonitor asyncTaskMonitor = new RealTimeTaskMonitor(taskId, ASYNCTASK_OPERATE_WORKFLOW_INSTANCE, jobContext);
        try {
            ...
            if (Objects.nonNull(params) && Objects.nonNull(args)) {
                ...
                workflowInstanceService.operateWorkflowInstance(startStateParam, (AsyncTaskMonitor)asyncTaskMonitor);
    ...
    public String getTaskPoolType() {
        return ASYNCTASK_OPERATE_WORKFLOW_INSTANCE;
    }
}
