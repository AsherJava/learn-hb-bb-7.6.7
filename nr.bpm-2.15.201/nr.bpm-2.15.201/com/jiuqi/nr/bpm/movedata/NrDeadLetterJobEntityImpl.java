...
public class NrDeadLetterJobEntityImpl {
    private String id;
    ...
    public String toString() {
        return "NrDeadLetterJobEntityImpl{id='" + this.id + '\'' + ", rev=" + this.rev + ", type='" + this.type + '\'' + ", exclusive=" + this.exclusive + ", executionId='" + this.executionId + '\'' + ", processInstanceId='" + this.processInstanceId + '\'' + ", procDefId='" + this.procDefId + '\'' + ", exceptionStackId='" + this.exceptionStackId + '\'' + ", exceptionMsg='" + this.exceptionMsg + '\'' + ", dueDate=" + this.dueDate + ", repeat='" + this.repeat + '\'' + ", handlerType='" + this.handlerType + '\'' + ", handlerCfg='" + this.handlerCfg + '\'' + ", tenantId='" + this.tenantId + '\'' + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        NrDeadLetterJobEntityImpl that = (NrDeadLetterJobEntityImpl)o;
