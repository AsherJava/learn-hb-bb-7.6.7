...
public class FormCopyPublishProgressVO {
    ...
    public FormCopyPublishProgressVO() {
    }

    public FormCopyPublishProgressVO(ProgressItem progress) {
        if (progress != null) {
            this.initSteps();
            ...
            this.currentProgess = progress.getCurrentProgess();
