...
public class FormCopyContext {
    Map<String, List<FormCopyDeleteFormRegionDefine>> formKeyToFormRegionMap;
    ...
    public Map<String, List<FormCopyDeleteFormRegionDefine>> getFormKeyToFormRegionMap() {
        return this.formKeyToFormRegionMap;
    }

    public void setFormKeyToFormRegionMap(Map<String, List<FormCopyDeleteFormRegionDefine>> formKeyToFormRegionMap) {
        this.formKeyToFormRegionMap = formKeyToFormRegionMap;
    }
