...
import com.jiuqi.nr.task.form.util.FormulaMonitor;
import com.jiuqi.nr.task.form.util.FormulaObj;
...
@Component(value="saveFormWithFormulaHelper2")
public class SaveFormWithFormulaHelper {
        ...
        if (designFormulaDTOList != null && designFormulaDTOList.size() != 0) {
            ...
            for (DesignFormulaDTO designFormulaDTO : designFormulaDTOList) {
                ...
                if (StringUtils.isNotEmpty((String)message)) {
                    ...
                    designFormulaDTO.setResultMes("\u516c\u5f0f\u65e0\u6cd5\u66f4\u65b0\u3010\u6570\u636e\u94fe\u63a5\u88ab\u79fb\u9664\u7b49\u539f\u56e0\u3011\uff0c\u5c06\u4fdd\u6301\u539f\u5185\u5bb9\u4e0d\u53d8\u3002");
                }
    ...
    public Map<String, List<DesignFormulaDTO>> saveFormWithFormula(String formKey, FormDesignerDTO formSaveObject, ProgressItem progressItem) {
        ...
        List allFormulaScheme = this.formulaDesignTimeController.getAllFormulaSchemeDefinesByFormScheme(formSaveObject.getForm().getFormScheme());
        List formulaSchemeKeys = allFormulaScheme.stream().filter(o -> o.getFormulaSchemeType() == FormulaSchemeType.FORMULA_SCHEME_TYPE_REPORT).map(IBaseMetaItem::getKey).collect(Collectors.toList());
    ...
    private List<IParsedExpression> parseFormulas(String formSchemeKey, List<Formula> formulaList, DataEngineConsts.FormulaType formulaType, FormulaMonitor formulaMonitor) throws JQException {
        ...
        try {
            ...
            logger.error("\u516c\u5f0f\u6821\u9a8c\u540e\u53f0\u5f02\u5e38:{}", (Object)e.getMessage(), (Object)e);
        }
