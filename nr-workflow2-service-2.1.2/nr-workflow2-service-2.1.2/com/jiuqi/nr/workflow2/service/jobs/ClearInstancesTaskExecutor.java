...
@RealTimeJob(group="NR-WORKFLOW2-TASK-FOR#clear_instances", groupTitle="\u6e05\u9664\u6d41\u7a0b\u5b9e\u4f8b\u7684-\u5f02\u6b65\u4efb\u52a1", subject="\u62a5\u8868")
public class ClearInstancesTaskExecutor
extends AbstractInstanceTaskExecutor<ProcessBatchRunPara> {
    public static final String TASK_NAME = "NR-WORKFLOW2-TASK-FOR#clear_instances";
    public static final String TASK_TITLE = "\u6e05\u9664\u6d41\u7a0b\u5b9e\u4f8b\u7684-\u5f02\u6b65\u4efb\u52a1";

    @Override
    protected void executeProcess(JobContext jobContext, ProcessBatchRunPara runParam, IProcessAsyncMonitor monitor) {
        ...
        IOperateResultSet operateResultSet = operateResultManager.getOperateResultSet(new EventOperateColumn(TASK_NAME, "\u6e05\u9664\u6d41\u7a0b\u5b9e\u4f8b"));
        instanceServiceHelper.getProcessInstanceService(runParam.getTaskKey()).clearInstances(runParam, bizKeyCollection, monitor, operateResultSet);
    }
