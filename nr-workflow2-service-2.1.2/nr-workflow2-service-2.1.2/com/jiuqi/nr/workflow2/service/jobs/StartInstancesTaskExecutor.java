...
@RealTimeJob(group="NR-WORKFLOW2-TASK-FOR#start_instances", groupTitle="\u542f\u52a8\u6d41\u7a0b\u5b9e\u4f8b\u7684-\u5f02\u6b65\u4efb\u52a1", subject="\u62a5\u8868")
public class StartInstancesTaskExecutor
extends AbstractInstanceTaskExecutor<ProcessBatchRunPara> {
    private static final long serialVersionUID = -2699789578239375377L;
    public static final String TASK_TITLE = "\u542f\u52a8\u6d41\u7a0b\u5b9e\u4f8b\u7684-\u5f02\u6b65\u4efb\u52a1";
    public static final String TASK_NAME = "NR-WORKFLOW2-TASK-FOR#start_instances";
    ...
    protected void executeProcess(JobContext jobContext, ProcessBatchRunPara runParam, IProcessAsyncMonitor monitor) throws JobExecutionException {
        ...
        IOperateResultSet operateResultSet = operateResultManager.getOperateResultSet(new EventOperateColumn(TASK_NAME, "\u542f\u52a8\u6d41\u7a0b\u5b9e\u4f8b"));
        instanceServiceHelper.getProcessInstanceService(runParam.getTaskKey()).startInstances(runParam, bizKeyCollection, monitor, operateResultSet);
    }
