...
public class BatchCompleteProcessTaskPosEvent
extends ApplicationEvent {
    private final IBusinessKeyCollection businessKeyCollection;
    private final IProcessExecutePara executePara;

    public BatchCompleteProcessTaskPosEvent(IProcessExecutePara executePara, IBusinessKeyCollection businessKeyCollection) {
        super("\u6d41\u7a0b\u6d41\u8f6c\u540e\u7f6e\u6d88\u606f\u4e8b\u4ef6");
