...
@Component
@RealTimeJob(group="ASYNCTASK_MIDSTORE_PULL", groupTitle="\u4e2d\u95f4\u5e93 ")
...
extends NpRealTimeTaskExecutor {
    ...
    public static final String ASYNCTASK_MIDSTORE_PULL = "ASYNCTASK_MIDSTORE_PULL";
    ...
    public void execute(JobContext jobContext) {
        ...
        RealTimeTaskMonitor asyncTaskMonitor = new RealTimeTaskMonitor(taskId, ASYNCTASK_MIDSTORE_PULL, jobContext);
        try {
            if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                ...
                midstoreService.midstorePull(midstoreInfo, (AsyncTaskMonitor)asyncTaskMonitor);
