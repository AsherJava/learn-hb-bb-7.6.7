...
@Service
public class FormDeployServiceImpl
extends AbstractResourceDeployService {
    ...
    public void deploy(ParamDeployContext context, String formSchemeKey) {
        LOGGER.info("\u62a5\u8868\u53c2\u6570\u53d1\u5e03\uff1a\u53d1\u5e03\u62a5\u8868\u65b9\u6848");
        context.getProgressConsumer().accept(this.getType(), "\u53d1\u5e03\u62a5\u8868\u65b9\u6848");
    ...
    public void rollback(ParamDeployContext context, String formSchemeKey) {
        LOGGER.info("\u62a5\u8868\u53c2\u6570\u53d1\u5e03\uff1a\u56de\u6eda\u62a5\u8868\u65b9\u6848");
        context.getProgressConsumer().accept(this.getType(), "\u56de\u6eda\u62a5\u8868\u65b9\u6848");
