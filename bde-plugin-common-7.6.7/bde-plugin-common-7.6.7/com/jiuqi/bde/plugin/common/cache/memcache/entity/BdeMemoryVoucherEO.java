...
@DBTable(name="BDE_VOUCHER", title="\u51ed\u8bc1\u4f59\u989d\u8868", primaryRequired=false, kind=TableModelKind.SYSTEM_EXTEND, ownerGroupID=@DBTableGroup(id="11000000-0000-0000-0000-000000000002", code="table_group_bde", title="BDE"), indexs={@DBIndex(name="IDX_BDE_VOUCHER_BIZKEY", type=DBIndex.TableIndexType.TABLE_INDEX_NORMAL, columnsFields={"BIZCOMBID", "SUBJECTCODE", "CURRENCYCODE"})}, convertToBudModel=true, modelType=ModelType.OTHER, dataSource="jiuqi.gcreport.mdd.datasource", sourceTable="")
public class BdeMemoryVoucherEO
extends DcDefaultTableEntity
implements ITableExtend {
    private static final long serialVersionUID = -7763762384260914488L;
    ...
    @DBColumn(nameInDB="BQNUM", title="\u672c\u671f\u53d1\u751f\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=10)
    private BigDecimal bqnum;
    @DBColumn(nameInDB="JL", title="\u501f\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=11)
    private BigDecimal jl;
    @DBColumn(nameInDB="DL", title="\u8d37\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=12)
    private BigDecimal dl;
    @DBColumn(nameInDB="LJNUM", title="\u7d2f\u8ba1\u53d1\u751f\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=13)
    ...
    @DBColumn(nameInDB="WBQNUM", title="\u5916\u5e01\u672c\u671f\u53d1\u751f\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=19)
    private BigDecimal wbqnum;
    @DBColumn(nameInDB="WJL", title="\u539f\u5e01\u501f\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=20)
    private BigDecimal wjl;
    @DBColumn(nameInDB="WDL", title="\u539f\u5e01\u8d37\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=21)
    private BigDecimal wdl;
    @DBColumn(nameInDB="WLJNUM", title="\u5916\u5e01\u7d2f\u8ba1\u53d1\u751f\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=22)
    private BigDecimal wljnum;
    @DBColumn(nameInDB="WYE", title="\u539f\u5e01\u4f59\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=23)
