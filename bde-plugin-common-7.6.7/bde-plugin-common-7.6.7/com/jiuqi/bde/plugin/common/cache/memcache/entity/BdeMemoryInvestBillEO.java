...
@DBTable(name="BDE_INVESTBILL", title="\u6295\u8d44\u53f0\u8d26\u6a21\u578b", primaryRequired=false, kind=TableModelKind.SYSTEM_EXTEND, ownerGroupID=@DBTableGroup(id="11000000-0000-0000-0000-000000000002", code="table_group_bde", title="BDE"), indexs={@DBIndex(name="IDX_BDE_INVESTBILL_BIZKEY", type=DBIndex.TableIndexType.TABLE_INDEX_NORMAL, columnsFields={"BIZCOMBID", "VCHRUNIQUECODE"})}, convertToBudModel=true, modelType=ModelType.OTHER, dataSource="jiuqi.gcreport.mdd.datasource", sourceTable="")
public class BdeMemoryInvestBillEO
extends DcDefaultTableEntity
implements ITableExtend {
    private static final long serialVersionUID = -3433153246453257239L;
    ...
    @DBColumn(nameInDB="CHANGEDATE", title="\u53d8\u52a8\u65f6\u671f", dbType=DBColumn.DBType.NVarchar, length=20, defaultValue="'#'", order=3)
    private String changeDate;
    @DBColumn(nameInDB="SUBJECTCODE", title="\u79d1\u76ee", dbType=DBColumn.DBType.NVarchar, length=60, defaultValue="'#'", order=4)
    private String subjectCode;
    @DBColumn(nameInDB="VCHRUNIQUECODE", title="\u51ed\u8bc1\u552f\u4e00\u6807\u8bc6", dbType=DBColumn.DBType.NVarchar, length=60, defaultValue="'#'", order=5)
    private String vchrUniqueCode;
    @DBColumn(nameInDB="CHANGESCENARIO", title="\u53d8\u52a8\u573a\u666f", dbType=DBColumn.DBType.NVarchar, length=60, defaultValue="'#'", order=6)
    private String changeScenario;
    @DBColumn(nameInDB="VCHRNUM", title="\u51ed\u8bc1\u53f7", dbType=DBColumn.DBType.NVarchar, length=60, defaultValue="'#'", order=6)
    private String vchrNum;
    @DBColumn(nameInDB="INVESTEDUNIT", title="\u88ab\u6295\u8d44\u5355\u4f4d", dbType=DBColumn.DBType.NVarchar, length=60, defaultValue="'#'", order=6)
    private String investedUnit;
    @DBColumn(nameInDB="CURRENCYCODE", title="\u5e01\u522b", dbType=DBColumn.DBType.NVarchar, length=60, defaultValue="'#'", order=7)
    private String currencyCode;
    @DBColumn(nameInDB="NC", title="\u5e74\u521d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=8)
    private BigDecimal nc;
    @DBColumn(nameInDB="C", title="\u671f\u521d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=9)
    private BigDecimal c;
    @DBColumn(nameInDB="JF", title="\u501f\u65b9", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=10)
    private BigDecimal jf;
    @DBColumn(nameInDB="DF", title="\u8d37\u65b9", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=11)
    private BigDecimal df;
    @DBColumn(nameInDB="JL", title="\u501f\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=12)
    private BigDecimal jl;
    @DBColumn(nameInDB="DL", title="\u8d37\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=13)
    private BigDecimal dl;
    @DBColumn(nameInDB="YE", title="\u4f59\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=14)
    private BigDecimal ye;
    @DBColumn(nameInDB="WNC", title="\u539f\u5e01\u5e74\u521d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=15)
    private BigDecimal wnc;
    @DBColumn(nameInDB="WC", title="\u539f\u5e01\u671f\u521d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=16)
    private BigDecimal wc;
    @DBColumn(nameInDB="WJF", title="\u539f\u5e01\u501f\u65b9", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=17)
    private BigDecimal wjf;
    @DBColumn(nameInDB="WDF", title="\u539f\u5e01\u8d37\u65b9", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=18)
    private BigDecimal wdf;
    @DBColumn(nameInDB="WJL", title="\u539f\u5e01\u501f\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=19)
    private BigDecimal wjl;
    @DBColumn(nameInDB="WDL", title="\u539f\u5e01\u8d37\u7d2f", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=20)
    private BigDecimal wdl;
    @DBColumn(nameInDB="WYE", title="\u539f\u5e01\u4f59\u989d", dbType=DBColumn.DBType.Numeric, precision=19, scale=2, isRequired=true, defaultValue="0.00", order=21)
