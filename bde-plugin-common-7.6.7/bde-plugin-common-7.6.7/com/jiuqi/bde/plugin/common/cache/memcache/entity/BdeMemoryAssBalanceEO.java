...
@DBTable(name="BDE_ASSBALANCE", title="\u5168\u7ef4\u5ea6\u4f59\u989d\u8868", primaryRequired=false, kind=TableModelKind.SYSTEM_EXTEND, ownerGroupID=@DBTableGroup(id="11000000-0000-0000-0000-000000000002", code="table_group_bde", title="BDE"), indexs={@DBIndex(name="IDX_BDE_ASSBALANCE_BIZKEY", type=DBIndex.TableIndexType.TABLE_INDEX_NORMAL, columnsFields={"BIZCOMBID", "SUBJECTCODE", "CURRENCYCODE"})}, convertToBudModel=true, modelType=ModelType.OTHER, dataSource="jiuqi.gcreport.mdd.datasource", sourceTable="")
public class BdeMemoryAssBalanceEO
extends DcDefaultTableEntity
implements ITableExtend {
    private static final long serialVersionUID = -1440110059963173666L;
    @Autowired
    AssistExtendDimService assistExtendDimService;
    ...
    public String getTableName() {
        return "BDE_ASSBALANCE";
    }

    public AssistExtendDimService getAssistExtendDimService() {
        return this.assistExtendDimService;
    }

    public void setAssistExtendDimService(AssistExtendDimService assistExtendDimService) {
        this.assistExtendDimService = assistExtendDimService;
    }
