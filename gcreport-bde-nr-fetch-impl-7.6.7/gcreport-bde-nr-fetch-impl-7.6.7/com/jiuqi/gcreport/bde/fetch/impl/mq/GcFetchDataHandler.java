...
@Component
public class GcFetchDataHandler
implements ITaskHandler {
    ...
    private Logger logger = LoggerFactory.getLogger(GcFetchDataHandler.class);

    public String getName() {
        return FetchTaskType.NR_FETCH.getCode();
    }

    public String getTitle() {
        return FetchTaskType.NR_FETCH.getTitle();
    }
