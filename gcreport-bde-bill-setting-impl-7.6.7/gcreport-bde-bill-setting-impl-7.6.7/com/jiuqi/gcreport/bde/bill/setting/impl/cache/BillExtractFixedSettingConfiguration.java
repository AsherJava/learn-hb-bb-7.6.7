...
@Component
public class BillExtractFixedSettingConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_BILL_EXTRACT_FIED_SETTING_MANAGE";
    public static final String CACHE_NAME = "BDE_BILL_EXTRACT_FIED_SETTING_SCHEME";
