...
@Component
public class BillExtractFloatSettingConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_BILL_EXTRACT_FLOAT_SETTING_MANAGE";
    public static final String CACHE_NAME = "BDE_BILL_EXTRACT_FLOAT_SETTING_SCHEME";
