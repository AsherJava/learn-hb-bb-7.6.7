...
@Component
public class BillExtractDefineCacheConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BDE_BILL_EXTRACT_DEFINE_MANAGE";
    public static final String CACHE_NAME = "BDE_BILL_EXTRACT_DEFINE";
