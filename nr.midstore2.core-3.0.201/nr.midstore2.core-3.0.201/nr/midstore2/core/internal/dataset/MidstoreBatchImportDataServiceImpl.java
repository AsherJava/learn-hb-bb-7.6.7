...
import nr.midstore2.core.internal.dataset.MidstoreDataSet;
import nr.midstore2.core.internal.dataset.tz.MidstoreSBDataSet;
...
implements IMidstoreBatchImportDataService {
    ...
    public IMidstoreDataSet getBatchExportRegionDataSet(MidsotreTableContext tableContext, String TaskKey, String tableKey) {
        ...
        regionData.setType(dataTable.getDataTableType().getValue());
        AbstractMidstoreDataSet regionDataSet = null;
        regionDataSet = dataTable != null && dataTable.getDataTableType() == DataTableType.ACCOUNT ? new MidstoreSBDataSet(tableContext, regionData) : new MidstoreDataSet(tableContext, regionData);
        return regionDataSet;
    }
