 ...
 *  com.jiuqi.dc.datamapping.impl.service.impl.automatch.AbstractRefServiceImpl
...
@Service
public class CustomCodeRefServiceImpl
extends AbstractRefServiceImpl {
    private static final String CODE = "CUSTOM_CODE";
    private static final String NAME = "\u81ea\u5b9a\u4e49\u4ee3\u7801";
    ...
    public List<DataRefDTO> autoMatch(BaseDataMappingDefineDTO define, List<DataRefDTO> unRefData, List<Map<String, Object>> baseDataList, DataRefAutoMatchDTO dto) {
        ...
        String lowerMatchDim = "CODE".toLowerCase();
