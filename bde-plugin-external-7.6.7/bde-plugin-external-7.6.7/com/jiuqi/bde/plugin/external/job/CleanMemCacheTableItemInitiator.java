...
import com.jiuqi.bde.plugin.external.job.CleanMemCacheTableJob;
...
@Component
public class CleanMemCacheTableItemInitiator
implements IBdeModuleItemInitiator {
    private static Logger logger = LoggerFactory.getLogger(CleanMemCacheTableItemInitiator.class);
    ...
    private void registerJob() throws Exception {
        ...
        try {
            JobModel jobModel = new JobStorageManager().getJob("com.jiuqi.bde.memcache.clean");
            if (jobModel != null) {
                CleanMemCacheTableJob job = new CleanMemCacheTableJob();
                SysJobManager.getInstance().register((AbstractSysJob)job, null);
                logger.info("\u521d\u59cb\u6e05\u7406\u70ed\u70b9\u6570\u636e\u8ba1\u5212\u4efb\u52a1\u5df2\u7ecf\u5b58\u5728\uff0c\u8df3\u8fc7\u6ce8\u518c");
                return;
            }
        }
        catch (JobsException e) {
            logger.info(String.format("\u521d\u59cb\u6e05\u7406\u70ed\u70b9\u6570\u636e\u8ba1\u5212\u4efb\u52a1%1$s\uff0c\u8df3\u8fc7\u6ce8\u518c", e.getMessage()));
            return;
        }
        CleanMemCacheTableJob job = new CleanMemCacheTableJob();
        SysJobManager.getInstance().register((AbstractSysJob)job, null);
        jobManager.jobEnable("com.jiuqi.bde.memcache.clean", true);
        ...
        jobManager.updateJobScheduleConf("com.jiuqi.bde.memcache.clean", 0L, endTime, (IScheduleMethod)scheduleMethod);
    }
