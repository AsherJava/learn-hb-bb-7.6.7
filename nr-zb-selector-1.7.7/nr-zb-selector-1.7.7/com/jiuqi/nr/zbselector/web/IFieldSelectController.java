...
@RestController
@RequestMapping(value={"/zb-selector"})
public class IFieldSelectController {
    ...
    @Autowired
    private IZBSelectorService zbSelectorService;

    @RequiresPermissions(value={"nr:zbselector:griddata"})
    @RequestMapping(value={"/fieldselect-griddata"}, method={RequestMethod.POST})
    public String getFormData(@RequestBody FieldSelectFormFilter fieldSelectFormFilter) {
        try {
            ...
            FieldSelectFormData formData = helper.getFormData(fieldSelectFormFilter);
            ...
            LogHelper.info((String)LogModuleEnum.NRQUERY.getTitle(), (String)"\u67e5\u8be2\u6307\u6807\u6570\u636e", (String)("\u67e5\u8be2\u6210\u529f\uff0c\u8868\u5355id:" + fieldSelectFormFilter.getFormKey() + "\uff0c\u65b9\u6848id\uff1a" + fieldSelectFormFilter.getSchemeKey()));
            return fromDataStr;
        }
        catch (Exception ex) {
            logger.error(ex.getMessage(), ex);
            LogHelper.info((String)LogModuleEnum.NRQUERY.getTitle(), (String)"\u67e5\u8be2\u6307\u6807\u6570\u636e\u5f02\u5e38", (String)("\u5f02\u5e38\u539f\u56e0\uff1a" + ex));
            LogHelper.info((String)LogModuleEnum.NRQUERY.getTitle(), (String)"\u67e5\u8be2\u6307\u6807\u6570\u636e", (String)("\u67e5\u8be2\u5931\u8d25\uff0c\u8868\u5355id:" + fieldSelectFormFilter.getFormKey() + "\uff0c\u65b9\u6848id\uff1a" + fieldSelectFormFilter.getSchemeKey()));
            return null;
        }
    }

    @PostMapping(value={"/fieldselect-getallfields"})
    public List<FieldSelectLinksData> getAllFields(@RequestBody FieldSelectFormFilter fieldSelectFormFilter) {
        ...
        return fieldHelper.getAllFields(this.fieldSelectExtend, fieldSelectFormFilter);
    }
    ...
    @RequestMapping(value={"/fieldselect-gotPeriodObjByTask"}, method={RequestMethod.GET})
    public String getPeriodObjByTask(String taskKey, String period) {
        return this.zbSelectorService.getPeriodObjByTask(taskKey, period);
    }

    @RequestMapping(value={"/fieldselect-gottasktrees"}, method={RequestMethod.GET})
    public List<ITree<TaskTreeNode>> getAllTaskTrees(String[] taskTypes, boolean complete) {
        return this.zbSelectorService.getRootTaskTreeNodes(complete);
    }

    @GetMapping(value={"/fieldselect-getTaskLinksByFormScheme"})
    public List<TaskLinkImpl> getTaskLinksByFormScheme(String formSchemeKey) {
        return this.zbSelectorService.getTaskLinksByFormScheme(formSchemeKey);
    }
