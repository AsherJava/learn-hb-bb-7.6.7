...
public enum FinancialCubesPeriodTypeEnum {
    Y("Y", "\u6708\u5ea6"),
    J("J", "\u5b63\u5ea6"),
    H("H", "\u534a\u5e74"),
    N("N", "\u5e74\u5ea6");
    ...
    private FinancialCubesPeriodTypeEnum(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static FinancialCubesPeriodTypeEnum getByCode(String code) {
