...
public enum FinancialCubesAuditTrailEnum {
    SINGLE("1", "\u5355\u6237"),
    ACCOUNTING("11", "\u8d22\u52a1"),
    ...
    private FinancialCubesAuditTrailEnum(String code, String name) {
        this.code = code;
        this.name = name;
    }

    public static FinancialCubesAuditTrailEnum getEnumByCode(String code) {
        for (FinancialCubesAuditTrailEnum auditTrailEnum : FinancialCubesAuditTrailEnum.values()) {
