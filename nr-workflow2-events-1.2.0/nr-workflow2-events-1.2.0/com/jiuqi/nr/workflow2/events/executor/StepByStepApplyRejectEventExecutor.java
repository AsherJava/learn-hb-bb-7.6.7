...
public class StepByStepApplyRejectEventExecutor
extends StepByStepRejectEventExecutor {
    public StepByStepApplyRejectEventExecutor(JSONObject eventJsonConfig, EventDependentServiceHelper helper) {
