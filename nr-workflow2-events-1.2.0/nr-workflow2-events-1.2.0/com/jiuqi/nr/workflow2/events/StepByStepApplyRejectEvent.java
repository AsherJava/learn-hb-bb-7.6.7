...
import com.jiuqi.nr.workflow2.events.executor.StepByStepApplyRejectEventExecutor;
import org.json.JSONObject;

public class StepByStepApplyRejectEvent
extends ActionEventRegisteration {
    public static final String ID = "step-by-step-applyreject-event";
    public static final String TITLE = "\u7533\u8bf7\u9000\u56de\uff0c\u5c42\u5c42\u68c0\u67e5\u4e8b\u4ef6";

    public StepByStepApplyRejectEvent() {
        super(ID, TITLE);
    }
    ...
    public IActionEventExecutorFactory getExecutorFactory() {
        return new IActionEventExecutorFactory(){
            ...
            public String getActionEventDefinitionId() {
                return StepByStepApplyRejectEvent.ID;
            }
            ...
            public IActionEventExecutor createActionEventExecutor(String parameter) {
                ...
                return new StepByStepApplyRejectEventExecutor(eventJsonConfig, helper);
            }
        };
    }
}
