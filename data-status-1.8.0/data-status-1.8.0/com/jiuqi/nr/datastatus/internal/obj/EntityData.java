...
public class EntityData {
    ...
    public EntityData(IEntityDefine entityDefine) {
        ...
        this.kind = EntityKind.NORMAL_ENTITY_KIND.getKind();
    ...
    public EntityData(IPeriodEntity periodEntity) {
        ...
        this.kind = EntityKind.PERIOD_ENTITY_KIND.getKind();
    }
    ...
    public String getKey() {
        if (EntityKind.NORMAL_ENTITY_KIND.getKind().equals(this.kind)) {
            return this.entityDefine.getId();
        }
        if (EntityKind.ADJUST_ENTITY_KIND.getKind().equals(this.kind)) {
            return "ADJUST";
        }
