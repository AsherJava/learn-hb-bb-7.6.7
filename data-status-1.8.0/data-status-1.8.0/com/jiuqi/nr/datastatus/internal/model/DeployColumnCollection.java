...
public class DeployColumnCollection {
    ...
    public void appendCreCol(DesignColumnModelDefine column) {
        this.createColumnList.add(column);
    }

    public void appendModCol(DesignColumnModelDefine column) {
        this.modifyColumnList.add(column);
    }

    public boolean needCre() {
        return this.createColumnList.size() > 0;
    }

    public boolean needMod() {
        return this.modifyColumnList.size() > 0;
    }

    public boolean needDel() {
        return this.deleteColumnList.size() > 0;
    }
