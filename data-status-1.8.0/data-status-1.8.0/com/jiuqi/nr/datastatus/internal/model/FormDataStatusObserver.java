...
public class FormDataStatusObserver
implements Observer,
...
IParamDeployFinishListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FormDataStatusObserver.class);
    ...
    public String getName() {
        return "\u62a5\u8868\u6570\u636e\u72b6\u6001\u8868" + this.getClass().getName();
    }
    ...
    public void onDelete(FormSchemeDefine define, Consumer<String> warningConsumer, Consumer<String> progressConsumer) {
        progressConsumer.accept("\u6b63\u5728\u5220\u9664\u62a5\u8868\u6570\u636e\u72b6\u6001\u8868");
        if (define == null) {
            return;
        }
    ...
    public void onUpdate(FormSchemeDefine define, Consumer<String> warningConsumer, Consumer<String> progressConsumer) {
        progressConsumer.accept("\u6b63\u5728\u53d1\u5e03\u62a5\u8868\u6570\u636e\u72b6\u6001\u8868");
        if (define == null) {
            return;
        }
        ...
        try {
            ...
            warningConsumer.accept("\u62a5\u8868\u6570\u636e\u72b6\u6001\u8868\u53d1\u5e03\u5f02\u5e38\uff1a" + e.getMessage());
        }
    }
}
