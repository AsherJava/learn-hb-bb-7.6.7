...
public class FixedTableRuleJsonStringEO2VOHelper {
    private String jsonStr;
    private String reportSystemId;

    private FixedTableRuleJsonStringEO2VOHelper() {
    }

    public static FixedTableRuleJsonStringEO2VOHelper newInstance(String jsonStr, String reportSystemId) {
        FixedTableRuleJsonStringEO2VOHelper helper = new FixedTableRuleJsonStringEO2VOHelper();
    ...
    private Map<String, Object> handleOneDetailedSetting(Map<String, Object> detailedSetting) {
        String oldUnitCode = (String)JsonUtils.readValue((String)JsonUtils.writeValueAsString((Object)detailedSetting.get("unit")), String.class);
        GcOrgBaseTool orgTool = GcOrgBaseTool.getInstance();
        OrgToJsonVO orgToJson = orgTool.getOrgByCode(oldUnitCode);
        detailedSetting.put("unit", orgToJson);
