...
import com.jiuqi.gcreport.calculate.rule.fixedTable.datatracer.FixedRuleTraceProcessor;
...
@Component
public class FixedRuleTracer
implements UnionRuleTracer {
    public static final String RULE_TYPE_NAME = "FIXED_TABLE";
    ...
    public UnionRuleTraceProcessor newProcessorInstance(GcOffSetVchrItemAdjustEO offsetItem, AbstractUnionRule rule, GcTaskBaseArguments taskArg) {
        return FixedRuleTraceProcessor.newInstance(offsetItem, rule, taskArg);
    }
}
