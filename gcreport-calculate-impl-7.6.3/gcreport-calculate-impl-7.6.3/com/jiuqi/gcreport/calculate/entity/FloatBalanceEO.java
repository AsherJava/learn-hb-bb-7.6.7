...
@DBTable(name="GC_FLOATBALANCE", title="\u6d6e\u52a8\u4f59\u989d\u8868", stopSuper=DefaultTableEntity.class, indexs={@DBIndex(name="IDX_GC_FLOATBALANCE_BIZKEYORDER", columnsFields={"BIZKEYORDER"}, type=DBIndex.TableIndexType.TABLE_INDEX_UNIQUE)})
public class FloatBalanceEO
extends DefaultTableEntity {
    private static final long serialVersionUID = -2066568805187193906L;
    public static final String TABLENAME = "GC_FLOATBALANCE";
    ...
    @DBColumn(nameInDB="OPPUNITCODE", title="\u5bf9\u65b9\u5355\u4f4d", dbType=DBColumn.DBType.NVarchar, length=50, refTabField="MD_ORG_CORPORATE.CODE")
    private String oppUnitCode;
    @DBColumn(nameInDB="ACCTORGCODE", title="\u8bb0\u8d26\u5355\u4f4d", dbType=DBColumn.DBType.NVarchar, length=50, refTabField="MD_ORG_CORPORATE.CODE")
    private String acctOrgCode;
    @DBColumn(nameInDB="DATATIME", title="\u9ed8\u8ba4\u65f6\u671f\u4e3b\u4f53", dbType=DBColumn.DBType.NVarchar, length=9, isRequired=true, refTabField="DEFAULT_PERIOD.SQ_CODE")
