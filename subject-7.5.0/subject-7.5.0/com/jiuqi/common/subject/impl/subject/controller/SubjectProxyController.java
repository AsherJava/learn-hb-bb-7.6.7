...
@RestController
public class SubjectProxyController {
    final String API_BASE_PATH = "/api/datacenter/v1/base/subject";
    @Autowired
    private SubjectService service;

    @PostMapping(value={"/api/datacenter/v1/base/subject/sync_cache"})
    public BusinessResponseEntity<Boolean> syncCache() {
        return BusinessResponseEntity.ok((Object)this.service.syncCache());
    }

    @PostMapping(value={"/api/datacenter/v1/base/subject/define"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/list"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/tree"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/treeByCodes"})
    ...
    @GetMapping(value={"/api/datacenter/v1/base/subject/get/{id}"})
    ...
    @GetMapping(value={"/api/datacenter/v1/base/subject/get_by_code/{code}"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/create"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/modify"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/delete"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/stop"})
    ...
    @PostMapping(value={"/api/datacenter/v1/base/subject/start"})
    ...
    @GetMapping(value={"/api/datacenter/v1/base/subject/gatAllPublishedDim"})
