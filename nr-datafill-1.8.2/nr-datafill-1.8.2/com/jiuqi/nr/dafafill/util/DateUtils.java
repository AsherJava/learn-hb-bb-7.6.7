...
public class DateUtils {
    ...
    public static final String YEAR_MONTH_DAY_4 = "yyyy\u5e74MM\u6708dd\u65e5";
    public static final String YEAR_MONTH_DAY_5 = "yyyy\u5e74M\u6708dd\u65e5";
    public static final String YEAR_MONTH_DAY_6 = "yyyy\u5e74MM\u6708d\u65e5";
    public static final String YEAR_MONTH_DAY_7 = "yyyy\u5e74M\u6708d\u65e5";
    public static final String YEAR_MONTH_DAY_8 = "yyyy/MM/dd";
    public static final String YEAR_MONTH_DAY_9 = "yyyy/M/dd";
    public static final String YEAR_MONTH_DAY_10 = "yyyy/MM/d";
    public static final String YEAR_MONTH_DAY_11 = "yyyy/M/d";
    public static final String YEAR_MONTH_DAY_12 = "yyyyMMdd";
    ...
    private static final DateTimeFormatter formatter_4 = DateTimeFormatter.ofPattern("yyyy\u5e74MM\u6708dd\u65e5");
    private static final DateTimeFormatter formatter_5 = DateTimeFormatter.ofPattern("yyyy\u5e74M\u6708dd\u65e5");
    private static final DateTimeFormatter formatter_6 = DateTimeFormatter.ofPattern("yyyy\u5e74MM\u6708d\u65e5");
    private static final DateTimeFormatter formatter_7 = DateTimeFormatter.ofPattern("yyyy\u5e74M\u6708d\u65e5");
    private static final DateTimeFormatter formatter_8 = DateTimeFormatter.ofPattern("yyyy/MM/dd");
    private static final DateTimeFormatter formatter_9 = DateTimeFormatter.ofPattern("yyyy/M/dd");
    private static final DateTimeFormatter formatter_10 = DateTimeFormatter.ofPattern("yyyy/MM/d");
    private static final DateTimeFormatter formatter_11 = DateTimeFormatter.ofPattern("yyyy/M/d");
    private static final DateTimeFormatter formatter_12 = DateTimeFormatter.ofPattern("yyyyMMdd");
    ...
    public static Date stringToDate(String dateStr) {
        ...
        String[] splits;
        DateTimeFormatter temp = null;
        temp = dateStr.contains("-") ? ((splits = dateStr.split("-"))[1].length() == 1 && splits[2].length() == 2 ? formatter_1 : (splits[1].length() == 2 && splits[2].length() == 1 ? formatter_2 : (splits[1].length() == 1 && splits[2].length() == 1 ? formatter_3 : formatter))) : (dateStr.contains("\u5e74") ? ((splits2 = (splits = dateStr.split("\u5e74"))[1].split("\u6708"))[0].length() == 1 && splits2[1].length() == 3 ? formatter_5 : (splits2[0].length() == 2 && splits2[1].length() == 2 ? formatter_6 : (splits2[0].length() == 1 && splits2[1].length() == 2 ? formatter_7 : formatter_4))) : (dateStr.contains("/") ? ((splits = dateStr.split("/"))[1].length() == 1 && splits[2].length() == 2 ? formatter_9 : (splits[1].length() == 2 && splits[2].length() == 1 ? formatter_10 : (splits[1].length() == 1 && splits[2].length() == 1 ? formatter_11 : formatter_8))) : formatter_12));
