...
@Component
public class UnitCodeIsolateCacheProvider
implements FieldMappingBizDataCacheProvider {
    ...
    public static final String CACHE_KEY = "UnitCodeFieldMapping";
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Override
    public IsolationStrategy getIsolateType() {
        return IsolationStrategy.UNITCODE;
    }
    ...
    public Map<Object, Map<String, DataRefMappingCacheDTO>> getRefDataMap(String schemeCode, String dimCode) {
        List<DataRefDTO> dataRefDTOS = this.isolateFieldMappingDao.loadIsolateAllMapping(IsolationStrategy.UNITCODE, schemeCode, dimCode);
