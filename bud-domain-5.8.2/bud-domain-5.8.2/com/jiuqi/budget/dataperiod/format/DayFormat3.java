...
@Component(value="budDayFormat3")
public class DayFormat3
extends BaseDataPeriodFormat {
    ...
    public String format(Locale locale, DataPeriod dataPeriod) {
        ...
        if (Locale.CHINA.equals(locale)) {
            return startDay.getYear() + "\u5e74" + startDay.getMonthValue() + "\u6708" + startDay.getDayOfMonth() + "\u65e5";
        }
        return startDay.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT));
    }
