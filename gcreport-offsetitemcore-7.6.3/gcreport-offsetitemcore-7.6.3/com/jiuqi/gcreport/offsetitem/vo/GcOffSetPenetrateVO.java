...
public class GcOffSetPenetrateVO {
    private String id;
    ...
    private List<GcPenetrateDetailVO> penetrateDetail;
    ...
    public List<GcPenetrateDetailVO> getPenetrateDetail() {
        if (null == this.penetrateDetail) {
            return new ArrayList<GcPenetrateDetailVO>();
        }
        return this.penetrateDetail;
    }

    public void setPenetrateDetail(List<GcPenetrateDetailVO> penetrateDetail) {
        this.penetrateDetail = penetrateDetail;
    }
}
