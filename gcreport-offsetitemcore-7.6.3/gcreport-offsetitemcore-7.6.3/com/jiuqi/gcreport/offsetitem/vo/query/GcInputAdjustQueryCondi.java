...
public class GcInputAdjustQueryCondi {
    ...
    public int pageSize;
    public int pageNum;
    public List<String> mRecidList;

    public List<String> getmRecidList() {
        return this.mRecidList;
    }

    public void setmRecidList(List<String> mRecidList) {
        this.mRecidList = mRecidList;
    }
