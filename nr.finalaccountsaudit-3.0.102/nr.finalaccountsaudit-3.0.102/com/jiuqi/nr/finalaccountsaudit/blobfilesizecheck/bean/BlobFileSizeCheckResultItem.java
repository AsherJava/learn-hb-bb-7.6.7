...
public class BlobFileSizeCheckResultItem
implements Serializable {
    ...
    private List<BlobFileSizeCheckFieldResultItem> fieldItems = new ArrayList<BlobFileSizeCheckFieldResultItem>();
    ...
    public List<BlobFileSizeCheckFieldResultItem> getFieldItems() {
        return this.fieldItems;
    }

    public void setFieldItems(List<BlobFileSizeCheckFieldResultItem> fieldItems) {
        this.fieldItems = fieldItems;
    }

    public void addFieldItem(BlobFileSizeCheckFieldResultItem fieldItem) {
