...
implements FieldDefine {
    ...
    public EngineFieldDefine(ColumnModelDefine columnModelDefine) {
    ...
    public FieldType getType() {
        ColumnModelType columnType = this.columnModelDefine.getColumnType();
        if (columnType != null) {
            return DefinitionTransUtils.valueOf((ColumnModelType)columnType);
        }
        return null;
    }
