...
implements IStatistic {
    private static final long serialVersionUID = -185883391000534285L;
    ...
    public StatUnit createStatUnit(IContext paramIContext, List<IASTNode> paramList) throws SyntaxException {
        return StatItem.createStatUnit((int)5, (int)paramList.get(0).getType(paramIContext));
    }
}
