...
@Component
public class AfterCreaterBackWriteType
implements VaBillBackWriteTypeIntf {
    @Override
    public String getType() {
        return VaBackWriteEnum.AFTER_CREATER_BACK.getName();
    }

    @Override
    public String getTitle() {
        return VaBackWriteEnum.AFTER_CREATER_BACK.getTitle();
    }
    ...
    public boolean needExecute(BillModel model) {
        ...
        if (ObjectUtils.isEmpty(actionName) || !actionName.toString().equals("bill-retract")) {
            return false;
        }
        ...
        return oldbillstate == BillState.COMMITTED.getValue() && (billstate == BillState.SAVED.getValue() || billstate == BillState.SENDBACK.getValue());
    }
}
