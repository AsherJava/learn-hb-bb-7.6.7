...
public class ColumnInfo {
    ...
    public ColumnInfo(String code, String name, ColumnModelType type, int size, String referFieldID, boolean isKeyField, String defaultValue) {
        this.code = code;
        this.name = name;
        this.type = type;
        this.size = size;
    ...
    public ColumnInfo(String code, String name, ColumnModelType type, int size, String referFieldID, boolean isKeyField) {
        this(code, name, type, size, referFieldID, isKeyField, "");
    }
    ...
    public ColumnInfo(String code, String name, ColumnModelType type, int size) {
        this(code, name, type, size, "", false, "");
    }
