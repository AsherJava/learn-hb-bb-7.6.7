...
import com.jiuqi.nr.data.access.param.UnitAccessCache;
import com.jiuqi.nr.dataservice.core.dimension.DimensionCombination;
import java.util.Map;
import java.util.Objects;
import java.util.Optional;

public class UnitBatchAccessCache
extends UnitAccessCache
implements IBatchAccess {
    ...
    public UnitBatchAccessCache(String name, String formSchemeKey) {
        this.name = name;
    ...
    public AccessCode getAccessCode(DimensionCombination masterKey, String formKey) {
        ...
        Map<DimensionValueSet, String> cacheMap = this.getCacheMap();
        if (cacheMap.isEmpty()) {
            return accessCode;
        }
        Optional<String> optCode = this.matchCacheValue(findKey);
        if (!optCode.isPresent()) {
            return accessCode;
        }
        accessCode.setCode(optCode.get());
        return accessCode;
    }
