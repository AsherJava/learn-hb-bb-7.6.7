...
@Service
public class FormLockDelTableDataService
implements IDelTableDataService {
    ...
    public void clearTableData(String dataSchemeKey) {
        ...
        this.clearFormLockTable(dataScheme);
        this.clearFormLockHistoryTable(dataScheme);
    }

    private void clearFormLockTable(DataSchemeDTO dataScheme) {
    ...
    private void clearFormLockHistoryTable(DataSchemeDTO dataScheme) {
