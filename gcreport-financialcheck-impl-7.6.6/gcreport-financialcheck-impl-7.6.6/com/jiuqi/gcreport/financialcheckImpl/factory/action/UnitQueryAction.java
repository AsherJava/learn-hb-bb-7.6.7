...
implements GcFinancialCheckAction {
    ...
    public Object execute(Object param) {
        ...
        String showLocation = financialCheckQueryConditionVO.getShowLocation();
        ...
        if ("unitUncheck".equals(showLocation)) {
            return financialCheckService.queryUncheckedGroupByUnit(financialCheckQueryConditionVO);
        }
        return financialCheckService.queryUncheckedGroupByOppUnit(financialCheckQueryConditionVO);
    }
