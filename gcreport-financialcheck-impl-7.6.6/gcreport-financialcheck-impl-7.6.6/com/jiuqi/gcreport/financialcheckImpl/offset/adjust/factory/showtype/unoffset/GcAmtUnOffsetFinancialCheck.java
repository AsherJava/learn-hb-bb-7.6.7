 ...
 */
package com.jiuqi.gcreport.financialcheckImpl.offset.adjust.factory.showtype.unoffset;

import com.jiuqi.gcreport.financialcheckImpl.offset.adjust.factory.action.manual.QueryUnOffsetFinancialCheck;
import com.jiuqi.gcreport.financialcheckImpl.offset.adjust.factory.action.query.unoffset.AmtQueryFinancialCheckAction;
...
@Component
public class GcAmtUnOffsetFinancialCheck
implements GcOffsetItemShowType {
    @Autowired
    private AmtQueryFinancialCheckAction amtQueryConnectDealAction;
    @Autowired
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.amtQueryConnectDealAction);
