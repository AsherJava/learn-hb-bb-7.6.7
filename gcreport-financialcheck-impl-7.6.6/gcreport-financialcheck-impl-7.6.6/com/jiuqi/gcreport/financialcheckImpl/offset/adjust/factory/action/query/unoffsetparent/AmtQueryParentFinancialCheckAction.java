 ...
 */
package com.jiuqi.gcreport.financialcheckImpl.offset.adjust.factory.action.query.unoffsetparent;
...
@Component
public class AmtQueryParentFinancialCheckAction
implements GcOffSetItemAction {
    ...
    public Object execute(GcOffsetExecutorVO gcOffsetExecutorVO) {
        ...
        Pagination<Map<String, Object>> pagination = this.financialCheckOffsetService.listFinancialCheckOffset(queryParamsVO, true);
