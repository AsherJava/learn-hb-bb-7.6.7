 ...
 */
package com.jiuqi.gcreport.financialcheckImpl.offset.adjust.factory.showtype.unoffsetParent;

import com.jiuqi.gcreport.financialcheckImpl.offset.adjust.factory.action.query.unoffsetparent.AmtQueryParentFinancialCheckAction;
...
@Component
public class GcAmtUnOffsetParentFinancialCheck
implements GcOffsetItemShowType {
    @Autowired
    private AmtQueryParentFinancialCheckAction amtQueryParentFinancialCheckAction;
    ...
    public List<GcOffSetItemAction> actions() {
        ...
        list.add(this.amtQueryParentFinancialCheckAction);
        return list;
    }
}
