...
public class FcDownDataSqlBuilderHelper
extends FcBaseSqlBuilderHelper {
    ...
    private void buildLevelSql(FinancialCheckQueryConditionDTO condition, StringBuilder sql, String orgType) {
        ...
        sql.append(" and ").append("bfdw.gcparents like '").append(localUnit.getGcParentStr()).append("_%' and ").append("dfdw.gcparents like '").append(localUnit.getGcParentStr()).append("_%' and substr(").append("bfdw.gcparents, 1,").append(length + codeLength + 1).append(") = substr(").append("dfdw.gcparents, 1,").append(length + codeLength + 1).append(") ");
    }
