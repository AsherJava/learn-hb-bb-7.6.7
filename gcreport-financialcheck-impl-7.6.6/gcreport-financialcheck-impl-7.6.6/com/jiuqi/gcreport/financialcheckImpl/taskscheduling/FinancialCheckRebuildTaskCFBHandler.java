...
import com.jiuqi.gcreport.financialcheckImpl.dataentry.service.impl.GcBalanceCheckCFDataRebuildServiceImpl;
...
@Component
public class FinancialCheckRebuildTaskCFBHandler
extends FinancialCheckBaseTaskHandler {
    ...
    @Autowired
    private GcBalanceCheckCFDataRebuildServiceImpl gcBalanceCheckDataRebuildService;

    public String getName() {
        return "FinancialCheckRebuildTaskCFBHandler";
    }

    public String getTitle() {
        return "\u5bf9\u8d26\u4e2d\u5fc3\u73b0\u6d41\u5e95\u7a3f\u6570\u636e\u91cd\u7b97\u4efb\u52a1";
    }
    ...
    public TaskHandleResult handleTask(String param, ITaskProgressMonitor monitor) {
        ...
        this.taskService.updateBeginHandle("FinancialCheckDataCollectionTaskHandlerCFB", rebuildDTO.getUnitCode() + "|" + rebuildDTO.getDataTime(), new Date());
