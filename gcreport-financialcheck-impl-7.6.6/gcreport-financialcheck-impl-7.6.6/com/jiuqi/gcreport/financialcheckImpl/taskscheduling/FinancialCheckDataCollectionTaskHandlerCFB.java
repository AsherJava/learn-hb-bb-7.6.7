...
@Component
public class FinancialCheckDataCollectionTaskHandlerCFB
extends FinancialCheckBaseTaskHandler {
    public static final String CF_COLLECTION_TASK_NAME = "FinancialCheckDataCollectionTaskHandlerCFB";
    @Autowired
    private TaskManageService taskService;
    @Autowired
    GcBalanceCheckCFDataCollectionServiceImpl dataCollectionService;
    @Autowired
    private UserInfoUtil userInfoUtil;

    public String getName() {
        return CF_COLLECTION_TASK_NAME;
    }

    public String getTitle() {
        return "\u5bf9\u8d26\u4e2d\u5fc3\u6570\u636e\u91c7\u96c6\u4efb\u52a1-\u4f59\u989d\u5bf9\u8d26\u6a21\u5f0f-\u73b0\u6d41\u5de5\u4f5c\u5e95\u7a3f";
    }

    public String getPreTask() {
        return "FinancialCubesCfCalcHandler;FinancialCubesAdjustCfCalcHandler";
    }
