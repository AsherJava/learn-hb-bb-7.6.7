...
implements Condition {
    private static final Logger logger = LoggerFactory.getLogger(ConditionGroupCheck.class);
    private final String relationName;
    private final List<ConditionRowCheck> conditionRows;

    public ConditionGroupCheck(String relationName, List<ConditionRowCheck> conditionRows) {
    ...
    public boolean check(Map<String, Object> data) {
        ...
        if (relation == null) {
            logger.error("\u6d41\u8f6c\u7ebf\u516c\u5f0f\u4e0d\u652f\u6301\u5173\u7cfb\u64cd\u4f5c\u7b26\uff1a{}", (Object)this.relationName);
            throw new WorkflowException(VaWorkFlowI18nUtils.getInfo("va.workflow.notsupportseqrelationoperator") + this.relationName);
        }
        ArrayList<Condition> conditions = new ArrayList<Condition>(this.conditionRows);
