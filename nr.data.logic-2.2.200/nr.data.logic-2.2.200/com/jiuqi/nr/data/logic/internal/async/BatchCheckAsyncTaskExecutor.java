...
@RealTimeJob(group="ASYNC_TASK_BATCH_CHECK", groupTitle="\u6570\u636e\u670d\u52a1\u6279\u91cf\u5ba1\u6838")
...
extends NpRealTimeTaskExecutor {
    ...
    private static final long serialVersionUID = 7343877033577079878L;

    public String getTaskPoolType() {
        return "ASYNC_TASK_BATCH_CHECK";
    }
            ...
            try {
                if (Objects.nonNull(params) && Objects.nonNull(params.get("NR_ARGS"))) {
                    ...
                    if (args instanceof CheckParam) {
                        ...
                        checkService.batchCheck(checkParam, new ProgressMonitor((AsyncTaskMonitor)monitor));
                        if (monitor.isCancel()) {
                            String retStr = "\u4efb\u52a1\u53d6\u6d88";
