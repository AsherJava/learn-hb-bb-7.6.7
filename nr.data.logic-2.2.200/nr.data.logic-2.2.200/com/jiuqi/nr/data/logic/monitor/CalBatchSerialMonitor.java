...
public class CalBatchSerialMonitor
extends BatchSerialBaseMonitor
implements IDataStatusMonitor {
    private static final Logger logger = LoggerFactory.getLogger(CalBatchSerialMonitor.class);
    private DataStatusPresetInfo dataStatusPresetInfo;

    public CalBatchSerialMonitor(String formSchemeKey, String formulaSchemeKey, DimensionValueSet dimensionValueSet, Collection<IParsedExpression> expressions) {
    ...
    public boolean isCancel() {
        return this.mainMonitor.isCancel();
    }
}
