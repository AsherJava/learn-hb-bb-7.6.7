...
public class AuthorityItemChangedBillStorage {
    private AuthorityItemChangedBillStorage() {
    }

    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = AuthorityItemChangedBillStorage.getCreateDataMode(tenantName);
        DataModelDTO dataModelDTO = new DataModelDTO();
        dataModelDTO.setName("GC_AUTHORITYITEMCHANGEBILL");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_AUTHORITYITEMCHANGEBILL");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u6743\u9650\u7ba1\u7406\u53d8\u66f4\u540e\u5b50\u8868");
