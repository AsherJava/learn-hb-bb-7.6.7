...
public class AuthorityManageBillStorage {
    private AuthorityManageBillStorage() {
    }

    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = AuthorityManageBillStorage.getCreateDataMode(tenantName);
        DataModelDTO dataModelDTO = new DataModelDTO();
        dataModelDTO.setName("GC_AUTHORITYMANAGEMENTBILL");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_AUTHORITYMANAGEMENTBILL");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u6743\u9650\u7ba1\u7406\u5355\u4e3b\u8868");
