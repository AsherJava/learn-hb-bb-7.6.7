...
import com.jiuqi.va.filter.bill.formula.OrgFormulaHandle;
...
public class OrgFormulaExecute {
    ...
    private static final OrgFormulaExecute EXECUTE = new OrgFormulaExecute();

    public static final OrgFormulaExecute getInstance() {
        return EXECUTE;
    }

    private OrgFormulaExecute() {
    }
    ...
    private IExpression getExpression(OrgFormulaContext context, String expression) throws ParseException {
        OrgFormulaHandle handle = new OrgFormulaHandle();
