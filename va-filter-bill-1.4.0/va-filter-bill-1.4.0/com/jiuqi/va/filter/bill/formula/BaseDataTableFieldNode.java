...
public class BaseDataTableFieldNode
extends DynamicNode
implements TableFieldNode {
    private static final long serialVersionUID = 8920005329961813013L;
    public final String tableName;
    public final String fieldName;
    public DataModelType.ColumnType columnType;

    public BaseDataTableFieldNode(IContext context, Token token, String tableName, String fieldName) {
        super(token);
        this.tableName = tableName;
        this.fieldName = fieldName;
        this.setColumnType((BaseDataFormulaContext)((Object)Convert.cast((Object)context, BaseDataFormulaContext.class)));
    }

    private void setColumnType(BaseDataFormulaContext baseDataFormulaContext) {
        Optional<DataModelColumn> result;
        DataModelDO modelDO = (DataModelDO)baseDataFormulaContext.get(this.tableName);
        if (modelDO == null) {
            modelDO = this.findTabelDefine(this.tableName);
            if (modelDO == null) {
                throw new RuntimeException("\u672a\u77e5\u7684\u8868\u5b9a\u4e49\uff1a" + this.tableName);
            }
            baseDataFormulaContext.put(this.tableName, modelDO);
        }
    ...
    public Object evaluate(IContext context) throws SyntaxException {
        throw new SyntaxException("\u57fa\u7840\u6570\u636e\u516c\u5f0f\u4e0d\u652f\u6301\u83b7\u53d6\u5355\u636e\u5b57\u6bb5");
    }
