...
import com.jiuqi.va.filter.bill.formula.OrgTableFieldNode;
import com.jiuqi.va.formula.intf.FunRefDataDefine;
import java.util.List;
import org.springframework.util.StringUtils;

public class OrgFormulaNodeProvider
implements IReportDynamicNodeProvider {
    public IASTNode find(IContext context, Token token, String refName) throws DynamicNodeException {
        ...
        OrgFormulaContext cxt = (OrgFormulaContext)((Object)Convert.cast((Object)context, OrgFormulaContext.class));
        ...
        return new OrgFieldNode(token, refDataDefine);
    }
    ...
    public IASTNode find(IContext context, Token token, List<String> objPath) throws DynamicNodeException {
        ...
        return new OrgTableFieldNode(context, token, tableName, fieldName);
    }
