...
import com.jiuqi.va.filter.bill.formula.EnumDataFormulaNodeProvider;
import com.jiuqi.va.formula.provider.ModelFunctionProvider;
import java.util.Map;

public class EnumDataFormulaHandle {
    public IExpression parse(EnumDataFormulaContext context, String expresion) throws ParseException {
        ReportFormulaParser parser = new ReportFormulaParser();
        parser.registerDynamicNodeProvider((IReportDynamicNodeProvider)new EnumDataFormulaNodeProvider());
