...
@Component
public class GcFormulaCheckDesCopyAction
extends AbstractGcActionItem {
    private AsyncTaskManager asyncTaskManager;

    protected GcFormulaCheckDesCopyAction(AsyncTaskManager asyncTaskManager) {
        super("gcFormulaCheckDesCopyInfo", "\u540c\u6b65\u51fa\u9519\u8bf4\u660e", "", "#icon-_GJZshenhe");
    ...
    public Object execute(GcActionItemEnv actionItemEnv) {
        ...
        String asynTaskId = this.asyncTaskManager.publishTask((Object)gcFormulaCheckDesCopyInfoParam, GcAsyncTaskPoolType.ASYNCTASK_CHECKDESCOPYINFO.getName());
