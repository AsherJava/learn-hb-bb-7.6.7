...
public class DataTypes {
    ...
    private static final AbstractData[] NULL_VALUES = new AbstractData[]{VoidData.VOID, BoolData.NULL, DateTimeData.NULL, FloatData.NULL, IntData.NULL, DateData.NULL, StringData.NULL};
