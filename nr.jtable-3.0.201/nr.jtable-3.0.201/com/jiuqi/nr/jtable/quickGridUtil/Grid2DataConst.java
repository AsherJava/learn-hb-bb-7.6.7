...
public class Grid2DataConst {
    ...
    static final String COLOR_REGULAR_16 = "^#([0-9a-fA-F]{6}|[0-9a-fA-F]{3})$";
    static final Pattern pattern = Pattern.compile("^#([0-9a-fA-F]{6}|[0-9a-fA-F]{3})$");
    ...
    static boolean checkColorStr(String colorStr) {
        if (null == colorStr) {
            return false;
        }
    ...
    static int htmlColorToInt(String color) {
