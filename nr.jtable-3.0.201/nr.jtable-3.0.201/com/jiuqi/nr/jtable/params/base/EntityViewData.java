...
@ApiModel(value="EntityViewData", description="\u4e3b\u4f53\u89c6\u56fe\u4fe1\u606f")
...
public class EntityViewData {
    ...
    @ApiModelProperty(value=" \u4e3b\u4f53\u89c6\u56fe\u662f\u5426\u9700\u8981\u5c55\u793a\u9009\u62e9", name="showDimEntity")
    private boolean showDimEntity = true;
    ...
    @ApiModelProperty(value="\u5b9e\u4f53\u89c6\u56fe\u5b9a\u4e49", name="entityViewDefine")
    ...
    public String getRowFilter() {
        if (this.entityViewDefine != null) {
            return this.entityViewDefine.getRowFilterExpression();
        }
        return null;
    }
    ...
    public boolean isEntityAuth() {
        if (this.entityViewDefine != null) {
            return !this.entityViewDefine.isIgnorePermissions();
        }
        return true;
    }
    ...
    public boolean isShowDimEntity() {
        return this.showDimEntity;
    }

    public void setShowDimEntity(boolean showDimEntity) {
        this.showDimEntity = showDimEntity;
    }
    ...
    public void initialize(IEntityDefine entityDefine) {
        ...
        IEntityViewRunTimeController runTimeController = (IEntityViewRunTimeController)BeanUtil.getBean(IEntityViewRunTimeController.class);
        this.entityViewDefine = runTimeController.buildEntityView(this.key);
    }
