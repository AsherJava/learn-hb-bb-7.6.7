...
public class TimeLinkData
extends LinkData {
    private static final Logger logger = LoggerFactory.getLogger(TimeLinkData.class);

    public TimeLinkData(DataLinkDefine dataLinkDefine, FieldDefine fieldDefine) {
        super(dataLinkDefine, fieldDefine);
        this.type = LinkType.LINK_TYPE_TIME.getValue();
    ...
    public Object getData(Object value, DataFormaterCache dataFormaterCache, SaveErrorDataInfo saveErrorDataInfo) {
        ...
        try {
            Date date = DateUtils.timeToDate(value.toString());
