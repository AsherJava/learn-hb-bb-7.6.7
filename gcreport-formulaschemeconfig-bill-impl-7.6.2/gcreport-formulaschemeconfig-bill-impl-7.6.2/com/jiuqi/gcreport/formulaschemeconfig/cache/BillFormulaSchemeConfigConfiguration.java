...
@Component
public class BillFormulaSchemeConfigConfiguration
implements CacheManagerConfiguration {
    public static final String MANAGE_NAME = "BILL_FORMULA_SCHEME_CONFIG_MANAGE";
    public static final String CACHE_NAME = "BILL_FORMULA_SCHEME_CONFIG";
