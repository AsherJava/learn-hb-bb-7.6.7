...
import com.jiuqi.gcreport.unionrule.enums.InventoryUnitEnum;
...
extends AbstractUnionRule {
    ...
    public String getRuleType() {
        return RuleTypeEnum.INVENTORY.getCode();
    }
    ...
    public static class Item {
        private InventoryUnitEnum inventoryUnit;
        private String subjectCode;
        private String fetchFormula;
        private Map<String, String> dimensions;
        private Integer sort;

        public InventoryUnitEnum getInventoryUnit() {
            return this.inventoryUnit;
        }

        public void setInventoryUnit(InventoryUnitEnum inventoryUnit) {
