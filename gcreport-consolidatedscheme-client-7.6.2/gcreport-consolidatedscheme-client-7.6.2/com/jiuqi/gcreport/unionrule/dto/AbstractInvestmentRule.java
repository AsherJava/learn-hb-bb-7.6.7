...
public abstract class AbstractInvestmentRule
extends AbstractUnionRule {
    private Boolean equityLawAdjustFlag = false;
    private List<String> initialMerge;
    private List<String> goingConcern;
    private List<String> dealWith;
    private List<String> changeRatioOfCurrYear;
    private List<String> changeRatioOfCurrMonth;
    ...
    public Boolean getEquityLawAdjustFlag() {
        return this.equityLawAdjustFlag;
    }

    public void setEquityLawAdjustFlag(Boolean equityLawAdjustFlag) {
        this.equityLawAdjustFlag = equityLawAdjustFlag;
    }
    ...
    public List<String> getChangeRatioOfCurrYear() {
        return this.changeRatioOfCurrYear;
    }

    public void setChangeRatioOfCurrYear(List<String> changeRatioOfCurrYear) {
        this.changeRatioOfCurrYear = changeRatioOfCurrYear;
    }

    public List<String> getChangeRatioOfCurrMonth() {
        return this.changeRatioOfCurrMonth;
    }

    public void setChangeRatioOfCurrMonth(List<String> changeRatioOfCurrMonth) {
        this.changeRatioOfCurrMonth = changeRatioOfCurrMonth;
    }
