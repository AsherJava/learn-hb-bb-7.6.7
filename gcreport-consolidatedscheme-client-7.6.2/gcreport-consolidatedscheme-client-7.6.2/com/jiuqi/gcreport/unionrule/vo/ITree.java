...
public class ITree<E extends UnionRuleVO>
implements Serializable {
    ...
    private void init() {
        if (this.data != null) {
            this.key = ((BaseRuleVO)this.data).getId();
            this.code = ((BaseRuleVO)this.data).getId();
            this.title = ((BaseRuleVO)this.data).getTitle();
            this.isLeaf = ((UnionRuleVO)this.data).getLeafFlag() == null ? false : ((UnionRuleVO)this.data).getLeafFlag();
        }
    }
