...
public interface FinancialCubesOffsetAgingSysDao {
    public List<Object[]> queryOffsetData(FinancialCubesOffsetTaskDto var1, Set<String> var2);

    public List<Object[]> queryOffsetDataByRebuild(FinancialCubesRebuildDTO var1, Set<String> var2);
}
