...
public class UUIDUtils {
    ...
    private static final String EMPTY_HALF_GUID_STR = "0000000000000000";

    public static String emptyUUIDStr() {
        return EMPTY_UUID_STR;
    }

    public static String emptyHalfGUIDStr() {
        return EMPTY_HALF_GUID_STR;
    }
    ...
    public static String newHalfGUIDStr() {
        ...
        for (int i = 7; i >= 0; --i) {
            ...
            charArray[index--] = LOWER_HEX_DIGITS[b & 0xF];
            charArray[index--] = LOWER_HEX_DIGITS[b >>> 4 & 0xF];
        }
    ...
    public static String nameUUIDFromBytes(byte[] bytes) {
        ...
        return UUIDUtils.toString36(UUID.nameUUIDFromBytes(bytes));
    }
