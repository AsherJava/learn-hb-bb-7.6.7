...
public class NumberUtils {
    ...
    public static String format(Number value) {
        if (value instanceof Double || value instanceof Float) {
            value = NumberUtils.round(value.doubleValue(), 2);
        }
        return nftl.get().format(value);
    }
    ...
    public static String tryFormat(String str, Number def) {
        return NumberUtils.format(NumberUtils.tryParseNumber(str, def));
    }
    ...
    public static String doubleToString(Double value, int decimal) {
        ...
        return NumberUtils.doubleToString((double)value, decimal);
    }
    ...
    public static String doubleToString(Double value) {
        ...
        return NumberUtils.doubleToString((double)value, 2);
    }
    ...
    public static String doubleToString(double value, int max, int min, boolean group) {
        DecimalFormat format = new DecimalFormat();
    ...
    public static double sumDouble(Object o1, Object o2) {
        return NumberUtils.sum(ConverterUtils.getAsDouble(o1), ConverterUtils.getAsDouble(o2));
    }

    public static BigDecimal sumBigDecimal(Object o1, Object o2) {
        return NumberUtils.sum(ConverterUtils.getAsBigDecimal(o1), ConverterUtils.getAsBigDecimal(o2));
    }
    ...
    public static double subDouble(Object o1, Object o2) {
        return NumberUtils.sub(ConverterUtils.getAsDouble(o1), ConverterUtils.getAsDouble(o2));
    }

    public static BigDecimal subBigDecimal(Object o1, Object o2) {
        return NumberUtils.sub(ConverterUtils.getAsBigDecimal(o1), ConverterUtils.getAsBigDecimal(o2));
    }
    ...
    public static BigDecimal div(BigDecimal bd1, BigDecimal bd2) {
        Assert.isFalse(bd2.equals(BigDecimal.ZERO), "\u9664\u6570\u4e0d\u80fd\u4e3a0\u3002", new Object[0]);
    ...
    public static double[] split(double value, int times) {
        Assert.isTrue(times > 0, "\u5747\u5206\u4efd\u6570\u5fc5\u987b\u5927\u4e8e0", new Object[0]);
    ...
    public static int compareInt(Integer value1, Integer value2) {
        if (value1 == null) {
            return -1;
        }
        if (value2 == null) {
