...
import com.jiuqi.common.base.http.BusinessResponseErrorCodeEnum;
...
public final class BusinessResponseEntity<T> {
    ...
    public BusinessResponseEntity<T> errorDetail(String errorDetail) {
        GcSecurityProperties securityPro = SpringContextUtils.getBean(GcSecurityProperties.class);
        if (securityPro.getLevel() < 1) {
