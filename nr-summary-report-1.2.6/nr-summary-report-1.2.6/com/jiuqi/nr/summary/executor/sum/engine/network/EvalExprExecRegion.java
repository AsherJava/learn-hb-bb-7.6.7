 ...
 */
package com.jiuqi.nr.summary.executor.sum.engine.network;
...
extends FormulaExecRegion {
    ...
    protected boolean executeChildren(Object subTask, BoolValue somethingDone) throws Exception {
        if (this.findStatExecutor() == null) {
            SumContext sumContext = (SumContext)this.context;
            sumContext.getCurrentRegion().getJudger().judge(sumContext);
            sumContext.runStatistic();
            return true;
        }
