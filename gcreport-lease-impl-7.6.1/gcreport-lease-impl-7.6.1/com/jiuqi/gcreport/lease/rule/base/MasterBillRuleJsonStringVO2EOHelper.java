...
public class MasterBillRuleJsonStringVO2EOHelper {
    private UnionRuleVO unionRuleVO;

    private MasterBillRuleJsonStringVO2EOHelper() {
    }

    public static MasterBillRuleJsonStringVO2EOHelper newInstance(UnionRuleVO unionRuleVO) {
        MasterBillRuleJsonStringVO2EOHelper helper = new MasterBillRuleJsonStringVO2EOHelper();
    ...
    private Map<String, Object> handleSaveOneDetailedSetting(Map<String, Object> detailedSetting, String debitOrCredit, int fetchConfigGroupIndex, int rowDebitOrCreditIndex) {
        String fixedAssetsType = "CUSTOMIZE";
        if (!Objects.isNull(detailedSetting.get("type")) && !fixedAssetsType.equals(detailedSetting.get("type"))) {
