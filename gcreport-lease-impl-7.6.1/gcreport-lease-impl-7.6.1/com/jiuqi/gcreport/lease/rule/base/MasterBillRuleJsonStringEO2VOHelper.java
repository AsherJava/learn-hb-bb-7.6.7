...
public class MasterBillRuleJsonStringEO2VOHelper {
    private String jsonStr;
    private String reportSystemId;

    private MasterBillRuleJsonStringEO2VOHelper() {
    }

    public static MasterBillRuleJsonStringEO2VOHelper newInstance(String jsonStr, String reportSystemId) {
        MasterBillRuleJsonStringEO2VOHelper helper = new MasterBillRuleJsonStringEO2VOHelper();
    ...
    private Map<String, Object> handleOneDetailedSetting(Map<String, Object> detailedSetting) {
        ...
        if (!fixedAssetsType.equals(detailedSetting.get("type"))) {
