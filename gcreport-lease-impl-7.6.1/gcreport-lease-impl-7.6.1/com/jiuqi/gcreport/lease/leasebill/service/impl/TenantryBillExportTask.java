...
@Component
public class TenantryBillExportTask
extends AbstractBillMaterExportTask {
    ...
    protected List<Map<String, Object>> getRecords(Map<String, Object> params) {
        ...
        List<Map<String, Object>> masters = this.tenantryBillDao.listTenantryBillsByPaging(tempTableCondition, params);
        InvestBillTool.formatBillContent(masters, params, (String)"GC_TENANTRYBILL", (boolean)false);
        return masters;
    }
    ...
    private TempTableCondition getTempTableCondition(Map<String, Object> params) {
        ...
        String orgType = OrgUtil.getOrgType((String)"GC_TENANTRYBILL");
