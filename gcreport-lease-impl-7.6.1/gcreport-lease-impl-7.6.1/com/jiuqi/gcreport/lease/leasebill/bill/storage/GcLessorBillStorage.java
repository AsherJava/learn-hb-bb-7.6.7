...
public class GcLessorBillStorage {
    public static void init(String tenantName) {
        DataModelClient client = (DataModelClient)ApplicationContextRegister.getBean(DataModelClient.class);
        DataModelDO origalDataModel = GcLessorBillStorage.getCreateDataMode(tenantName);
        DataModelDTO dataModelDTO = new DataModelDTO();
        dataModelDTO.setName("GC_LESSORBILL");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("GC_LESSORBILL");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("\u51fa\u79df\u65b9\u5355\u636e\u4e3b\u8868");
        List columns = GcStorageUtil.getBillMasterTableTemplateFields();
        dataModelDO.setColumns(columns);
        dataModelDO.addColumn("UNITCODE").columnTitle("\u51fa\u79df\u65b9").columnType(DataModelType.ColumnType.NVARCHAR).lengths(new Integer[]{36}).mapping("MD_ORG_CORPORATE.CODE").mappingType(Integer.valueOf(4)).columnAttr(DataModelType.ColumnAttr.EXTEND);
        dataModelDO.addColumn("OPPUNITCODE").columnTitle("\u627f\u79df\u65b9").columnType(DataModelType.ColumnType.NVARCHAR).lengths(new Integer[]{36}).mapping("MD_ORG_CORPORATE.CODE").mappingType(Integer.valueOf(4)).columnAttr(DataModelType.ColumnAttr.EXTEND);
        ...
        dataModelDO.addColumn("ASSETTYPE").columnTitle("\u8d44\u4ea7\u7c7b\u578b").columnType(DataModelType.ColumnType.NVARCHAR).lengths(new Integer[]{20}).columnAttr(DataModelType.ColumnAttr.EXTEND);
        ...
        dataModelDO.addColumn("COLLECTAMT").columnTitle("\u6bcf\u671f\u6536\u6b3e\u989d").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
        ...
        dataModelDO.addColumn("INITUNASSUREAMT").columnTitle("\u521d\u59cb\u786e\u8ba4\u672a\u62c5\u4fdd\u4f59\u503c").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
        dataModelDO.addColumn("IINITUNFININCOME").columnTitle("\u521d\u59cb\u786e\u8ba4\u672a\u5b9e\u73b0\u878d\u8d44\u6536\u76ca").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
        dataModelDO.addColumn("INITFINLEASEASSET").columnTitle("\u521d\u59cb\u786e\u8ba4\u878d\u8d44\u79df\u8d41\u8d44\u4ea7").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
        ...
        dataModelDO.addColumn("INITASSETDISPOSALINCOME").columnTitle("\u521d\u59cb\u8d44\u4ea7\u5904\u7f6e\u6536\u76ca").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
        ...
        dataModelDO.addColumn("DPCALOSSSUBJECT").columnTitle("\u6298\u65e7\u5bf9\u5e94\u635f\u76ca\u79d1\u76ee").columnType(DataModelType.ColumnType.NVARCHAR).lengths(new Integer[]{20}).columnAttr(DataModelType.ColumnAttr.EXTEND);
        dataModelDO.addColumn("REMAININGTERM").columnTitle("\u5269\u4f59\u4f7f\u7528\u671f\u9650\uff08\u6708\uff09").columnType(DataModelType.ColumnType.NUMERIC).lengths(new Integer[]{19, 2}).columnAttr(DataModelType.ColumnAttr.FIXED);
