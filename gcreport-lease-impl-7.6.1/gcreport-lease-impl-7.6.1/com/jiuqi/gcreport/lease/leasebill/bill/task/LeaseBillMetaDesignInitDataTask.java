        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(lessorIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    String lessorBillListValue = IOUtils.toString(inputStream, "utf-8");
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(tenantryIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    InputStream inputStream = resource.getInputStream();
                    String tenantryBillListValue = IOUtils.toString(inputStream, "utf-8");
                    String sql = "insert into meta_design(id,designdata) values (?,?)";
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(fvchIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    InputStream inputStream = resource.getInputStream();
                    String lessorBillValue = IOUtils.toString(inputStream, "utf-8");
                    String sql = "insert into meta_design(id,designdata) values (?,?)";
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(investIds)) {
                ...
                if (metaDesignCount == 0) {
                    ...
                    InputStream inputStream = resource.getInputStream();
                    String tenantryBillValue = IOUtils.toString(inputStream, "utf-8");
                    String sql = "insert into meta_design(id,designdata) values (?,?)";
