...
@Component
public class LessorBillDaoImpl
implements LessorBillDao {
    final String MERGELEVEL = "mergeLevel";

    @Override
    public List<Map<String, Object>> listLessorBillsByPaging(TempTableCondition tempTableCondition, Map<String, Object> params) {
        ...
        String mergeRange = LessorBillDaoImpl.getMergeRange(params);
        String sql = "select" + this.getCols() + " from " + "GC_LESSORBILL" + " i \n";
    ...
    @Override
    public int countLessorBills(TempTableCondition tempTableCondition, Map<String, Object> params) {
    ...
    private void batchDeleteSubByMasterIdList(List<String> idList) {
        ...
        String sql = "delete from GC_LESSORITEMBILL  where " + inSql;
    ...
    private void batchDeleteMasterByIdList(List<String> idList) {
        ...
        String sql = "delete from GC_LESSORBILL  where " + inSql;
        EntNativeSqlDefaultDao.getInstance().execute(sql);
    }

    private String getCols() {
        return SqlUtils.getColumnsSqlByTableDefine((String)"GC_LESSORBILL", (String)"i");
    }
