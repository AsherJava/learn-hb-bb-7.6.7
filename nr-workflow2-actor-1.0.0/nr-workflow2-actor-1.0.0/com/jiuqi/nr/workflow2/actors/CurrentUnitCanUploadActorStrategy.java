...
public class CurrentUnitCanUploadActorStrategy
implements IActorStrategyExecutorFactory {
    public static final String ID = "jiuqi.nr.curunit_canreport";
    public static final String TITLE = "\u5f53\u524d\u5355\u4f4d\u4e0b\u6709\u4e0a\u62a5\u6743\u9650\u7684\u4eba";
    public static final short ORDER = 9;
    private final ExecutorCollection executors;

    public CurrentUnitCanUploadActorStrategy(CurrentUnitEexcutor currentUnitEexcutor, AuthorityEexcutor authorityExecutor) {
