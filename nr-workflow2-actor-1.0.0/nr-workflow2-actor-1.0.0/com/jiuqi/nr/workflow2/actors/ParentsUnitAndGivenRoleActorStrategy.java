...
public class ParentsUnitAndGivenRoleActorStrategy
implements IActorStrategyExecutorFactory {
    public static final String ID = "jiuqi.nr.parentsunit_givenrole";
    public static final String TITLE = "\u6240\u6709\u4e0a\u7ea7\u5355\u4f4d\u4e0b\u6307\u5b9a\u89d2\u8272\u7684\u7528\u6237";
    public static final short ORDER = 15;
    private final RoleService roleService;
    private final CurrentUnitEexcutor currentUnitEexcutor;

    public ParentsUnitAndGivenRoleActorStrategy(RoleService roleService, CurrentUnitEexcutor currentUnitEexcutor) {
