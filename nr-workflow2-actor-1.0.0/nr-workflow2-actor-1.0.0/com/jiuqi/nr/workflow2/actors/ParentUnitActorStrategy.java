...
public class ParentUnitActorStrategy
implements IActorStrategyExecutorFactory {
    public static final String ID = "jiuqi.nr.parentunit";
    public static final String TITLE = "\u76f4\u63a5\u4e0a\u7ea7\u5355\u4f4d\u4e0b\u7684\u7528\u6237";
    public static final short ORDER = 11;
    private final CurrentUnitEexcutor currentUnitEexcutor;

    public ParentUnitActorStrategy(CurrentUnitEexcutor currentUnitEexcutor) {
