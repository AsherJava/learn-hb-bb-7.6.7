...
public class CanUploadAndGivenRoleActorStrategy
implements IActorStrategyExecutorFactory {
    public static final String ID = "jiuqi.nr.canreport_givenrole";
    public static final String TITLE = "\u6709\u4e0a\u62a5\u6743\u9650\u4e14\u5c5e\u4e8e\u6307\u5b9a\u89d2\u8272\u7684\u4eba";
    public static final short ORDER = 5;
    private final RoleService roleService;
    private final AuthorityEexcutor authorityExecutor;

    public CanUploadAndGivenRoleActorStrategy(AuthorityEexcutor authorityExecutor, RoleService roleService) {
