...
public class CanSubmitAndGivenRoleActorStrategy
implements IActorStrategyExecutorFactory {
    public static final String ID = "jiuqi.nr.cansubmit_givenrole";
    public static final String TITLE = "\u6709\u9001\u5ba1\u6743\u9650\u4e14\u5c5e\u4e8e\u6307\u5b9a\u89d2\u8272\u7684\u4eba";
    public static final short ORDER = 4;
    private final RoleService roleService;
    private final AuthorityEexcutor authorityExecutor;

    public CanSubmitAndGivenRoleActorStrategy(AuthorityEexcutor authorityExecutor, RoleService roleService) {
