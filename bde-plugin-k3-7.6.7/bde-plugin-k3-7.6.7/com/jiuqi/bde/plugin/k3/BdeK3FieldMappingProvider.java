...
@Component
public class BdeK3FieldMappingProvider
extends BaseMappingProvider {
    public static final String CODE = "K3Assist";
    @Autowired
    ...
    public List<OrgMappingTypeDTO> listMappingType(DataSchemeDTO dto) {
        ArrayList<OrgMappingTypeDTO> orgMappingTypeDTOS = new ArrayList<OrgMappingTypeDTO>();
        ...
        orgSql.append("SELECT FFRAMEWORKID AS ID,FNAME AS NAME ,FNumber AS CODE FROM T_GR_FRAMEWORK");
        ...
        orgMappingTypeDTOS.add(orgMappingTypeDTO);
        return orgMappingTypeDTOS;
    }
}
