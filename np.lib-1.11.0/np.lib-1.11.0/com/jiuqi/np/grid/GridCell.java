...
import com.jiuqi.np.grid.DateCellProperty;
...
import com.jiuqi.np.grid.TextCellProperty;
...
implements Serializable {
    ...
    public final int getBackColor() {
        return GridCell.BGR2RGB(this.grid.cellColors().get(GridCell.byteToInt(this.data[0])));
    }
    ...
    public final int getBEdgeColor() {
        return GridCell.BGR2RGB(this.grid.edgeColors().get(this.data[10] >> 4 & 0xF));
    }
    ...
    public final int getFontColor() {
        ...
        return GridCell.BGR2RGB(this.grid.fontColors().get(index));
    }
    ...
    public final boolean getFontStyle(int fontStyle) {
        if (fontStyle >= 0 && fontStyle < 4) {
            return this.getBit(1, fontStyle);
        }
        return false;
    }
    ...
    public final int getREdgeColor() {
        ...
        return GridCell.BGR2RGB(this.grid.edgeColors().get(index));
    }
    ...
    public final Date getDate() {
        return DateUtil.tryParserDateString((String)this.grid.getCellData(this.col, this.row));
    }
    ...
    public final void setBackColor(int value) {
        int color = GridCell.RGB2BGR(value);
    ...
    public final void setFontColor(int value) {
        ...
        if (index < 0) {
            index = this.grid.fontColors().count() < 63 ? this.grid.fontColors().add(color) : 63;
        }
    ...
    public final void setSilverHead(boolean value) {
        ...
        if (value) {
            this.setBackColor(-16777201);
            this.setBackStyle(28);
            this.setLEdgeColor(0x808080);
            this.setREdgeColor(0x808080);
            this.setTEdgeColor(0x808080);
            this.setBEdgeColor(0x808080);
        } else {
            this.setBackColor(-16777211);
            this.setBackStyle(0);
            this.setLEdgeColor(0x808080);
            this.setREdgeColor(0x808080);
            this.setTEdgeColor(0x808080);
    ...
    public final void setDate(Date value) {
        String str = value == null ? null : DateUtil.convertDateToString1((Date)value);
    ...
    public static final String makeLinkInformation(String text, String reference, String target) {
        try {
            MemStream stream = new MemStream();
            GridCell.writeString((Stream)stream, text);
    ...
    public boolean equals(Object obj) {
        ...
        byte[] cmpData = ((GridCell)obj).getPropData();
