...
import com.jiuqi.nr.efdc.bean.EntityDataDeserializer;
import com.jiuqi.nr.efdc.bean.EntityDataSerialize;
...
implements INode {
    ...
    public static EntityDataObject buildEntityData(com.jiuqi.nr.entity.engine.intf.IEntityRow row) {
        ...
        if (row != null) {
            ...
            for (int idx = 0; idx < fieldCount; ++idx) {
                IEntityAttribute field = fieldsInfo.getFieldByIndex(idx);
    ...
    public static EntityDataObject buildEntityData(IEntityRow row) {
        ...
        if (row != null) {
            ...
            com.jiuqi.np.dataengine.setting.IFieldsInfo fields = row.getFieldsInfo();
            ...
            for (int idx = 0; idx < fieldCount; ++idx) {
                ...
                Object asObject = null;
                try {
                    com.jiuqi.np.dataengine.data.AbstractData value = row.getValue(field);
                    asObject = value.getAsObject();
                }
                catch (Exception exception) {
                    // empty catch block
