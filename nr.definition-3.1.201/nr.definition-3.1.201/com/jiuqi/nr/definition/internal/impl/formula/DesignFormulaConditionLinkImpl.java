...
@DBAnno.DBTable(dbTable="NR_PARAM_CONDITION_LINK_DES")
@DBAnno.DBLinks(value={@DBAnno.DBLink(linkWith=DesignFormulaConditionLinkImpl.class, linkField="key", field="conditionKey"), @DBAnno.DBLink(linkWith=DesignFormulaDefine.class, linkField="key", field="formulaKey"), @DBAnno.DBLink(linkWith=DesignFormulaSchemeDefine.class, linkField="key", field="formulaSchemeKey")})
public class DesignFormulaConditionLinkImpl
implements DesignFormulaConditionLink {
    ...
    public boolean equals(Object o) {
        ...
        DesignFormulaConditionLinkImpl that = (DesignFormulaConditionLinkImpl)o;
