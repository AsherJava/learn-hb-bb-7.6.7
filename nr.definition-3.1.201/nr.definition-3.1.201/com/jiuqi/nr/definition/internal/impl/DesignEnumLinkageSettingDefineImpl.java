...
@DBAnno.DBTable(dbTable="des_sys_enumlinkage")
public class DesignEnumLinkageSettingDefineImpl
implements DesignEnumLinkageSettingDefine {
    ...
    @Override
    public void setMasterLink(String masterLinkKey) {
        this.masterLink = masterLinkKey;
    }

    @Override
    public void setSlaveLinks(List<String> slaveLinksKey) {
        this.slaveLinks = slaveLinksKey;
    }
    ...
    @Override
    public void setShowLinks(List<String> showLinksKey) {
        this.showLinks = showLinksKey;
    }
