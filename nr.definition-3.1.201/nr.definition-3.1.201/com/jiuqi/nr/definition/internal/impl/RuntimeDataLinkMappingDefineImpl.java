...
@DBAnno.DBTable(dbTable="NR_PARAM_DATALINKMAPPING")
public class RuntimeDataLinkMappingDefineImpl
implements DataLinkMappingDefine {
    public static final String CLZ_FIELD_ID = "id";
