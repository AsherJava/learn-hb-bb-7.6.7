...
public class AnalyseDataLinkFinder
implements IDataLinkFinder {
    ...
    public AnalyseDataLinkFinder(IRunTimeViewController controller, IDataDefinitionRuntimeController runtimeController, IEntityViewRunTimeController entityViewRunTimeController, String formSchemeKey, String sourceFormSchemeKey) {
    ...
    public DataLinkColumn findDataColumn(ReportInfo reportInfo, int rowIndex, int colIndex, boolean isGridPosition) {
        try {
            ...
            FieldDefine fieldDefine = this.runtimeController.queryFieldDefine(dataLink.getLinkExpression());
            if (fieldDefine == null) {
                this.logger.error("\u6839\u636e\u5355\u5143\u683c\u5173\u8054\u6307\u6807key:" + dataLink.getLinkExpression() + "\u6ca1\u6709\u627e\u5230\u6307\u6807\u5b9a\u4e49");
                return null;
            }
    ...
    public DataLinkColumn findDataColumnByFieldName(ReportInfo reportInfo, String fieldName) {
        DataLinkColumn linkColumn = this.findDataColumnByFieldName(reportInfo, fieldName, this.sourceFormSchemeKey);
        if (linkColumn == null) {
    ...
    private DataLinkColumn findDataColumnByFieldName(ReportInfo reportInfo, String fieldName, String schemeKey) {
        try {
            if (reportInfo == null) {
            ...
            DataLinkColumn column = this.getDataLinkColumn(reportInfo, dataLinkDefine, fieldDefine);
            return column;
        }
        catch (Exception e) {
    ...
    private ReportInfo getReportInfo(FormDefine form) {
        ...
        this.reportInfoMp.put(form.getKey().toString(), report);
        return report;
    }
