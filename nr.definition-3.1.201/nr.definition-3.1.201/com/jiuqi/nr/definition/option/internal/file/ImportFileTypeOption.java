...
@Component
public class ImportFileTypeOption
implements TaskOptionDefine {
    ...
    public List<OptionItem> getOptionItems() {
        ArrayList<OptionItem> list = new ArrayList<OptionItem>(4);
        for (final FileTypeOptionEnum value : FileTypeOptionEnum.values()) {
            if (value == FileTypeOptionEnum.PDF || value == FileTypeOptionEnum.OFD) continue;
