...
public class ReportLabelTemplateObject
extends TextTemplateObject {
    ...
    public void setLocation(String location) {
        this.location = "null".equals(location) ? null : location;
    }
    ...
    public void deserialize(Element element) {
        ...
        this.location = String.valueOf(element.getAttribute(ATT_LOCATION));
    }
    ...
    public Element serialize(Document ownerDocument) {
        ...
        element.setAttribute(ATT_LOCATION, String.valueOf(this.location));
        return element;
    }
