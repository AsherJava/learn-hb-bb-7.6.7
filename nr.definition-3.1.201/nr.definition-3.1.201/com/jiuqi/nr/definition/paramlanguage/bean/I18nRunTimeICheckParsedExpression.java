...
public class I18nRunTimeICheckParsedExpression
extends CheckExpression {
    private final IParsedExpression parsedExpression;
    private String meaning;
    private Formula i18nFormula;

    public I18nRunTimeICheckParsedExpression(CheckExpression parsedExpression) {
        super((IExpression)parsedExpression, parsedExpression.getSource());
