...
@Component
public class Nc6XjllBalanceContentProvider
extends AbstractXjllBalanceContentProvider {
    ...
    protected QueryParam<PenetrateBalance> getQueryParam(PenetrateBaseDTO condi) {
        ...
        if (containSubject) {
            ...
            sql.append("       ${SUBJECTFIELD} AS MD_ACCTSUBJECT,  \n");
        }
        ...
        sql.append(" WHERE 1 = 1  \n");
        sql.append(this.buildCfItemCondi("MD_CFITEM", "CODE", condi.getCashCode()));
        if (containSubject) {
