...
public class ILVO {
    ...
    private List<OrgDataVO> orgDataVOList;
    ...
    public List<OrgDataVO> getOrgDataVOList() {
        return this.orgDataVOList;
    }

    public void setOrgDataVOList(List<OrgDataVO> orgDataVOList) {
        this.orgDataVOList = orgDataVOList;
    }
