...
public class OfficeUtil {
    ...
    public static void simpleFooter(XWPFDocument docx, String text) throws Exception {
        ...
        XWPFParagraph codePara = new XWPFParagraph(ctp, (IBody)docx);
    ...
    private static void addField(XWPFParagraph paragraph, String fieldName) {
        ...
        ctSimpleField.setDirty((Object)true);
        ctSimpleField.addNewR().addNewT().setStringValue("<<fieldName>>");
    }

    public static int convertPixelToPoint(int pixel) {
        return Integer.parseInt(new DecimalFormat("0").format(Units.pixelToPoints((double)pixel)));
    }
    ...
    public static void addCustomHeadingStyle(CustomXWPFDocument docxDocument, String strStyleId, int headingLevel, float lineHeight) throws XmlException, IOException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        ...
        if (headingLevel > 0 && headingLevel < 5) {
            CTString styleBasedOn = (CTString)CTString.Factory.newInstance();
            styleBasedOn.setVal(strStyleId);
            ctStyle.setBasedOn(styleBasedOn);
            CTString styleNext = (CTString)CTString.Factory.newInstance();
            styleNext.setVal(strStyleId);
            ctStyle.setBasedOn(styleNext);
            CTString styleLink = (CTString)CTString.Factory.newInstance();
            styleLink.setVal(String.valueOf(headingLevel * 10));
            ctStyle.setLink(styleLink);
            CTDecimalNumber styleUIPriority = (CTDecimalNumber)CTDecimalNumber.Factory.newInstance();
            styleUIPriority.setVal(new BigInteger("9"));
            ctStyle.setUiPriority(styleUIPriority);
        }
        ctStyle.setQFormat((CTOnOff)CTOnOff.Factory.newInstance());
        CTPPrGeneral pPr = ctStyle.addNewPPr();
        CTOnOff off = (CTOnOff)CTOnOff.Factory.newInstance();
        off.setVal((Object)STOnOffEnum.OFF);
        CTOnOff on = (CTOnOff)CTOnOff.Factory.newInstance();
        on.setVal((Object)STOnOffEnum.ON);
        ...
        if (lineHeightValue == null) {
            spacing.setLine((Object)new BigInteger("360"));
        } else {
            spacing.setLine((Object)new BigInteger(lineHeightValue.toString()));
        }
        spacing.setLineRule(STLineSpacingRule.AUTO);
        if (headingLevel > 0 && headingLevel < 5) {
            pPr.setKeepNext((CTOnOff)CTOnOff.Factory.newInstance());
            pPr.setKeepLines((CTOnOff)CTOnOff.Factory.newInstance());
        }
        ...
        CTOnOff[] bcs = new CTOnOff[]{(CTOnOff)CTOnOff.Factory.newInstance()};
        switch (headingLevel) {
            case 1: {
                rPr = ctStyle.addNewRPr();
                rFonts = rPr.addNewRFonts();
                styleOutLineLvl = (CTDecimalNumber)CTDecimalNumber.Factory.newInstance();
                ...
                rPr.setBCsArray(bcs);
                rPr.addNewKern().setVal((Object)new BigInteger("44"));
                rPr.addNewSz().setVal((Object)new BigInteger("32"));
                rPr.addNewSzCs().setVal((Object)new BigInteger("44"));
                break;
            }
            case 2: {
                rPr = ctStyle.addNewRPr();
                ...
                rPr.setBCsArray(bcs);
                rPr.addNewKern().setVal((Object)new BigInteger("44"));
                rPr.addNewSz().setVal((Object)new BigInteger("30"));
                rPr.addNewSzCs().setVal((Object)new BigInteger("44"));
                break;
            }
            case 3: {
                ...
                rPr.setBCsArray(bcs);
                rPr.addNewB();
                rPr.addNewKern().setVal((Object)new BigInteger("30"));
                rPr.addNewSz().setVal((Object)new BigInteger("24"));
                rPr.addNewSzCs().setVal((Object)new BigInteger("30"));
                break;
            }
            case 4: {
                rPr = ctStyle.addNewRPr();
    ...
    public static void setSpaceing(XWPFParagraph paragraph, String lineSpace) {
        ...
        spacing.setLine((Object)new BigInteger(space.intValue() + ""));
    }
