...
class HeadFootPolicyExt {
    ...
    public HeadFootPolicyExt(CustomXWPFHeaderFooterPolicy headerFooterPolicy, Map<String, String> headerSettings, Map<String, String> footerSettings, Map<String, String> noSettings) {
        ...
        this.enumType = STJc.Enum.forString(noSettings.get("enumType"));
        this.evenEnumType = STJc.Enum.forString(noSettings.get("evenEnumType"));
        this.oddEnumType = STJc.Enum.forString(noSettings.get("oddEnumType"));
    ...
    public void addSdtFooter(XWPFFooter footer, STJc.Enum enumType) {
        ...
        pRpr.addNewSz().setVal(new BigInteger("20"));
        pRpr.addNewSzCs().setVal(new BigInteger("20"));
        CTR run = p.addNewR();
    ...
    public void formatHeadFootRun(CTR run, int fontSize, String fontFamily) {
        ...
        rpr.addNewSz().setVal(new BigInteger(fontSize * 2 + ""));
        rpr.addNewSzCs().setVal(new BigInteger(fontSize * 2 + ""));
    }
}
